...
import { ArrowRight, Heart, Clock, BookOpen, Target, CheckCircle, AlertCircle } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto">
          ...
          delay: 0.2
            ...
            <div className="grid gap-4 max-w-2xl mx-auto">
              {painPoints.map((pain, index) => <motion.div key={pain.text} initial={{
              opacity: 0,
              x: -30
            }} animate={isInView ? {
              opacity: 1,
          ...
          delay: 1.2
            ...
            <a href="#pricing" onClick={() => typeof window !== 'undefined' && (window as any).fbq?.('track', 'Lead')}>
