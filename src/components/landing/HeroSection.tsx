...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden noise-overlay">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-blue-bright/10 rounded-full blur-[100px] animate-glow-pulse" style={{ animationDelay: "1.5s" }} />
      ...
      <div className="container relative z-10 px-6 py-20 md:py-32">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium text-primary">Clube Exclusivo de Formação</span>
          </motion.div>
