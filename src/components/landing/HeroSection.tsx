...
const HeroSection = () => {
  const benefits = ["Fé aplicada à vida real", "Mentalidade", "Alta Performance", "Empreendedorismo", "Marketing Digital", "Vida Devocional", "Teologia", "Gestão Financeira", "Controle Emocional"];
      ...
      <div className="container relative z-10 px-6 py-20 md:py-32">
        ...
        ease: "easeOut"
          ...
          delay: 0.6
            ...
            <p className="text-foreground font-medium mb-4">Aqui o crescimento → É integral.<span className="text-primary">É integral.</span>
            </p>
