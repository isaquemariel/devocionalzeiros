        ...
        <div className="max-w-5xl mx-auto mb-24">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-6">
              ...
              <span className="text-gradient">CLUBE HD</span>
            </h2>
          ...
          >
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              ...
              <br />
              Você passa a fazer parte de um <span className="text-foreground font-semibold">ecossistema anual</span>, pensado para sustentar constância, amadurecimento espiritual e desenvolvimento integral.
            </p>
            <p className="text-lg text-primary font-medium mt-6">
              Durante 12 meses, você terá acesso a:
            </p>
          </motion.div>
