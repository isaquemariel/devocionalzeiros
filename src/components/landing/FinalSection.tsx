...
const FinalSection = () => {
  ...
  const benefits = [{
    ...
    description: "Momentos presenciais de comunhão, aprendizado, networking, alinhamento e vida real, fortalecendo vínculos e aprofundando a caminhada."
  }, {
    icon: Video,
    title: "Encontros Online Mensais",
    description: "Mentorias ao vivo para alinhamento espiritual, profissional e emocional, mantendo ritmo, direção e constância ao longo do ano."
  }, {
    icon: MessageCircle,
      ...
      <div className="container relative z-10 px-6">
        ...
        <div className="max-w-5xl mx-auto mb-24">
          ...
          duration: 0.8
            ...
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-6">O QUE VOCÊ ACESSAR NO CLUBE HD<span className="text-gradient">CLUBE HD</span>
            </h2>
