          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            delay: 0.2
              ...
              <div className="space-y-4 text-muted-foreground text-lg leading-relaxed">
                ...
                <p>Desse confronto nasceu o Devocionalzeiros e, mais tarde, o Método HD, fruto de anos de prática devocional diária e acompanhamento de pessoas reais. No CLUBE HD, caminho junto, ajudando cristãos a saírem de uma fé estática para uma vida intencional, madura e alinhada, onde corpo, alma e espírito glorificam a Deus na rotina.<span className="text-foreground font-medium">
