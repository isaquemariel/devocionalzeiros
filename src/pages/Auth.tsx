                  ...
                  {isLogin && !isRecovery && (
                    <>
                      ...
                      <motion.button
                        ...
                        className="w-full py-2.5 sm:py-3 rounded-xl font-medium text-sm sm:text-base relative overflow-hidden group disabled:opacity-50 bg-background border border-border hover:bg-muted/50 transition-all flex items-center justify-center gap-2 sm:gap-3"
                        whileHover={{ scale: 1.01 }}
                        whileTap={{ scale: 0.99 }}
