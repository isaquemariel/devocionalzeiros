...
// (a capa do RPG é desenhada ao vivo pelo RPGGameCard — com o personagem de
// verdade —, então não há imagem dela para pré-carregar)
const cardImages = [cardLeituraBiblica, cardQuiz, cardDevocional, cardChat, cardSermao, cardBibliaEstudo, cardComunidade];
...
{ id: "rpg", image: "", altText: "Jogo da Bíblia", route: "/rpg" },
...
const Home = () => {
  ...
  // Mantemos o estado para reativar facilmente no futuro.
  // useEffect(() => {
