    ...
    <div className="min-h-screen bg-background flex flex-col overflow-x-hidden">
      ...
      <main className="flex-1 container max-w-2xl mx-auto px-4 py-6">
        ...
        {!quizStarted ? (
          ...
          >
            {/* Header Card */}
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-600/20 via-yellow-600/15 to-orange-600/20 border border-amber-500/30 p-6">
              ...
              <div className="relative z-10">
                ...
                <h1 className="text-2xl font-bold mb-2 bg-gradient-to-r from-amber-400 via-amber-300 to-amber-400 bg-clip-text text-transparent">
                  Quiz Bíblico
                </h1>
            ...
            <div className="rounded-xl bg-card border border-border p-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-primary/10 border border-primary/20">
                  <div className="text-3xl font-bold text-primary mb-1">{chaptersReadToday}</div>
                  <div className="text-sm text-muted-foreground">Capítulos lidos</div>
                </div>
                <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
                  <div className="text-3xl font-bold text-amber-400 mb-1">{questionsAnsweredToday}</div>
              ...
              {chaptersReadToday > 0 && (
                <div className="p-4 rounded-lg bg-muted/30 border border-border">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Perguntas disponíveis</span>
                    <span className="text-lg font-bold text-foreground">
                      {Math.max(0, maxQuestions - questionsAnsweredToday)}
                    </span>
                  </div>
                  <div className="w-full h-2 bg-muted/50 rounded-full mt-2 overflow-hidden">
                    <div 
            ...
            {hasQuestionsAvailable ? (
              <Button
                ...
                className="w-full h-14 text-lg bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 shadow-lg shadow-amber-500/30"
              >
                {quizLoading ? (
                  <>
              ...
              <div className="text-center p-6 rounded-xl bg-muted/30 border border-border">
                ...
                <Button onClick={() => navigate('/biblia')} variant="outline">
              ...
              <div className="text-center p-6 rounded-xl bg-green-500/10 border border-green-500/30">
                ...
                <p className="text-green-400 font-medium mb-2">Quiz completo para hoje! ✓</p>
          ...
          >
            <div className="relative w-28 h-28 mx-auto mb-8">
              ...
              <Sparkles className="absolute -bottom-1 -left-1 w-6 h-6 text-primary animate-pulse delay-150" />
            </div>
            
            <h2 className="text-3xl font-bold mb-3 bg-gradient-to-r from-amber-400 via-amber-300 to-amber-400 bg-clip-text text-transparent">
              Parabéns!
            </h2>
            ...
            <div className="flex justify-center gap-6 mb-8">
              <div className="text-center p-6 rounded-2xl bg-green-500/10 border border-green-500/30 min-w-[120px]">
                <div className="flex items-center justify-center gap-2 text-green-400 mb-2">
                  <CheckCircle2 className="w-7 h-7" />
                  <span className="text-4xl font-bold">{results.correct}</span>
                </div>
                <p className="text-sm text-green-400/80">Acertos</p>
              </div>
              <div className="text-center p-6 rounded-2xl bg-red-500/10 border border-red-500/30 min-w-[120px]">
                <div className="flex items-center justify-center gap-2 text-red-400 mb-2">
                  <XCircle className="w-7 h-7" />
                  <span className="text-4xl font-bold">{results.total - results.correct}</span>
                </div>
                <p className="text-sm text-red-400/80">Erros</p>
              </div>
            </div>

            <div className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-to-r from-primary/20 to-blue-500/20 border border-primary/40 mb-8">
            ...
            <div className="space-y-3">
              <Button 
                ...
                className="w-full h-12 bg-gradient-to-r from-primary to-blue-500 hover:from-primary/90 hover:to-blue-500/90 shadow-lg shadow-primary/30"
              >
                Continuar Leitura
              </Button>
              <Button 
          ...
          >
            ...
            {/* Question */}
            <div className="relative p-5 rounded-xl bg-gradient-to-br from-primary/10 to-blue-500/5 border border-primary/20 mb-6">
