...
import { TrashSection } from '@/components/financas/sections/TrashSection';
...
export interface FinanceCategoriesContext {
...
export const CategoriesCtx = React.createContext<FinanceCategoriesContext>({
  allCategories: [],
  customCategories: [],
          ...
          <div className="flex-1 flex flex-col min-w-0 w-full">
            <header className="sticky top-[44px] z-30 bg-card border-b border-border px-4 py-3 flex items-center justify-between lg:hidden">
              ...
              <div className="flex items-center gap-2">
                <button onClick={() => openModal('expense')} className="px-2.5 py-1.5 bg-red-600/20 text-red-400 rounded-lg text-xs font-medium hover:bg-red-600/30 transition-colors">
                  − Saída
                </button>
                <button onClick={() => openModal('income')} className="px-2.5 py-1.5 bg-emerald-600 text-white rounded-lg text-xs font-medium hover:bg-emerald-700 transition-colors">
                  + Entrada
                </button>
              </div>
            </header>
