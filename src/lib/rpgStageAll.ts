// ============================================================================
// MAPA COMPLETO do modo CENA VIVA — todos os livros carregados de uma vez.
//
// ⚠ USO EXCLUSIVO DE FERRAMENTA. Os validadores de `scripts/` precisam de ver
// tudo junto, e `scripts/gen-stage-index.mjs` gera daqui o `stageIndex.ts`. O
// APP NÃO IMPORTA ESTE ARQUIVO: importá-lo traz os 11 MB de roteiro de uma vez
// e desfaz o carregamento por livro. Para o app, use `rpgStageRegistry.ts`.
//
...
// NÃO IMPORTE ISTO NO APP. Este arquivo puxa os 21 livros de uma vez (11 MB de
// roteiro) e existe só para os validadores de `scripts/` e para o gerador de
// `stageIndex.ts`. O app usa `rpgStageRegistry.ts`, que carrega um livro de
// cada vez por import() dinâmico.
