...
import { drawFeatherWing, drawMountHD } from "@/lib/rpgHero";
// o herói mora em `rpgHero` (as telas leves o usam sem carregar o palco);
// continua exportado daqui para quem já o importava junto com o palco
export { drawHeroHD, drawPetHD, heroMountLift, HERO_ALTURA, type HDHeroOpts } from "@/lib/rpgHero";
