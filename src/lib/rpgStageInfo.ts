...
export const PROP_TAG_INFO: Record<string, StageInfo> = {
  ...
  "caverna-de-en-gedi": {
    ...
    text: "\"E entrou nela Saul, a cobrir seus pés; e Davi e os seus homens estavam nos fundos da caverna\" (1Sm 24:3). \"Cobrir os pés\" é o modo pudico com que o hebraico diz que o rei entrou para fazer as suas necessidades: sozinho, agachado, de costas, com o manto no chão. As grutas de calcário de En-Gedi são fundas e ramificadas, e quem vem da luz não enxerga nada lá dentro, enquanto quem está no escuro vê perfeitamente a silhueta recortada na entrada. Os homens leram a coincidência como sentença do céu: \"Eis aqui o dia, do qual o Senhor te diz: Eis que te dou o teu inimigo nas tuas mãos\" (1Sm 24:4). Davi leu de outro jeito — oportunidade não é ordem — e a única coisa que a sua lâmina tocou foi um pedaço de pano. Saiu depois e gritou da boca da caverna o que poderia ter feito e não fez (1Sm 24:8-11); e Saul, que entrara ali como caçador, saiu chorando e chamando-o de filho.",
  },
  "aba-da-capa-de-saul": {
