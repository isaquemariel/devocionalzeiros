...
export const CHAR_INFO: Record<string, StageInfo> = {
  "o-senhor-diante-de-abraao": { title: "O SENHOR, diante de quem Abraão ficou em pé", subtitle: "Gn 18:22-33 — o varão central que não desceu a Sodoma", text: "Dos três varões que comeram debaixo da árvore, dois \"viraram aqueles homens os rostos dali, e foram-se para Sodoma; mas Abraão ficou ainda em pé diante da face do Senhor\" (Gn 18:22). É com esta figura que se trava a intercessão mais ousada da Escritura: \"Não faria justiça o Juiz de toda a terra?\" (Gn 18:25), e o número desce de cinquenta a dez, e a cada lance a resposta é \"Não a destruirei\" ou \"Não o farei\". A presença é luz, nunca rosto: o SENHOR não é desenhado como pessoa, e o que se vê é o varão luminoso pelo qual Ele fala. No fim, \"retirou-se o Senhor, quando acabou de falar a Abraão; e Abraão tornou-se ao seu lugar\" (Gn 18:33) — e os dois que desceram são os mesmos dois anjos que chegam a Sodoma à tarde (Gn 19:1)." },
  ...
  hirao: { title: "Hirão, rei de Tiro", subtitle: "O aliado fenício de Davi e de Salomão (2Sm 5:11; 1Rs 5)", text: "Rei da cidade portuária de Tiro, foi o primeiro soberano estrangeiro a reconhecer o reinado de Davi sobre todo o Israel: \"enviou mensageiros a Davi, e madeira de cedro, e carpinteiros, e pedreiros que edificaram a Davi uma casa\" (2Sm 5:11) — e foi diante desse palácio novo que Davi entendeu que o SENHOR exaltara o seu reino \"por amor do seu povo\" (2Sm 5:12). A amizade atravessou uma geração: \"Hirão sempre tinha amado a Davi\", e por isso ele mandou os seus servos a Salomão assim que soube da unção (1Rs 5:1). O acordo do templo é dele: os sidônios, que sabiam cortar madeira como ninguém, derrubaram os CEDROS DO LÍBANO, que desceram em jangadas pelo mar, em troca de trigo e azeite batido para a sua casa, ano após ano (1Rs 5:6-11). Enviou também o artífice de cobre que fundiu as duas colunas e o mar (1Rs 7:13-14), e os seus marinheiros levaram a frota de Salomão a Ofir (1Rs 9:27). Nem tudo foi harmonia: as vinte cidades da Galileia que recebeu em pagamento não lhe agradaram, e ele perguntou \"Que cidades são estas que me deste, irmão meu?\" — o lugar ficou chamado \"Terra de Cabul, até hoje\" (1Rs 9:13). A casa do SENHOR foi levantada com madeira estrangeira e mãos estrangeiras — sinal antigo de que aquele Nome atrairia gente de \"terra remota\" (1Rs 8:41)." },
  ...
  "abisague": {
    ...
    subtitle: "A moça que aquecia o rei Davi na velhice (1Rs 1:3)",
    text: "Entra na Escritura como remédio para a velhice de um rei: \"cobriam-no de roupas, porém não se aquecia\" (1:1), e os servos saíram a procurar. \"E buscaram por todos os termos de Israel uma moça formosa, e acharam a Abisague, sunamita; e a trouxeram ao rei\" (1:3). O texto guarda dela duas coisas juntas, e as duas importam: \"E era a moça sobremaneira formosa; e tinha cuidado do rei, e o servia; porém o rei não a conheceu\" (1:4). Estava ali, servindo em silêncio, na câmara em que Bate-Seba e Natã travaram a disputa que decidiu o trono de Israel (1:15). Depois da morte de Davi, tornou-se o pretexto de uma sentença de morte: Adonias pediu por ela, e Salomão leu no pedido o que ele de fato era — \"E por que pedes a Abisague, a sunamita, para Adonias? Pede também para ele o reino\" (2:22). Nunca fala uma palavra em todo o livro, e por causa dela um príncipe morreu no mesmo dia (2:24). É a figura muda a quem os poderosos atribuem sentidos que ela não escolheu.",
  },
  "adonias": {
    title: "Adonias",
    subtitle: "Filho de Hagite, o príncipe que se proclamou rei (1Rs 1:5)",
    text: "\"Então Adonias, filho de Hagite, se levantou, dizendo: Eu reinarei\" (1:5) — não foi ungido, não foi chamado, apenas se levantou. Imitou o irmão morto até nos detalhes: \"E preparou carros, e cavaleiros, e cinqüenta homens, que corressem adiante dele\" (1:5), exatamente como Absalão. E o versículo seguinte explica a vida inteira num aparte devastador: \"E nunca seu pai o tinha contrariado, dizendo: Por que fizeste assim? E era ele também muito formoso de parecer\" (1:6). Fez-se um banquete junto à pedra de Zoelete e convidou a todos, menos a Natã, a Benaia e a Salomão (1:9-10); mas o som das trombetas de Giom chegou ao meio da festa, e \"estremeceram e se levantaram todos os convidados\" (1:49). Correu ao santuário e \"apegou-se às pontas do altar\" (1:50), e Salomão o poupou com uma condição exata: \"Se for homem de bem, nem um de seus cabelos cairá em terra; se, porém, se achar nele maldade, morrerá\" (1:52). Não se achou homem de bem: voltou por Bate-Seba a pedir Abisague, começando com a frase que o entregou — \"Bem sabes que o reino era meu\" (2:15). Morreu naquele mesmo dia pela mão de Benaia (2:24-25). O filho que nunca ouviu um \"Por que fizeste assim?\" do pai acabou ouvindo do irmão a única palavra que ninguém adia.",
  },
  "salomao": {
    title: "Salomão",
    subtitle: "O rei sábio de Gibeom, o construtor do templo, o coração desviado (1Rs 1–11)",
    text: "Ungido em Giom sobre a mula do pai enquanto Adonias banqueteava (1:38-40), recebeu de Davi a ordem de partida: \"esforça-te, pois, e sê homem\" (2:2). Em Gibeom, Deus lhe abriu um cheque em branco — \"Pede o que queres que eu te dê\" (3:5) — e ele não pediu vida longa, nem riquezas, nem a morte dos inimigos: \"sou apenas um menino pequeno; não sei como sair, nem como entrar\" (3:7), \"dá um coração entendido para julgar a teu povo\" (3:9). Deus lhe deu o que pediu e o que não pediu: \"te dei um coração tão sábio e entendido, que antes de ti igual não houve, e depois de ti igual não se levantará\" (3:12). A espada pedida diante das duas prostitutas provou-o diante de Israel (3:24-28); \"disse três mil provérbios, e foram os seus cânticos mil e cinco\" (4:32), e sete anos de obra levantaram a casa do SENHOR, onde a nuvem entrou de tal modo que \"os sacerdotes não podiam permanecer em pé para ministrar\" (8:11). Ali orou a oração mais lúcida jamais feita por um construtor: \"Mas, na verdade, habitaria Deus na terra? Eis que os céus, e até o céu dos céus, não te poderiam conter, quanto menos esta casa que eu tenho edificado\" (8:27) — e nela pediu que Deus ouvisse também \"ao estrangeiro, que não for do teu povo Israel\" (8:41). E então a tragédia lenta: setecentas princesas e trezentas concubinas, e \"suas mulheres lhe perverteram o coração\" (11:3); altos a Quemós e a Moloque no monte diante de Jerusalém (11:7). O homem que orara pelo estrangeiro acabou adorando os deuses dele. \"certamente rasgarei de ti este reino, e o darei a teu servo\" (11:11): a sabedoria era dom, não blindagem.",
  },
  "mae-verdadeira": {
    title: "A mãe verdadeira",
    subtitle: "A que preferiu perder o filho a vê-lo dividido (1Rs 3:26)",
    text: "Uma das \"duas mulheres prostitutas\" que vieram ao rei sem testemunha nenhuma para sustentar a sua causa: \"nenhum estranho estava conosco na casa; somente nós duas naquela casa\" (3:16-18). Contou a noite inteira — o filho da outra morto porque \"se deitara sobre ele\", a troca à meia-noite, e a descoberta terrível ao amanhecer: \"atentando pela manhã para ele, eis que não era meu filho, que eu havia tido\" (3:19-21). Quando o rei mandou trazer uma espada e ordenou dividir o menino, foi o corpo dela que respondeu antes da boca: \"porque as suas entranhas se lhe enterneceram por seu filho\", e disse: \"Ah! senhor meu, dai-lhe o menino vivo, e de modo nenhum o mateis\" (3:26). Renunciou ao filho para que o filho vivesse — e foi exatamente essa renúncia que o rei leu como prova: \"Dai a esta o menino vivo, e de maneira nenhuma o mateis, porque esta é sua mãe\" (3:27). O amor verdadeiro é o que abre mão de possuir; e uma mulher sem nome e sem honra na cidade ensinou a Israel o que era a sabedoria de Deus (3:28).",
  },
  "mae-falsa": {
    title: "A mãe falsa",
    subtitle: "A que aceitou a divisão do menino (1Rs 3:26)",
    text: "A outra das duas mulheres do juízo de Salomão: dormiu sobre o próprio filho e o matou, e à meia-noite trocou os meninos enquanto a companheira dormia (3:19-20). Diante do rei, sustentou a mentira em plena inversão: \"Não, mas o vivo é meu filho, e teu filho o morto\" (3:22). Quando a espada foi trazida e a sentença dada — \"Dividi em duas partes o menino vivo; e dai metade a uma, e metade a outra\" (3:25) —, ela não recuou; disse a frase que a condenou para sempre: \"Nem teu nem meu seja; dividi-o\" (3:26). É o retrato exato da inveja: já não quer o bem, quer que ninguém o tenha. Não perdeu a causa por falta de provas, mas porque abriu a boca; a sabedoria de Deus não interrogou testemunhas, apenas deu a cada coração a chance de se mostrar.",
  },
  "hirao-artifice": {
    title: "Hirão, o artífice de cobre",
    subtitle: "Filho de uma viúva de Naftali, fundidor do templo (1Rs 7:13-14)",
    text: "Salomão mandou buscá-lo em Tiro, e o texto se detém na sua origem misturada: \"Era ele filho de uma mulher viúva, da tribo de Naftali, e fora seu pai um homem de Tiro, que trabalhava em cobre; e era cheio de sabedoria, e de entendimento, e de ciência para fazer toda a obra de cobre\" (7:14). A mesma palavra usada para o dom do rei — sabedoria — é usada para as mãos deste operário: o templo foi levantado por um rei sábio e fundido por um fundidor sábio. Suas obras ficaram de pé na porta da casa de Deus: as duas colunas de dezoito côvados, e \"levantando a coluna direita, pôs-lhe o nome de Jaquim; e levantando a coluna esquerda, pôs-lhe o nome de Boaz\" (7:21); \"o mar de fundição, de dez côvados de uma borda até à outra borda, perfeitamente redondo\" (7:23), que \"firmava-se sobre doze bois\" voltados para os quatro ventos (7:25); as dez bases, as pias, as pás e as bacias, \"todos eram de cobre polido\" (7:45). Fundiu tudo longe do templo, na lama do vale: \"Na planície do Jordão, o rei os fundiu em terra barrenta; entre Sucote e Zaretã\" (7:46). Filho de viúva israelita e de pai estrangeiro, é a prova antecipada da oração que Salomão faria naquela casa a favor do estrangeiro (8:41-43).",
  },
  "rainha-de-saba": {
    title: "A rainha de Sabá",
    subtitle: "A que veio de longe provar Salomão com enigmas (1Rs 10:1)",
    text: "\"E ouvindo a rainha de Sabá a fama de Salomão, acerca do nome do SENHOR, veio prová-lo com questões difíceis\" (10:1) — repare no que a moveu: não a fama do ouro, mas a fama ligada ao Nome. \"E chegou a Jerusalém com uma grande comitiva; com camelos carregados de especiarias, e muitíssimo ouro, e pedras preciosas; e foi a Salomão, e disse-lhe tudo quanto tinha no seu coração\" (10:2). Não sobrou enigma: \"nada houve que não lhe pudesse esclarecer\" (10:3). Vendo a sabedoria, a casa, a mesa, os servos e os holocaustos que ele oferecia, \"ficou fora de si\" (10:5) — a ARC guarda assim o fôlego que lhe faltou. Então fez a confissão de quem descobre que a realidade excedeu o boato: \"eu não cria naquelas palavras, até que vim e os meus olhos o viram; eis que não me disseram metade\" (10:7), e terminou louvando não o rei, mas quem o pusera ali: \"Bendito seja o Senhor teu Deus, que teve agrado em ti, para te pôr no trono de Israel\" (10:9). Deu cento e vinte talentos de ouro e voltou para a sua terra (10:10,13). Jesus a levantaria como testemunha contra a própria geração dele: veio dos confins da terra ouvir a sabedoria de Salomão, e ali estava alguém maior do que Salomão (Mt 12:42).",
  },
  "aias-silonita": {
    title: "Aías, o silonita",
    subtitle: "O profeta da capa rasgada em doze pedaços (1Rs 11:29; 14:2)",
    text: "Encontrou Jeroboão fora dos muros, longe de ouvidos: \"o profeta Aías, o silonita, o encontrou no caminho, e ele estava vestido com uma roupa nova, e os dois estavam sós no campo\" (11:29). Então fez a profecia com as mãos, não com a boca: \"E Aías pegou na roupa nova que tinha sobre si, e a rasgou em doze pedaços\", e disse \"Toma para ti os dez pedaços\" (11:30-31). Ainda no mesmo oráculo guardou a promessa que salvaria Judá do nada: \"para que Davi, meu servo, sempre tenha uma lâmpada diante de mim em Jerusalém\" (11:36). Anos depois, cego em Siló — \"já Aías não podia ver, porque os seus olhos estavam já escurecidos por causa da sua velhice\" (14:4) —, recebeu a visita da mulher disfarçada do rei que ele mesmo ungira. Deus o avisou antes, e o velho reconheceu-a pelo som: \"ouvindo Aías o ruído de seus pés, entrando ela pela porta, disse-lhe ele: Entra, mulher de Jeroboão; por que te disfarças assim? Pois eu sou enviado a ti com duras novas\" (14:6). É a lição mais dura do livro sobre disfarces: os olhos cegos do profeta viram o que a fantasia da rainha quis esconder, porque quem enxergava não eram os olhos dele.",
  },
  "jeroboao": {
    title: "Jeroboão, filho de Nebate",
    subtitle: "O servo valente que fez os dois bezerros de ouro (1Rs 11:26; 12:28)",
    text: "O texto o apresenta como \"efrateu, de Zereda, servo de Salomão (cuja mãe era mulher viúva, por nome Zerua)\" (11:26): começou de baixo e subiu por mérito — \"E o homem Jeroboão era forte e valente; e vendo Salomão a este jovem, que era laborioso, ele o pôs sobre todo o cargo da casa de José\" (11:28). Aías lhe deu dez pedaços de uma capa nova e uma promessa condicional imensa: se andasse nos caminhos de Deus, \"te edificarei uma casa firme, como edifiquei a Davi\" (11:38). Salomão tentou matá-lo, e ele fugiu ao Egito, a Sisaque (11:40). Voltou como porta-voz do povo em Siquém e recebeu dez tribos das mãos de Deus. E então, com o reino já na mão, fez as contas do medo no coração: se o povo subisse a Jerusalém para sacrificar, voltaria a Roboão \"e me matarão\" (12:27). Da política de sobrevivência nasceu o pecado que nomeou uma dinastia inteira: \"fez dois bezerros de ouro; e lhes disse: Muito trabalho vos será o subir a Jerusalém; vês aqui teus deuses, ó Israel, que te fizeram subir da terra do Egito\" (12:28), a mesma frase do bezerro de Arão. \"E pôs um em Betel, e colocou o outro em Dã\" (12:29), inventou uma festa no oitavo mês e \"constituiu sacerdotes dos mais baixos do povo, que não eram dos filhos de Levi\" (12:31). Em Betel, quando estendeu a mão contra o profeta, \"a sua mão, que estendera contra ele, se secou\" (13:4) — e a mão foi restituída pela oração do mesmo homem que ele quisera prender, sem que nada mudasse nele: \"Nem depois destas coisas deixou Jeroboão o seu mau caminho\" (13:33). Ficou na Bíblia como a fórmula do desastre do norte: aquele \"que fez pecar a Israel\" (14:16).",
  },
  "mulher-de-jeroboao": {
    title: "A mulher de Jeroboão",
    subtitle: "A rainha disfarçada que perdeu o filho no limiar (1Rs 14:2)",
    text: "Quando Abias adoeceu, o rei mandou a própria esposa em missão de espionagem religiosa: \"Levanta-te agora, e disfarça-te, para que não conheçam que és mulher de Jeroboão; e vai a Siló\" (14:2) — atrás do mesmo profeta que lhe dera o reino, agora consultado às escondidas como se fosse um adivinho de aldeia. Ela levou a paga humilde combinada, \"dez pães, e bolos, e uma botija de mel\" (14:3), e entrou na casa de um cego. Deus, porém, tinha avisado Aías: \"há de ser que, entrando ela, fingirá ser outra\" (14:5). E veio a saudação que desmontou tudo à porta: \"Entra, mulher de Jeroboão; por que te disfarças assim? Pois eu sou enviado a ti com duras novas\" (14:6). Ouviu de pé a sentença sobre a casa do marido e sobre o próprio filho, e a única misericórdia foi a mais dolorosa de todas: só aquele menino teria sepultura, \"porquanto se achou nele coisa boa para com o Senhor Deus de Israel em casa de Jeroboão\" (14:13). Voltou sabendo que a morte a esperava no fim do caminho: \"chegando ela ao limiar da porta, morreu o menino\" (14:17). Não tem nome no livro; tem só o passo que a denunciou e a soleira em que o filho lhe morreu.",
  },
  "roboao": {
    title: "Roboão",
    subtitle: "O filho de Salomão que partiu o reino em Siquém (1Rs 12)",
    text: "Foi a Siquém para ser feito rei e encontrou um povo com uma queixa concreta: \"Teu pai agravou o nosso jugo; agora, pois, alivia tu a dura servidão de teu pai\" (12:4). Pediu três dias e ouviu dois conselhos. Os anciãos lhe deram o retrato do reinado que salva: \"Se hoje fores servo deste povo, e o servires, e respondendo-lhe, lhe falares boas palavras, todos os dias serão teus servos\" (12:7). \"Porém ele deixou o conselho que os anciãos lhe tinham dado\" (12:8) e escolheu os que haviam crescido com ele, que lhe ensinaram a fanfarronice: \"Meu dedo mínimo é mais grosso do que os lombos de meu pai\" (12:10). No terceiro dia \"o rei respondeu ao povo duramente\" (12:13): \"meu pai vos castigou com açoites, porém eu vos castigarei com escorpiões\" (12:14). Dez tribos responderam com o grito que rasgou Israel em dois: \"Que parte temos nós com Davi?\" (12:16). Mandou Adorão, o da leva, e o viu ser apedrejado; escapou por pouco, \"o rei Roboão se animou a subir ao carro para fugir para Jerusalém\" (12:18). Ajuntou cento e oitenta mil homens para reconquistar o norte, e desistiu à palavra de Semaías (12:21-24). Reinou dezessete anos em Judá; sob ele o povo edificou altos e imagens de Aserá (14:23), Sisaque levou os tesouros do templo, e \"era o nome de sua mãe Naamá, amonita\" (14:21). \"porque esta revolta vinha do Senhor\" (12:15): a soberania de Deus não desculpou a estupidez do rei, apenas se serviu dela.",
  },
  "adorao": {
    title: "Adorão",
    subtitle: "O encarregado dos tributos, apedrejado pelo povo (1Rs 12:18)",
    text: "Aparece uma só vez, e para morrer. Diante da revolta das dez tribos, Roboão não mandou negociador nem sacerdote: mandou o cobrador. \"Então o rei Roboão enviou a Adorão, que estava sobre os tributos; e todo o Israel o apedrejou, e ele morreu\" (12:18). O nome está ligado ao mesmo ofício que Salomão criara — Adonirão, filho de Abda, \"sobre o tributo\" (4:6), e o mesmo Adonirão \"estava sobre a leva de gente\" que subia mês a mês ao Líbano (5:14). Era o rosto visível do jugo pesado de que o povo se queixara em Siquém, e foi nele que a raiva de vinte anos de trabalho forçado se descarregou. O rei, que não soubera ouvir, ainda mandou adiante o homem mais odiado do reino, e depois escapou de carro (12:18). É a lição amarga dos funcionários de reis imprudentes: quem paga a conta da soberba do trono raramente é quem se senta nele.",
  },
  "sisaque": {
    title: "Sisaque",
    subtitle: "O rei do Egito que levou os escudos de ouro (1Rs 14:25)",
    text: "Aparece primeiro como asilo político: fugindo de Salomão, \"Jeroboão se levantou, e fugiu para o Egito, a ter com Sisaque, rei do Egito; e esteve no Egito até que Salomão morreu\" (11:40) — o Egito outra vez abrigando aquele que Israel queria matar. Depois volta como cobrador do juízo: \"no quinto ano do rei Roboão, Sisaque, rei do Egito, subiu contra Jerusalém\" (14:25). Não houve batalha narrada, houve esvaziamento: \"E tomou os tesouros da casa do Senhor e os tesouros da casa do rei; e levou tudo. Também tomou todos os escudos de ouro que Salomão tinha feito\" (14:26). E então vem um dos detalhes mais tristes de todo o livro dos Reis: \"em lugar deles fez o rei Roboão escudos de cobre\" (14:27), guardados na câmara da guarda e levados na entrada do rei como se nada tivesse mudado. Cinco anos depois da glória de Salomão, a mesma pompa continuava a desfilar — só que em metal barato. É assim que a decadência costuma começar: sem estrondo, trocando o ouro pelo cobre e mantendo o cerimonial.",
  },
  "homem-de-deus-de-juda": {
    title: "O homem de Deus que veio de Judá",
    subtitle: "O que clamou contra o altar de Betel e morreu no caminho (1Rs 13)",
    text: "\"E eis que, por ordem do SENHOR, veio, de Judá a Betel, um homem de Deus; e Jeroboão estava junto ao altar, para queimar incenso\" (13:1). Não falou ao rei: falou à pedra. \"Altar, altar! Assim diz o Senhor: Eis que um filho nascerá à casa de Davi, cujo nome será Josias, o qual sacrificará sobre ti os sacerdotes dos altos\" (13:2) — profecia que nomeou um rei trezentos anos antes de ele nascer, e que 2 Reis 23 veria cumprir-se letra por letra. Deu um sinal na hora: \"Eis que o altar se fenderá, e a cinza, que nele está, se derramará\" (13:3), e assim se fendeu; a mão do rei estendida contra ele secou, e ele orou por essa mão e ela sarou (13:4-6). Recusou o convite do palácio com uma firmeza exemplar: \"Ainda que me desses metade da tua casa, não iria contigo, nem comeria pão nem beberia água neste lugar\" (13:8). Resistiu ao rei — e caiu diante de um velho da mesma profissão que lhe disse \"Também eu sou profeta como tu\" (13:18). Voltou, comeu, e ouviu a sentença à própria mesa (13:21-22); no caminho \"um leão o encontrou no caminho, e o matou\" (13:24), e o prodígio ficou parado na estrada para que ninguém pensasse em acaso: \"o leão não tinha devorado o corpo, nem tinha despedaçado o jumento\" (13:28). A palavra que ele pregou se cumpriu; a que ele desobedeceu também. Nenhum púlpito dispensa a obediência de quem sobe nele.",
  },
  "profeta-velho-de-betel": {
    title: "O velho profeta de Betel",
    subtitle: "O que mentiu e depois pranteou \"Ah, irmão meu!\" (1Rs 13:11,30)",
    text: "\"E morava em Betel um velho profeta\" (13:11) — morava, isto é, tinha ficado; vivia na cidade do bezerro e não clamara contra o altar. Ouviu dos filhos o que o forasteiro de Judá fizera, mandou albardar o jumento e o foi buscar: \"achou-o assentado debaixo de um carvalho\" (13:14). Diante da recusa, usou a única arma que o outro não sabia repelir — a autoridade profética: \"Também eu sou profeta como tu, e um anjo me falou por ordem do Senhor, dizendo: Faze-o voltar contigo à tua casa\" (13:18). O texto acrescenta o parêntese seco que julga tudo: \"porém mentiu-lhe\". E então acontece o mais estranho: à mesa, a palavra verdadeira do SENHOR veio justamente sobre ele, e foi o mentiroso quem teve de anunciar a morte do homem que enganara (13:20-22). Foi buscar o cadáver, pôs no seu próprio sepulcro e chorou como irmão: \"prantearam-no, dizendo: Ah, irmão meu!\" (13:30). Depois mandou aos filhos: \"ponde os meus ossos junto aos ossos dele\" (13:31), porque acreditava que a palavra contra o altar de Betel se cumpriria — e, séculos depois, foram esses ossos misturados que salvaram o seu sepulcro da fogueira de Josias (2Rs 23:18). Um homem pode mentir em nome de Deus e ainda assim tremer diante do que Deus disse. O arrependimento chegou; o dano, não voltou atrás.",
  },
  "asa": {
    title: "Asa",
    subtitle: "O rei de Judá que depôs a própria avó e queimou o ídolo dela (1Rs 15:11-13)",
    text: "Depois de dois reinados maus, Judá respirou: \"E Asa fez o que era reto aos olhos do Senhor, como Davi seu pai\" (15:11). Limpou a terra — \"tirou da terra os sodomitas, e removeu todos os ídolos que seus pais fizeram\" (15:12) — e foi até onde quase nenhum rei chega, ao próprio sangue: \"E até a Maaca, sua mãe, removeu para que não fosse rainha, porquanto tinha feito um horrível ídolo a Aserá; também Asa desfez o seu ídolo horrível, e o queimou junto ao ribeiro de Cedrom\" (15:13). O texto chama-lhe \"sua mãe\" no sentido de rainha-mãe, pois Maaca fora mulher de Abias, seu pai (15:2): quem ele depôs foi a avó, e queimou publicamente, no vale, o ídolo que ela mandara fazer. Ainda assim a reforma teve limite: \"Os altos, porém, não foram tirados; todavia foi o coração de Asa reto para com o Senhor todos os seus dias\" (15:14). E teve deslize: pressionado por Baasa, esvaziou os tesouros do templo para comprar a espada da Síria — \"Haja acordo entre mim e ti, como houve entre meu pai e teu pai\" (15:19) —, e Ben-Hadade feriu por ele as cidades do norte. Reinou quarenta e um anos, e \"no tempo da sua velhice, padeceu dos pés\" (15:23). Rei bom, reforma pela metade, fé que ao fim se apoiou na cavalaria alheia.",
  },
  "maaca": {
    title: "Maaca",
    subtitle: "A rainha-mãe deposta por causa do ídolo de Aserá (1Rs 15:13)",
    text: "Filha de Absalão e mulher de Roboão, é nomeada duas vezes com a mesma fórmula: \"era o nome de sua mãe Maaca, filha de Absalão\", para Abias (15:2) e ainda para Asa, seu neto (15:10) — sinal de que conservou o posto de rainha-mãe atravessando dois reinados, um poder que em Judá não era pequeno. Usou esse poder para uma coisa só que o texto registra: \"tinha feito um horrível ídolo a Aserá\" (15:13). O neto, no auge da reforma, tirou-lhe o cargo: \"E até a Maaca, sua mãe, removeu para que não fosse rainha\", e o ídolo não foi guardado nem escondido — \"também Asa desfez o seu ídolo horrível, e o queimou junto ao ribeiro de Cedrom\". Uma neta de Absalão, dentro do palácio de Davi, fabricando aquilo que a Lei mandava destruir; e o culto que ela sustentou não morreu com ela — as imagens de Aserá tinham brotado \"sobre todo o alto outeiro e debaixo de toda a árvore verde\" já nos dias de Roboão (14:23). É a demonstração de que a idolatria de Judá não veio só de fora: brotou da própria casa real, e foi preciso um rei disposto a enfrentar a própria família para arrancá-la.",
  },
  "baasa": {
    title: "Baasa",
    subtitle: "O de Issacar que exterminou a casa de Jeroboão e repetiu-lhe os pecados (1Rs 15:27)",
    text: "\"E conspirou contra ele Baasa, filho de Aías, da casa de Issacar, e feriu-o Baasa em Gibetom, que era dos filisteus\" (15:27) — matou Nadabe no cerco e tomou o trono no ano terceiro de Asa. Foi ele o instrumento visível de uma sentença antiga: \"feriu a toda a casa de Jeroboão; nada de Jeroboão deixou que tivesse fôlego, até o destruir, conforme à palavra do Senhor que dissera pelo ministério de seu servo Aías, o silonita\" (15:29). E aqui está a ironia que o livro faz questão de sublinhar: cumprir o juízo de Deus não santificou quem o executou. \"E fez o que era mau aos olhos do Senhor; e andou no caminho de Jeroboão\" (15:34) — matou a casa do pecado e adotou o pecado da casa. Reinou vinte e quatro anos em Tirza, guerreou com Asa e fortificou Ramá para asfixiar Judá (15:17,32). Então veio Jeú, filho de Hanani, com uma acusação em duas partes: \"Porquanto te levantei do pó, e te pus por príncipe sobre o meu povo Israel, e tu tens andado no caminho de Jeroboão\" (16:2), e ainda \"porque o havia ferido\" (16:7). A mesma sentença dada a Jeroboão caiu sobre ele, palavra por palavra: \"Quem morrer dos de Baasa, na cidade, os cães o comerão\" (16:4). Foi enterrado em Tirza, e Zinri não deixou da sua casa \"homem algum, nem a seus parentes, nem a seus amigos\" (16:11).",
  },
  "ela": {
    title: "Elá",
    subtitle: "O rei de Israel morto bêbado na casa do mordomo (1Rs 16:9)",
    text: "\"Elá, filho de Baasa, começou a reinar em Tirza sobre Israel; e reinou dois anos\" (16:8). Não há dele nenhum ato, nenhuma guerra, nenhuma palavra: o livro guarda apenas onde ele estava quando morreu. \"E Zinri, seu servo, capitão de metade dos carros, conspirou contra ele, estando ele em Tirza, bebendo e embriagando-se em casa de Arsa, mordomo em Tirza\" (16:9). O pai morrera na cama e fora sepultado com honra; o filho morreu à mesa de um funcionário, sem defesa e sem juízo: \"Entrou, pois, Zinri, e o feriu, e o matou\" (16:10). A sentença dada a Baasa cumpriu-se nele e na parentela toda, \"Por todos os pecados de Baasa, e os pecados de Elá, seu filho, que cometeram, e com que fizeram pecar a Israel, irritando ao Senhor Deus de Israel com as suas vaidades\" (16:13). Duas linhas de reinado e um cálice na mão: o retrato de um trono que já não governava nada, nem a si mesmo.",
  },
  "zinri": {
    title: "Zinri",
    subtitle: "Sete dias de reinado, que queimou o paço sobre si (1Rs 16:15,18)",
    text: "Capitão de metade dos carros de Elá, matou o senhor a quem servia enquanto este bebia (16:9-10) e sentou-se no trono. Mal se assentou, \"feriu a toda a casa de Baasa; não lhe deixou homem algum, nem a seus parentes, nem a seus amigos\" (16:11), cumprindo sem o saber a palavra de Jeú, filho de Hanani (16:12). Mas o exército estava acampado contra Gibetom, e a notícia correu: \"Zinri tem conspirado, e até matou o rei\" (16:16). No mesmo dia, no arraial, as tropas proclamaram Onri, subiram e cercaram Tirza. \"No ano vigésimo sétimo de Asa, rei de Judá, reinou Zinri sete dias em Tirza\" (16:15) — sete dias, o reinado mais curto de Israel. E o fim foi feito por ele mesmo: \"Zinri, vendo que a cidade era tomada, foi ao paço da casa do rei e queimou-a sobre si; e morreu\" (16:18). Não faltou coragem, faltou tudo o mais; o epitáfio que o texto lhe dá é o mesmo dos outros, \"Por causa dos pecados que cometera, fazendo o que era mau aos olhos do Senhor\" (16:19). Uma semana bastou para provar que tomar um trono e sustentá-lo são coisas diferentes.",
  },
  "onri": {
    title: "Onri",
    subtitle: "O capitão do exército que comprou o monte de Samaria (1Rs 16:24)",
    text: "Chegou ao poder pelo caminho mais direto: o arraial o aclamou. \"Todo o Israel pois, no mesmo dia, no arraial, constituiu rei sobre Israel a Onri, capitão do exército\" (16:16); ele subiu de Gibetom, cercou Tirza e recebeu o reino das mãos do fogo em que Zinri se matou. Ainda teve de vencer uma guerra civil de anos: \"metade do povo seguia a Tibni, filho de Ginate, para o fazer rei, e a outra metade seguia a Onri\" (16:21), até que \"Tibni morreu, e Onri reinou\" (16:22). Sua obra mais duradoura foi um negócio imobiliário: \"E de Semer comprou o monte de Samaria por dois talentos de prata, e edificou nele; e chamou a cidade que edificou Samaria, do nome de Semer, dono do monte\" (16:24) — deu ao reino do norte uma capital em posição forte, que carregaria o nome do vendedor por toda a Escritura até o Novo Testamento. Os anais do mundo lembram Onri como o fundador de uma dinastia poderosa; a Escritura o despacha em quatro versículos com uma frase: \"E fez Onri o que era mau aos olhos do Senhor; e fez pior do que todos quantos foram antes dele\" (16:25). Deus mede reis por outra régua que não a dos historiadores.",
  },
  "acabe": {
    title: "Acabe",
    subtitle: "O rei de Israel que fez mais mal do que todos antes dele (1Rs 16:30)",
    text: "\"E fez Acabe, filho de Onri, o que era mau aos olhos do Senhor, mais do que todos os que foram antes dele\" (16:30), e o texto explica por quê: os bezerros de Jeroboão já lhe pareciam pouco, e \"ainda tomou por mulher a Jezabel, filha de Etbaal, rei dos sidônios; e foi e serviu a Baal, e o adorou\" (16:31), levantando altar e casa a Baal em Samaria. Chamou o profeta de \"És tu o perturbador de Israel?\" (18:17) e depois de \"Já me achaste, inimigo meu?\" (21:20). Não era, porém, um homem de uma peça só: viu o fogo cair no Carmelo e a chuva voltar; poupou Ben-Hadade chamando-lhe \"meu irmão\" (20:32) quando Deus o entregara à destruição; deitou-se na cama com o rosto virado por causa de uma horta, e deixou a mulher matar Nabote em seu nome (21:4-16). O julgamento é implacável e exato: \"Porém ninguém fora como Acabe, que se vendera para fazer o que era mau aos olhos do Senhor; porque Jezabel, sua mulher, o incitava\" (21:25). E, mesmo assim, quando ouviu a sentença, \"rasgou as suas vestes, e cobriu a sua carne de saco, e jejuou; e jazia em saco, e andava mansamente\" (21:27) — e Deus, que vê até a humilhação de um homem vendido, adiou o golpe: \"Não viste que Acabe se humilha perante mim?\" (21:29). Morreu disfarçado em Ramote de Gileade, porque disfarce nenhum desvia uma flecha: \"um homem armou o arco, e atirou a esmo, e feriu o rei de Israel por entre as fivelas e as couraças\" (22:34). Ficou de pé no carro até a tarde, e ao lavarem o carro \"os cães lamberam o seu sangue\" (22:38).",
  },
  "jezabel": {
    title: "Jezabel",
    subtitle: "A filha de Etbaal que armou o jejum e as cartas seladas (1Rs 16:31; 21:8)",
    text: "Princesa fenícia, \"Jezabel, filha de Etbaal, rei dos sidônios\" (16:31), trouxe consigo o culto de Baal para dentro do palácio de Samaria e tratou a fé de Israel como um estorvo administrativo: sustentava à sua mesa \"os quatrocentos profetas de Aserá\" (18:19) enquanto ia \"destruindo Jezabel os profetas do Senhor\" (18:4) — foi por causa dela que Obadias escondeu cem deles em duas covas. Depois do Carmelo, não se abalou nem discutiu: mandou recado, com a serenidade de quem marca hora, \"Assim me façam os deuses, e outro tanto, se de certo amanhã a estas horas não puser a tua vida como a de um deles\" (19:2), e pôs em fuga o homem que enfrentara quatrocentos e cinqüenta. O seu retrato definitivo é a vinha: diante do marido de cara virada para a parede, perguntou \"Governas tu agora no reino de Israel?\" (21:7) e resolveu o assunto com papelada. \"Então escreveu cartas em nome de Acabe, e as selou com o seu sinete\" (21:8), e nelas mandou o roteiro completo — \"Apregoai um jejum, e ponde Nabote diante do povo\" (21:9), dois falsos testemunhos, e o apedrejamento. Usou a religião como instrumento do crime: convocou jejum para matar um justo. A palavra do SENHOR sobre ela é uma das mais duras da Bíblia: \"Os cães comerão a Jezabel junto ao antemuro de Jizreel\" (21:23).",
  },
  "elias": {
    title: "Elias, o tisbita",
    subtitle: "O profeta dos corvos, do fogo do Carmelo e da voz mansa e delicada (1Rs 17–19)",
    text: "Entra na história sem genealogia e sem aviso, \"Elias, o tisbita, dos moradores de Gileade\", plantado diante de Acabe: \"Vive o SENHOR Deus de Israel, perante cuja face estou, que nestes anos nem orvalho nem chuva haverá, senão segundo a minha palavra\" (17:1) — atacou Baal exatamente onde Baal dizia reinar, na chuva. Escondido em Querite, foi sustentado pelo que a Lei chamava imundo: \"E os corvos lhe traziam pão e carne pela manhã; como também pão e carne à noite\" (17:6). Em Sarepta, terra da própria Jezabel, viveu do último punhado de farinha de uma viúva e viu o milagre da provisão diária: \"A farinha da panela não se acabará, e o azeite da botija não faltará\" (17:14). No Carmelo pôs Israel diante da única pergunta que importava — \"Até quando coxeareis entre dois pensamentos? Se o Senhor é Deus, segui-o, e se Baal, segui-o\" (18:21) —, encharcou o altar de água e orou uma oração de trinta segundos; \"Então caiu fogo do Senhor, e consumiu o holocausto, e a lenha, e as pedras, e o pó, e ainda lambeu a água que estava no rego\" (18:38), e o povo caiu de rosto: \"Só o Senhor é Deus!\" (18:39). E no dia seguinte, uma ameaça de mulher o pôs a correr: \"foi sentar-se debaixo de um zimbro; e pediu para si a morte\", dizendo \"Já basta, ó Senhor; toma agora a minha vida, pois não sou melhor do que meus pais\" (19:4). Deus não o repreendeu: mandou um anjo com pão e água, deixou-o dormir, e o levou quarenta dias até Horebe. Ali não estava no vento, nem no terremoto, nem no fogo — \"e depois do fogo uma voz mansa e delicada\" (19:12) —, e a pergunta que ouviu duas vezes foi \"Que fazes aqui, Elias?\" (19:13). À queixa \"só eu fiquei\" (19:14), a resposta desfez a solidão do herói: \"Também deixei ficar em Israel sete mil: todos os joelhos que não se dobraram a Baal\" (19:18). Deus lhe deu trabalho, um sucessor e companhia — e é assim que se cura um profeta esgotado.",
  },
  "viuva-de-sarepta": {
    title: "A viúva de Sarepta",
    subtitle: "A estrangeira que deu o último punhado de farinha (1Rs 17:9)",
    text: "Deus mandou o profeta para fora de Israel, para a terra de Sidom, de onde vinha Jezabel: \"eis que eu ordenei ali a uma mulher viúva que te sustente\" (17:9) — e o \"ordenei\" veio antes de ela saber de nada. Elias a encontrou na porta da cidade, \"uma mulher viúva apanhando lenha\" (17:10), e pediu água e pão a quem estava preparando a última refeição da vida: \"nem um bolo tenho, senão somente um punhado de farinha numa panela, e um pouco de azeite numa botija; e vês aqui apanhei dois cavacos, e vou prepará-lo para mim e para o meu filho, para que o comamos, e morramos\" (17:12). O pedido foi duro — faze primeiro para mim — e ela fez; e o milagre não veio em despensa cheia, veio em fundo de panela que nunca raspava: \"Da panela a farinha não se acabou, e da botija o azeite não faltou\" (17:16). Quando o filho morreu, atirou ao profeta a dor toda: \"Que tenho eu contigo, homem de Deus? vieste tu a mim para trazeres à memória a minha iniqüidade, e matares a meu filho?\" (17:18). Recebeu-o vivo das mãos de Elias e fez a confissão que fecha o capítulo: \"Nisto conheço agora que tu és homem de Deus, e que a palavra do Senhor na tua boca é verdade\" (17:24). Jesus a citaria em Nazaré, para escândalo dos seus: em Israel havia muitas viúvas, e o profeta foi enviado a esta (Lc 4:25-26).",
  },
  "filho-da-viuva-de-sarepta": {
    title: "O filho da viúva de Sarepta",
    subtitle: "O menino que morreu e tornou a viver (1Rs 17:17-23)",
    text: "É o menino por quem a mãe preparava o último bolo antes de morrerem juntos de fome (17:12), e que sobreviveu à fome para adoecer depois: \"adoeceu o filho desta mulher, dona da casa; e a sua doença se agravou muito, até que nele nenhum fôlego ficou\" (17:17). Elias o tomou do regaço da mãe, subiu com ele ao quarto onde morava, deitou-o na sua própria cama e discutiu com Deus: \"Ó Senhor meu Deus, também até a esta viúva, com quem me hospedo, afligiste, matando-lhe o filho?\" (17:20). Então fez o gesto mais estranho e mais corporal de toda a profecia antiga: \"se estendeu sobre o menino três vezes, e clamou ao Senhor, e disse: Ó Senhor meu Deus, rogo-te que a alma deste menino torne a entrar nele\" (17:21). \"E o Senhor ouviu a voz de Elias; e a alma do menino tornou a entrar nele, e reviveu\" (17:22). É a primeira ressurreição registrada na Escritura, e ela não acontece no templo nem em Jerusalém, mas no quarto de cima de uma casa pobre em terra de sidônios. Elias desceu com ele nos braços e disse à mãe as três palavras que a Bíblia repetiria em Naim e em Betânia: \"Vês aí, teu filho vive\" (17:23).",
  },
  "obadias-mordomo": {
    title: "Obadias",
    subtitle: "O mordomo de Acabe que escondeu cem profetas em duas covas (1Rs 18:3-4)",
    text: "\"E Acabe chamou a Obadias, o mordomo; e Obadias temia muito ao Senhor\" (18:3): as duas metades da frase estão em tensão o livro inteiro — mordomo-mor da casa de Acabe e Jezabel, e homem tementíssimo a Deus. Enquanto a rainha varria os profetas do SENHOR, ele montou uma operação de resgate dentro do próprio palácio: \"Obadias tomou cem profetas, e de cinqüenta em cinqüenta os escondeu numa cova, e os sustentou com pão e água\" (18:4) — e, em plena seca, alimentar cem homens escondidos era gastar o que não havia. Enviado pelo rei a procurar erva para os cavalos, encontrou Elias no caminho e caiu por terra: \"prostrou-se sobre o seu rosto, e disse: És tu o meu senhor Elias?\" (18:7). Teve medo de ser morto por anunciá-lo e alegou o seu currículo com uma sinceridade comovente: \"eu, teu servo, temo ao Senhor desde a minha mocidade\" (18:12), e \"Como escondi a cem homens dos profetas do SENHOR, de cinqüenta em cinqüenta, numa cova, e os sustentei com pão e água?\" (18:13). Não subiu ao Carmelo nem chamou fogo do céu; salvou cem vidas com pão, água e silêncio. Ao lado do profeta que enfrenta reis, a Escritura põe o funcionário fiel que serve dentro da casa errada sem se vender a ela.",
  },
  "eliseu": {
    title: "Eliseu",
    subtitle: "O lavrador das doze juntas, chamado pela capa de Elias (1Rs 19:19)",
    text: "Deus o nomeou antes de ele saber: \"a Eliseu, filho de Safate de Abel-Meolá, ungirás profeta em teu lugar\" (19:16) — resposta do céu a um profeta que pedira a morte debaixo de um zimbro. Elias o encontrou no trabalho: \"achou a Eliseu, filho de Safate, que andava lavrando com doze juntas de bois adiante dele, e ele estava com a duodécima\" (19:19), sinal de uma casa próspera, com terra e gado que ele estava para herdar. O chamado veio sem discurso, sem oráculo, sem imposição de mãos: \"e lançou a sua capa sobre ele\". Ele correu atrás e pediu só uma coisa: \"Deixa-me beijar a meu pai e a minha mãe, e então te seguirei\" (19:20). Voltou — e a despedida foi um incêndio: \"tomou a junta de bois, e os matou, e com os aparelhos dos bois cozeu as carnes, e as deu ao povo, e comeram\" (19:21). Queimou o arado para cozinhar os próprios bois e repartiu o banquete com a aldeia: não deixou meio de voltar atrás. \"então se levantou e seguiu a Elias, e o servia\" — e por anos a sua função foi essa, servir, antes de qualquer milagre. Quem põe a mão no arado e olha para trás não é apto (Lc 9:62); Eliseu resolveu o problema queimando o arado.",
  },
  "ben-hadade": {
    title: "Ben-Hadade",
    subtitle: "O rei da Síria dos trinta e dois reis, poupado por Acabe (1Rs 20)",
    text: "Rei de Damasco, aparece primeiro como espada de aluguel: Asa lhe mandou a prata e o ouro do templo, e ele feriu por encomenda as cidades do norte de Israel (15:18-20). Depois sobe como senhor de guerra, com trinta e dois reis vassalos, e cerca Samaria exigindo tudo: \"A tua prata e o teu ouro são meus; e tuas mulheres e os melhores de teus filhos são meus\" (20:3). Gabou-se de que \"o pó de Samaria não bastará para encher as mãos de todo o povo que me segue\" (20:10) e recebeu de volta o provérbio que o desmascarou: \"Não se gabe quem se cinge das armas, como aquele que as descinge\" (20:11). Foi derrotado à hora do meio-dia enquanto \"estava bebendo e embriagando-se nas tendas, ele e os reis, os trinta e dois reis\" (20:16). No ano seguinte voltou com a teologia dos seus conselheiros: \"Seus deuses são deuses dos montes, por isso foram mais fortes do que nós; mas pelejemos com eles em campo raso\" (20:23) — e o SENHOR o desmentiu em pessoa, com o vale escolhido por ele: \"Porquanto os sírios disseram: O Senhor é Deus dos montes, e não Deus dos vales; toda esta grande multidão entregarei nas tuas mãos\" (20:28). Escondendo-se de câmara em câmara em Afeque, salvou-se pela reputação alheia: \"ponhamos, pois, sacos aos lombos, e cordas às cabeças\" (20:31), e a mensagem \"Diz o teu servo Ben-Hadade: Deixa-me viver\" (20:32) fez Acabe abrir os braços — \"Pois ainda vive? É meu irmão\". A clemência mal colocada custou a Acabe a própria vida (20:42).",
  },
  "nabote": {
    title: "Nabote, o jizreelita",
    subtitle: "O que não vendeu a herança de seus pais (1Rs 21:3)",
    text: "\"Nabote, o jizreelita, tinha uma vinha em Jizreel junto ao palácio de Acabe, rei de Samaria\" (21:1) — a proximidade é a tragédia: o rei queria uma horta e o vizinho tinha a terra. A oferta era justa por qualquer critério de mercado, outra vinha melhor ou o valor em dinheiro (21:2). A recusa não foi de preço, foi de fé: \"Guarde-me o Senhor de que eu te dê a herança de meus pais\" (21:3). Em Israel a terra não era mercadoria, era porção recebida do SENHOR e guardada para os filhos (Lv 25:23; Nm 36:7), e Nabote sabia disso melhor do que o seu rei. Morreu por causa dessa lealdade, e pelo instrumento mais cínico possível: um culto. \"Apregoai um jejum, e ponde Nabote diante do povo\" (21:9); dois filhos de Belial juraram \"Nabote blasfemou contra Deus e contra o rei\", e os anciãos e nobres da sua própria cidade obedeceram às cartas seladas — \"E o levaram para fora da cidade, e o apedrejaram, e morreu\" (21:13). O julgamento veio pela boca de Elias, na vinha ainda quente: \"No lugar em que os cães lamberam o sangue de Nabote lamberão também o teu próprio sangue\" (21:19). Deus não esqueceu um pequeno proprietário assassinado por um jejum falso; nenhum sangue de justo cai na terra sem que o céu tome nota.",
  },
  "micaias": {
    title: "Micaías, filho de Inlá",
    subtitle: "O profeta de quem Acabe dizia que nunca lhe profetizava o bem (1Rs 22:8)",
    text: "Estava preso, ou pelo menos afastado, e o rei o descreveu antes de o chamar: \"Ainda há um homem por quem podemos consultar ao Senhor; porém eu o odeio, porque nunca profetiza de mim o que é bom, mas só o mal; este é Micaías, filho de Inlá\" (22:8). O mensageiro tentou comprá-lo pelo caminho, sugerindo que falasse como os quatrocentos, e ouviu a única regra do ofício: \"Vive o Senhor que o que o Senhor me disser isso falarei\" (22:14). Diante dos dois tronos, começou pela ironia, repetindo o coro dos profetas de corte — \"Sobe, e serás bem sucedido\" (22:15) — até que o rei, sem perceber a armadilha, o conjurou a dizer a verdade. Então veio a visão do exército disperso: \"Vi a todo o Israel disperso pelos montes, como ovelhas que não tem pastor\" (22:17), isto é, o rei já morto. E veio a cena mais assombrosa: \"Vi ao Senhor assentado sobre o seu trono, e todo o exército do céu estava junto a ele\" (22:19), e um espírito que se ofereceu — \"Eu sairei, e serei um espírito de mentira na boca de todos os seus profetas\" (22:22). Levou uma bofetada de Zedequias e foi mandado ao cárcere \"com o pão de angústia, e com água de amargura, até que eu venha em paz\" (22:27). Respondeu com a aposta de toda a sua vida: \"Se tu voltares em paz, o Senhor não tem falado por mim\" (22:28). Acabe não voltou. Quatrocentos concordaram e erraram; um discordou e tinha razão — porque a verdade não se decide por maioria.",
  },
  "zedequias-filho-de-quenaana": {
    ...
    text: "Porta-voz dos quatrocentos profetas de corte, entendeu que uma palavra bonita rende mais quando vem com encenação: \"E Zedequias, filho de Quenaaná, fez para si uns chifres de ferro, e disse: Assim diz o Senhor: Com estes ferirás aos sírios, até de todo os consumir\" (22:11). Usou a fórmula dos verdadeiros profetas — \"Assim diz o Senhor\" — e um símbolo tirado da bênção de Moisés a José (Dt 33:17), para dizer ao rei exatamente o que o rei queria ouvir. Quando Micaías revelou o espírito de mentira posto na boca dos profetas, não argumentou: bateu. \"Então Zedequias, filho de Quenaaná, chegou, e feriu a Micaías no queixo, e disse: Por onde saiu de mim o Espírito do Senhor para falar a ti?\" (22:24) — a pergunta de quem tem certeza absoluta de estar do lado de Deus. A resposta foi um endereço e uma data: \"Eis que o verás naquele mesmo dia, quando entrares de câmara em câmara para te esconderes\" (22:25). É o retrato do falso profeta em três traços: o cenário, a fórmula sagrada e a violência contra quem contradiz. Sinceridade não é credencial; sinceramente enganado, ele levou um rei à morte.",
  },
  "josafa": {
    title: "Jeosafá",
    subtitle: "O rei de Judá que pediu para consultar a palavra do SENHOR (1Rs 22:5)",
    text: "Filho de Asa, reinou vinte e cinco anos em Jerusalém e \"andou em todos os caminhos de seu pai Asa, não se desviou deles, fazendo o que era reto aos olhos do Senhor\" (22:43); \"era o nome de sua mãe Azuba, filha de Sili\" (22:42). Fez a paz com o reino do norte depois de gerações de guerra — \"E Jeosafá esteve em paz com o rei de Israel\" (22:45) —, e essa paz foi ao mesmo tempo a sua virtude e a sua armadilha. Aliou-se a Acabe com uma entrega quase excessiva: \"Serei como tu, e o meu povo como o teu povo, e os meus cavalos como os teus cavalos\" (22:4). Mas, no meio do entusiasmo militar, foi ele — não o rei de Israel — quem se lembrou de Deus: \"Peço-te, consulta hoje a palavra do Senhor\" (22:5); e, ouvindo os quatrocentos aplaudirem em coro, insistiu com a pergunta que salva reinos: \"Não há aqui ainda algum profeta do Senhor, ao qual possamos consultar?\" (22:7). Ao ouvir Acabe reclamar de Micaías, repreendeu-o com delicadeza: \"Não fale o rei assim\" (22:8). Ainda assim subiu à batalha, vestido de rei enquanto o aliado se disfarçava, e quase morreu por isso: \"porém Jeosafá gritou\" (22:32), e os capitães o largaram. \"Todavia os altos não se tiraram\" (22:44), e os seus navios de Társis se quebraram em Eziom-Geber (22:49). Um rei bom, que perguntava certo e escolhia mal as companhias.",
  },
  "abiao": {
    title: "Abias, rei de Judá",
    subtitle: "O rei mau a quem foi dada uma lâmpada por amor de Davi (1Rs 15:1-5)",
    text: "Subiu ao trono \"no décimo oitavo ano do rei Jeroboão, filho de Nebate\" (15:1), e o seu reinado inteiro cabe num versículo: \"E reinou três anos em Jerusalém; e era o nome de sua mãe Maaca, filha de Absalão\" (15:2) — três anos apenas, e o veredicto é seco: \"E andou em todos os pecados que seu pai tinha cometido antes dele; e seu coração não foi perfeito para com o Senhor seu Deus como o coração de Davi, seu pai\" (15:3). O que segura a casa em pé não é ele: \"Mas por amor de Davi o Senhor seu Deus lhe deu uma lâmpada em Jerusalém, levantando a seu filho depois dele, e confirmando a Jerusalém\" (15:4). A lâmpada é a promessa feita a Davi, e ela arde num reinado que não a merece — o trono continua porque Deus prometeu, não porque o rei serviu. O texto ainda explica em que consistia a fidelidade de Davi, e com uma honestidade rara: \"não se tinha desviado de tudo quanto lhe ordenara em todos os dias da sua vida, senão só no negócio de Urias, o heteu\" (15:5). Guerreou com o norte todos os seus dias (15:7) e deixou o trono a Asa, que faria o que ele não fez. Não confundir com Abias, o menino filho de Jeroboão, que morreu em Tirza no mesmo período (14:17).",
  },
  "nadabe": {
    title: "Nadabe",
    subtitle: "O filho de Jeroboão, morto no cerco de Gibetom (1Rs 15:25-28)",
    text: "\"E Nadabe, filho de Jeroboão, começou a reinar sobre Israel no ano segundo de Asa, rei de Judá; e reinou sobre Israel dois anos\" (15:25). Herdou o trono e, com ele, o culto dos bezerros: \"E fez o que era mau aos olhos do Senhor; e andou nos caminhos de seu pai, e no seu pecado com que seu pai fizera pecar a Israel\" (15:26). Morreu em campanha, cercando uma cidade filisteia, traído por um dos seus: Baasa \"feriu-o Baasa em Gibetom, que era dos filisteus, quando Nadabe e todo o Israel cercavam a Gibetom\" (15:27), \"E matou-o, pois, Baasa no ano terceiro de Asa, rei de Judá, e reinou em seu lugar\" (15:28). Com ele acabou a casa de Jeroboão, que Aías anunciara e Baasa executou sem deixar \"que tivesse fôlego\" (15:29). Foi o irmão do menino Abias, o único da família a quem coube pranto e sepultura — e a diferença entre os dois destinos foi só uma: naquele \"se achou nele coisa boa para com o Senhor Deus de Israel\" (14:13), neste não se achou nada.",
  },
  "tibni": {
    title: "Tibni, filho de Ginate",
    subtitle: "O rei que metade de Israel seguiu e que a história perdeu (1Rs 16:21)",
    text: "Depois dos sete dias de Zinri, o reino do norte não teve um sucessor, teve dois: \"Então o povo de Israel se dividiu em dois partidos: metade do povo seguia a Tibni, filho de Ginate, para o fazer rei, e a outra metade seguia a Onri\" (16:21). Não sabemos de que tribo era, nem o que prometeu, nem quanto tempo durou a disputa — só que metade de Israel apostou nele. O desfecho cabe num versículo: \"Mas o povo que seguia a Onri foi mais forte do que o povo que seguia a Tibni, filho de Ginate; e Tibni morreu, e Onri reinou\" (16:22). O texto não diz que Deus o levantou nem que o rejeitou; não lhe dá sequer a fórmula de juízo que dá a todos os reis. É uma nota de rodapé sangrenta sobre um reino que já trocara três dinastias em poucos anos, e um lembrete de como a Escritura mede as coisas: a força que decidiu quem reinaria em Samaria não rendeu mais do que duas linhas.",
  },
  "semaias": {
    title: "Semaías",
    subtitle: "O homem de Deus que impediu a guerra entre irmãos (1Rs 12:22-24)",
    text: "Roboão já tinha o exército pronto — \"cento e oitenta mil escolhidos, destros para a guerra\" (12:21) — para retomar à força as dez tribos e reunificar o reino. Foi então que \"veio a palavra de Deus a Semaías, homem de Deus\" (12:22), mandando falar não só ao rei, mas a toda a casa de Judá, a Benjamim e ao restante do povo — porque a ordem tinha de chegar a quem já estava com a espada na mão. A mensagem é curta e desmonta o argumento inteiro: \"Assim diz o Senhor: Não subireis nem pelejareis contra vossos irmãos, os filhos de Israel; volte cada um para a sua casa, porque eu é que fiz esta obra\" (12:24). Duas coisas ali: são irmãos, e a divisão é obra de Deus, não acidente de política. E aconteceu o milagre mais raro do livro dos Reis — obedeceram: \"E ouviram a palavra do Senhor, e voltaram segundo a palavra do Senhor\". Um profeta sem sinais, sem fogo e sem confronto evitou uma guerra civil entre cento e oitenta mil homens dizendo uma frase. Nem todo ministério profético é espetacular; alguns apenas mandam o povo para casa, e salvam uma geração.",
  },
  "jeu-filho-de-hanani": {
    title: "Jeú, filho de Hanani",
    subtitle: "O profeta que sentenciou a casa de Baasa (1Rs 16:1)",
    text: "\"Então veio a palavra do SENHOR a Jeú, filho de Hanani, contra Baasa\" (16:1) — não é o Jeú, filho de Ninsi, que Elias receberia ordem de ungir rei (19:16), mas um profeta, filho de profeta, cuja família reaparece em Judá gerações depois. A sua mensagem começa lembrando a origem humilde do acusado: \"Porquanto te levantei do pó, e te pus por príncipe sobre o meu povo Israel, e tu tens andado no caminho de Jeroboão, e tens feito pecar a meu povo Israel\" (16:2) — o pecado é agravado pelo favor recebido. Depois vem a sentença que copia palavra por palavra a que fora dada à casa que Baasa exterminara: \"farei a tua casa como a casa de Jeroboão, filho de Nebate\" (16:3), \"Quem morrer dos de Baasa, na cidade, os cães o comerão; e o que dele morrer no campo, as aves do céu o comerão\" (16:4). E o oráculo acrescenta um motivo que faz pensar: Baasa é condenado pelo mal que fez \"e porque o havia ferido\" (16:7) — cumpriu o juízo de Deus sobre Jeroboão com as mãos sujas do próprio interesse. Anos mais tarde o narrador registra o cumprimento \"conforme à palavra do Senhor que, contra Baasa, ele falara pelo ministério do profeta Jeú\" (16:12). Deus usa homens maus como vara; e depois julga a vara.",
  },
  "hadade": {
    title: "Hadade, o edomeu",
    subtitle: "O príncipe de Edom criado na casa de Faraó (1Rs 11:14)",
    text: "\"Levantou, pois, o Senhor contra Salomão um adversário, Hadade, o edomeu; ele era da descendência do rei em Edom\" (11:14) — o texto é claro sobre a autoria: o adversário foi levantado por Deus, e a paz do reinado sábio começou a rachar por dentro. A sua história vem de longe: quando Joabe passou seis meses em Edom até destruir \"a todo o homem em Edom\" (11:16), este menino escapou com alguns servos do pai; \"era, porém, Hadade muito jovem\" (11:17). Foi acolhido pelo Egito com honras de casa real: \"E achou Hadade grande graça diante de Faraó, de maneira que lhe deu por mulher a irmã de sua mulher, a irmã de Tafnes, a rainha\" (11:19), e o filho Genubate cresceu \"na casa de Faraó, entre os filhos de Faraó\" (11:20). Ao saber que Davi e Joabe tinham morrido, pediu licença para voltar; Faraó estranhou, e ele repetiu o pedido sem explicar nada: \"Nada, mas todavia despede-me\" (11:22). Não precisava explicar — Faraó sabia. É a memória de uma matança antiga voltando como política externa uma geração depois: o sangue derramado em Edom nos dias de Davi cobrou o preço nos dias de Salomão.",
  },
  "rezom": {
    title: "Rezom, filho de Eliada",
    subtitle: "O chefe de bando que reinou em Damasco (1Rs 11:23)",
    text: "O segundo espinho levantado contra Salomão: \"Também Deus lhe levantou outro adversário, a Rezom, filho de Eliada, que tinha fugido de seu senhor Hadadezer, rei de Zobá\" (11:23). Começou como desertor, virou capitão de bando — \"ajuntou homens, e foi capitão de um esquadrão, quando Davi os matou\" (11:24) — e acabou fundando um poder que atormentaria Israel por séculos: \"e, indo-se para Damasco, habitaram ali, e reinaram em Damasco\". Enquanto Salomão recebia a rainha de Sabá e enchia Jerusalém de prata como pedras, um bandido tomava a cidade da qual sairiam os Ben-Hadades e os Hazaéis que sangrariam o reino do norte. O resumo que o texto lhe dá é de ódio persistente: \"E foi adversário de Israel, por todos os dias de Salomão, e isto além do mal que Hadade fazia; porque detestava a Israel, e reinava sobre a Síria\" (11:25). Está no capítulo do coração desviado, e não por acaso: quando um rei se afasta de Deus, os adversários não precisam ser criados do nada — basta que Deus deixe de os conter.",
  },
  "acazias": {
    title: "Acazias",
    subtitle: "O filho de Acabe que serviu a Baal (1Rs 22:52-54)",
    text: "\"Assim dormiu Acabe com seus pais; e Acazias, seu filho, reinou em seu lugar\" (22:40). Reinou pouco: \"E Acazias, filho de Acabe, começou a reinar sobre Israel, em Samaria, no ano dezessete de Jeosafá, rei de Judá; e reinou dois anos sobre Israel\" (22:52). O veredicto sobre ele soma três heranças, e a do meio é a que mais pesa: \"E fez o que era mau aos olhos do Senhor; porque andou no caminho de seu pai, como também no caminho de sua mãe, e no caminho de Jeroboão, filho de Nebate, que fez pecar a Israel\" (22:53). Poucos reis recebem essa menção explícita à mãe — mas era Jezabel, e a casa que ela montou continuou de pé depois de morto o marido. O último traço é a religião escolhida sem disfarce: \"E serviu a Baal, e adorou-o, e provocou a ira do Senhor Deus de Israel, conforme a tudo quanto fizera seu pai\" (22:54). Ainda tentou sociedade marítima com Judá, e foi recusado: \"Vão os meus servos com os teus servos nos navios. Porém Jeosafá não quis\" (22:50). O fogo do Carmelo caíra diante dos olhos da geração dele; não bastou. A fé não se herda por sangue, e o filho de Acabe é a prova.",
  },
  "hiel-o-betelita": {
    title: "Hiel, o betelita",
    subtitle: "O que reedificou Jericó sobre os próprios filhos (1Rs 16:34)",
    text: "Um único versículo, encaixado entre a idolatria de Acabe e a chegada de Elias, e ele carrega o peso de uma maldição de quinhentos anos: \"Em seus dias Hiel, o betelita, edificou a Jericó; em Abirão, seu primogênito, a fundou, e em Segube, seu filho menor, pôs as suas portas; conforme a palavra do Senhor, que falara pelo ministério de Josué, filho de Num\" (16:34). Josué jurara que quem reedificasse aquela cidade a fundaria à custa do primogênito e lhe poria as portas à custa do caçula (Js 6:26). Hiel construiu assim mesmo — e perdeu o primeiro filho ao lançar os alicerces e o último ao pendurar os portões, do começo ao fim da obra. O narrador põe isso exatamente ali de propósito: nos dias de Acabe, quando Israel tratava a palavra do SENHOR como folclore de outra era, um homem provou na própria casa que ela não caducou. É o prólogo silencioso do capítulo seguinte, em que um profeta chega dizendo que não haverá orvalho nem chuva senão segundo a sua palavra (17:1). Deus não esqueceu o que disse por Josué; e não esqueceria o que ia dizer por Elias.",
  },
  "semer-dono-do-monte": {
    title: "Semer",
    subtitle: "O dono do monte que deu nome a Samaria (1Rs 16:24)",
    text: "Aparece só como vendedor, num negócio de duas linhas: \"E de Semer comprou o monte de Samaria por dois talentos de prata, e edificou nele; e chamou a cidade que edificou Samaria, do nome de Semer, dono do monte\" (16:24). Não sabemos nada dele — nem tribo, nem descendência, nem se resistiu ou negociou de bom grado com o novo rei. Vendeu um monte por dois talentos de prata, e o nome ficou. Ficou na capital do reino do norte durante mais de cento e cinqüenta anos; ficou nos oráculos de Amós e Oseias contra a cidade; ficou no cativeiro da Assíria; ficou nos samaritanos do Novo Testamento, na mulher do poço e no bom samaritano da parábola. Não há na Escritura melhor exemplo de quanto um homem comum pode marcar a história sem ter feito nada de extraordinário: um proprietário anônimo emprestou o próprio nome ao lugar onde Acabe levantaria a casa de Baal e onde Elias enfrentaria reis.",
  },
  "arsa-mordomo": {
    title: "Arsa",
    subtitle: "O mordomo em Tirza, em cuja casa Elá foi morto (1Rs 16:9)",
    text: "O nome aparece uma vez, como endereço de um assassinato: \"E Zinri, seu servo, capitão de metade dos carros, conspirou contra ele, estando ele em Tirza, bebendo e embriagando-se em casa de Arsa, mordomo em Tirza\" (16:9). Era o encarregado da casa do rei na capital — o mesmo cargo que Obadias teria com Acabe (18:3) —, e foi o seu telhado que abrigou a noite em que a dinastia de Baasa acabou. O texto não diz se ele foi cúmplice, testemunha ou apenas anfitrião de um rei que bebia demais; deixa só o detalhe, e o detalhe basta. Um rei de Israel morreu embriagado na sala de um funcionário, longe do campo de batalha onde o exército inteiro estava acampado contra Gibetom (16:15). Arsa é o nome que a Escritura conservou de um homem que estava no lugar errado, na noite errada, servindo o senhor errado.",
  },
  "etbaal-rei-dos-sidonios": {
    title: "Etbaal",
    subtitle: "Rei dos sidônios, pai de Jezabel (1Rs 16:31)",
    text: "Nomeado uma só vez, numa frase que explica meio livro: \"ainda tomou por mulher a Jezabel, filha de Etbaal, rei dos sidônios; e foi e serviu a Baal, e o adorou\" (16:31). Sidom era a potência fenícia com que Israel sempre negociara — dela vieram os cortadores de madeira do templo, \"porque bem sabes tu que entre nós ninguém há que saiba cortar a madeira como os sidônios\" (5:6) —, mas dela veio também Astarote, que Salomão seguiu na velhice, a \"deusa dos sidônios\" (11:5,33). Ao casar o filho com a filha de Etbaal, a casa de Onri comprou aliança comercial e recebeu, no mesmo pacote, um culto de Estado. O próprio nome do sogro traz Baal dentro, e a filha que ele criou não veio a Samaria para se converter: veio para converter. Etbaal não faz nada na narrativa, e é justamente esse o ponto — os grandes desastres espirituais de Israel entram quase sempre por um contrato bem-sucedido, assinado por homens que só pensavam em política.",
  },
  "azuba": {
    title: "Azuba",
    subtitle: "Filha de Sili, mãe de Jeosafá (1Rs 22:42)",
    text: "\"E era Jeosafá da idade de trinta e cinco anos quando começou a reinar; e vinte e cinco anos reinou em Jerusalém; e era o nome de sua mãe Azuba, filha de Sili\" (22:42). É tudo o que a Escritura diz dela, e mesmo assim ela está ali por um motivo: no livro dos Reis, a fórmula que nomeia a mãe de cada rei de Judá é parte do julgamento do reinado — é por ela que sabemos que Maaca corrompeu Abias com o ídolo de Aserá (15:2,13) e que Naamá, a amonita, criou Roboão (14:21). Azuba é a mãe de um dos poucos reis de quem o texto diz que \"andou em todos os caminhos de seu pai Asa, não se desviou deles, fazendo o que era reto aos olhos do Senhor\" (22:43). Foi mulher de Asa, o rei que queimou o ídolo da rainha-mãe anterior no Cedrom, e criou o filho na geração em que Judá voltou a temer o SENHOR. A Bíblia guarda o nome sem contar a história — e o silêncio, aqui, é elogio: nada de ruim há para dizer.",
  },
  "naama-amonita": {
    title: "Naamá, a amonita",
    subtitle: "A mãe de Roboão, nomeada duas vezes (1Rs 14:21,31)",
    text: "O texto a nomeia no começo e no fim do reinado do filho, com a mesma fórmula: \"era o nome de sua mãe Naamá, amonita\" (14:21) e, de novo, ao sepultar Roboão, \"era o nome de sua mãe Naamá, amonita\" (14:31). Não é repetição descuidada; é o narrador cravando duas vezes a mesma informação para que ninguém a perca. Era uma das \"muitas mulheres estrangeiras\" que Salomão amou, \"moabitas, amonitas, edomitas, sidônias e hetéias\" (11:1), das nações de que Deus dissera \"perverterão o vosso coração para seguirdes os seus deuses\" (11:2). O rei que edificou um alto \"a Moloque, a abominação dos filhos de Amom\" (11:7) teve por herdeiro um filho de mulher amonita. E o reinado desse filho é descrito assim: \"E fez Judá o que era mau aos olhos do Senhor\" (14:22), e \"também eles edificaram altos, e estátuas, e imagens de Aserá sobre todo o alto outeiro e debaixo de toda a árvore verde\" (14:23). O aviso da Lei não era xenofobia — Rute, a moabita, está na genealogia de Davi. Era sobre o culto que entra em casa junto com o casamento; e Naamá é o nome que a Escritura pôs, duas vezes, nessa advertência.",
  },
  "filha-de-farao": {
    title: "A filha de Faraó",
    subtitle: "A mulher egípcia de Salomão, que subiu da Cidade de Davi (1Rs 3:1; 9:24)",
    text: "Abre a era de ouro e a assombra ao mesmo tempo: \"E Salomão se aparentou com Faraó, rei do Egito; e tomou a filha de Faraó, e a trouxe à cidade de Davi, até que acabasse de edificar a sua casa, e a casa do SENHOR, e a muralha de Jerusalém em redor\" (3:1). O casamento era diplomacia do mais alto nível — nenhum rei antes de Salomão recebera uma princesa do Egito —, e veio com dote de guerra: \"Porque Faraó, rei do Egito, subiu e tomou a Gezer, e a queimou a fogo, e matou os cananeus que moravam na cidade, e a deu em dote à sua filha, mulher de Salomão\" (9:16). O rei lhe construiu palácio próprio, \"também para a filha de Faraó, que Salomão tomara por mulher, fez uma casa semelhante àquele pórtico\" (7:8), e registrou a mudança com um cuidado que revela desconforto: \"Subiu, porém, a filha de Faraó da cidade de Davi, à sua casa, que Salomão lhe edificara\" (9:24) — tirou-a do bairro onde estivera a arca. Ela encabeça a lista fatal: \"E o rei Salomão amou muitas mulheres estrangeiras, além da filha de Faraó\" (11:1). O Egito de onde Deus tirara Israel voltou a Jerusalém pela porta da frente, como sogro do rei; e, uma geração depois, voltaria outra vez, com Sisaque, pela porta do tesouro (14:25-26).",
  },
  "abias-filho-de-jeroboao": {
    title: "Abias, filho de Jeroboão",
    subtitle: "O menino em quem se achou coisa boa para com o SENHOR (1Rs 14:13)",
    text: "\"Naquele tempo adoeceu Abias, filho de Jeroboão\" (14:1) — e um reino inteiro se moveu por causa de uma febre de criança: o pai, que erguera bezerros de ouro para não precisar de Jerusalém, mandou a mulher disfarçada a Siló consultar o profeta do SENHOR (14:2-3). Deus, que não é consultado às escondidas, mandou pelo cego Aías a sentença sobre a casa toda: \"destruirei de Jeroboão todo o homem até ao menino\", e os que morressem seriam comidos pelos cães e pelas aves (14:10-11). No meio dessa condenação, um versículo se abre como uma janela: \"E todo o Israel o pranteará, e o sepultará; porque de Jeroboão só este entrará em sepultura, porquanto se achou nele coisa boa para com o Senhor Deus de Israel em casa de Jeroboão\" (14:13). Numa casa que o texto descreve como esterco a ser varrido (14:10), Deus achou alguma coisa boa — e foi num menino. A morte veio no instante marcado: \"chegando ela ao limiar da porta, morreu o menino\" (14:17), e todo o Israel o pranteou (14:18). Morrer cedo foi a misericórdia que lhe coube: foi levado antes do juízo, e é o único da sua casa a ter sepultura e lágrimas. Deus lê corações um por um, mesmo dentro da família mais condenada do livro.",
  },
};
...
export const PROP_TAG_INFO: Record<string, StageInfo> = {
  ...
  // ---- 2 SAMUEL 1–8: os objetos-marco da coroa saqueada, do cântico do arco,
  // ---- da arca que subiu a Jerusalém e do trono firmado para sempre ----

  "arco-de-jonatas": {
    title: "O arco de Jônatas",
    subtitle: "2Sm 1:22 — o arco que nunca se retirou para trás",
    text: "O arco de guerra do mundo antigo era feito de madeira laminada com tendão e chifre, e a aljava pendia do ombro do arqueiro; entre os homens de Benjamim era a arma nacional, e Jônatas a trazia desde moço. No cântico, Davi o nomeia junto com a espada do pai: \"Do sangue dos feridos, da gordura dos valentes, nunca se retirou para trás o arco de Jônatas, nem voltou vazia a espada de Saul\" (2Sm 1:22). Retirar-se para trás é o gesto do arqueiro que recua para poupar flecha; deste arco o poema diz que nunca fez isso. Davi já tivera esse arco nas mãos uma vez, no dia do pacto entre os dois: \"Jônatas se despojou da capa que trazia sobre si, e a deu a Davi, como também as suas vestes, até a sua espada, e o seu arco, e o seu cinto\" (1Sm 18:4). E foi com flechas atiradas ao campo que o amigo lhe mandou o último recado, quando não podia mais falar-lhe em público (1Sm 20:36). A arma que selou a amizade é a mesma que o cântico agora deixa largada no chão de Gilboa.",
  },
  "arco-do-cantico": {
    title: "O arco do cântico",
    subtitle: "2Sm 1:18 — o uso do arco ensinado aos filhos de Judá",
    text: "Entre a lamentação e o seu texto, o narrador põe uma nota de ofício: \"Dizendo ele que ensinassem aos filhos de Judá o uso do arco\" (2Sm 1:18). A elegia ganhou o nome da arma que ela chora e virou lição obrigatória — o CÂNTICO DO ARCO, decorado pelos meninos de Judá como quem decora um salmo. Havia razão prática: Israel perdera Gilboa para arqueiros, pois \"a peleja se agravou contra Saul, e os flecheiros o alcançaram\" (1Sm 31:3), e o povo de Davi teria de aprender o que Benjamim já sabia. Mas o que se ensinava com o arco não era só pontaria: era a memória de dois homens, o respeito devido ao ungido do SENHOR e a recusa de festejar a queda de um inimigo. Davi transforma a maior derrota da nação em currículo, e põe uma geração inteira a cantar o luto pelo rei que o caçava.",
  },
  "coroa-de-saul": {
    title: "A coroa e o bracelete de Gilboa",
    subtitle: "2Sm 1:10 — a primeira coroa que chega às mãos de Davi",
    text: "\"tomei a coroa que tinha na cabeça, e o bracelete que trazia no braço, e os trouxe aqui a meu senhor\" (2Sm 1:10). O diadema real e a manilha do braço eram as duas insígnias que um rei do Oriente levava sobre o corpo; tiradas de um cadáver no campo, valiam como prova jurídica de que o trono estava vago. O amalequita as põe aos pés de Davi esperando recompensa, e recebe sentença: \"Como não temeste tu estender a mão para matares ao ungido do Senhor?\" (2Sm 1:14). A primeira coroa que chega às mãos de Davi vem de um saque — e por isso ele não a põe na cabeça: \"Então apanhou Davi as suas vestes, e as rasgou\" (2Sm 1:11), e jejuou até à tarde. O reino que ele há de receber virá da unção de Deus e do consentimento das tribos; nunca de um despojo arrancado de um morto.",
  },
  "espada-de-saul": {
    title: "A espada de Saul",
    subtitle: "2Sm 1:22 — a espada que nunca voltou vazia",
    text: "A espada da Idade do Ferro em Canaã era curta e reta, arma de aperto, usada quando as linhas já se tinham fechado; a do rei era também insígnia, e num tempo em que \"não se achou nem espada nem lança na mão de todo o povo\" só Saul e Jônatas as tinham (1Sm 13:22). O cântico a louva sem ressalva: \"nunca se retirou para trás o arco de Jônatas, nem voltou vazia a espada de Saul\" (2Sm 1:22). Davi elogia a arma do homem que passou anos apontando-a contra ele, e é essa generosidade que dá grandeza ao poema. Mas a mesma espada teve o seu último serviço voltado para dentro: no monte, cercado pelos flecheiros, \"Saul tomou a espada, e se lançou sobre ela\" (1Sm 31:4). Uma lâmina que nunca voltou vazia acabou por não poupar nem o próprio dono.",
  },
  "livro-de-jasher": {
    title: "O livro de Jasher",
    subtitle: "2Sm 1:18 — o rolo onde a lamentação ficou escrita",
    text: "\"Eis que está escrito no livro de Jasher\" (2Sm 1:18). JASHER quer dizer O RETO, e o livro era uma coletânea nacional de poemas de guerra e feitos memoráveis de Israel, guardada em rolo, fora do cânon e hoje perdida. A Escritura o cita apenas duas vezes: aqui, e no dia em que o sol se deteve sobre Gibeom — \"Isto não está escrito no livro de Jasher?\" (Js 10:13). Que a elegia de Davi tenha entrado nele diz o lugar que o cântico passou a ocupar: não era devoção particular de um homem ferido, era documento público da nação. O rolo em cena é a prova de que aquele luto foi escrito, copiado e ensinado — e não deixado passar com o tempo.",
  },

  "buzina-de-joabe": {
    title: "A buzina de Joabe",
    subtitle: "2Sm 2:28 — o sopro que parou a peleja",
    text: "A buzina de Israel era o chifre de carneiro trabalhado, de som áspero e longo alcance: o meio de comando do campo de batalha, com que se convocava, se avançava e se recolhia a tropa. \"Então Joabe tocou a buzina, e todo o povo parou, e não perseguiram mais a Israel; e tampouco pelejaram mais\" (2Sm 2:28). O que a fez soar não foi vitória nem derrota, mas uma pergunta gritada do alto do outeiro por Abner: \"Consumirá a espada para sempre? Não sabes tu que por fim haverá amargura?\" (2Sm 2:26). É a mesma buzina que Joabe tocará no fim da revolta de Seba, quando a cabeça do rebelde é lançada por cima do muro (2Sm 20:22): nas mãos deste homem, o chifre encerra guerras que a sua própria dureza ajudou a começar. Um sopro basta para parar o que uma frase começou — mas nenhum dos vinte e quatro moços mortos ao pé do tanque volta por causa dele.",
  },
  "coroa-de-juda": {
    title: "A coroa de Judá",
    subtitle: "2Sm 2:4 — a unção em Hebrom, sobre uma tribo só",
    text: "\"Então vieram os homens de Judá, e ungiram ali a Davi rei sobre a casa de Judá\" (2Sm 2:4). É a segunda unção de Davi — a primeira fora em segredo, na casa de Jessé — e ainda não é o reino inteiro: sete anos e seis meses ele reinaria em Hebrom sobre uma tribo, enquanto Abner fazia rei a Is-Bosete do outro lado do Jordão (2Sm 2:11). A coroa em cena é pequena de propósito. Davi não a toma pela força: consulta primeiro (\"Subirei a alguma das cidades de Judá?\"), sobe para onde lhe mandam e espera que os homens de Judá venham a ele. E a primeira coisa que faz de coroa na cabeça não é atacar o rival, mas abençoar os que sepultaram o rei morto: \"Benditos sejais vós do SENHOR, que fizestes tal beneficência a vosso senhor, a Saul\" (2Sm 2:5).",
  },
  "espadas-de-helcate-hazurim": {
    title: "As espadas de Helcate-Hazurim",
    subtitle: "2Sm 2:16 — o campo das espadas, junto a Gibeom",
    text: "\"E cada um lançou mão da cabeça do outro, cravou-lhe a espada no lado, e caíram juntos, por isso se chamou àquele lugar Helcate-Hazurim, que está junto a Gibeom\" (2Sm 2:16). O nome quer dizer CAMPO DOS LADOS AFIADOS, ou campo das espadas, e nasceu de um combate combinado: doze de Benjamim e doze dos servos de Davi, escolhidos para decidir por representação o que dois reinos não queriam decidir em batalha aberta. Não decidiu nada — os vinte e quatro agarraram-se pela cabeça e morreram todos no mesmo instante, e \"seguiu-se naquele dia uma crua peleja\" (2Sm 2:17). A proposta de Abner, \"Deixa levantar os moços, e joguem diante de nós\" (2Sm 2:14), é a mentira mais antiga da guerra civil: a de que se pode medir sangue com sangue e parar a tempo. As espadas fincadas naquele chão são a conta desse cálculo, e o resto do livro paga por ela.",
  },
  "lanca-de-abner": {
    title: "A lança de Abner",
    subtitle: "2Sm 2:23 — a extremidade traseira que atravessou Asael",
    text: "A lança israelita tinha ponta de ferro numa extremidade e, na outra, um contrapeso agudo com que se fincava a arma no chão — é o que estava espetado à cabeceira de Saul enquanto ele dormia, quando \"a sua lança estava fincada na terra à sua cabeceira\" (1Sm 26:7). Foi com essa extremidade de trás, e não com a ponta de matar, que Abner tentou apenas travar o rapaz que o perseguia: \"Abner o feriu com a ponta da lança pela quinta costela, e a lança lhe saiu por detrás, e caiu ali, e morreu naquele mesmo lugar\" (2Sm 2:23). Três vezes o capitão pedira que Asael se desviasse, e a razão que deu não era medo do moço: \"E como levantaria eu o meu rosto diante de Joabe, teu irmão?\" (2Sm 2:22). O narrador guarda o efeito da cena numa frase fria: \"todos os que chegavam ao lugar onde Asael caiu e morreu, paravam\". Desta lança nasce a vingança de sangue que matará Abner à porta de Hebrom e perseguirá Joabe até junto ao altar (1Rs 2:5,28-34).",
  },
  "sepultura-de-saul-em-jabes": {
    title: "A sepultura de Saul em Jabes",
    subtitle: "2Sm 2:4-5 — os ossos debaixo do arvoredo",
    text: "Jabes-Gileade devia a Saul a própria existência: foi a primeira cidade que ele salvou, no começo do reinado, quando Naás, o amonita, ameaçava arrancar a cada homem o olho direito (1Sm 11:2). Quarenta anos depois os homens de Jabes pagaram a dívida — atravessaram a noite, tiraram os corpos do muro de Bete-Sã e \"tomaram os seus ossos, e os sepultaram debaixo de um arvoredo, em Jabes, e jejuaram sete dias\" (1Sm 31:13). É esta sepultura que provoca a primeira palavra do rei recém-ungido: \"Os homens de Jabes-Gileade foram os que sepultaram a Saul\" (2Sm 2:4), e Davi manda mensageiros abençoá-los pela beneficência feita ao seu senhor. Muito mais tarde ele iria buscar aqueles ossos, \"os ossos de Saul, e os ossos de Jônatas seu filho\", para os enterrar na terra de Benjamim (2Sm 21:12-14). A primeira providência do reino novo foi honrar uma cova cavada por gratidão — e não caçar o que restava da casa do rei morto.",
  },
  "sepultura-do-pai-de-asael": {
    title: "A sepultura do pai de Asael",
    subtitle: "2Sm 2:32 — o jazigo da família em Belém",
    text: "\"E levantaram a Asael, e sepultaram-no na sepultura de seu pai, que estava em Belém\" (2Sm 2:32). O sepulcro de família em Judá era uma câmara escavada na rocha e fechada por uma laje, onde as gerações eram recolhidas umas sobre as outras: ser posto ali era ser recebido de volta em casa. Asael era filho de Zeruia, irmã de Davi, e por isso Belém é a cidade dele e a do rei — a guerra civil já está matando dentro da própria parentela. Fechado o jazigo, \"Joabe e seus homens caminharam toda aquela noite, e amanheceu-lhes o dia em Hebrom\": o irmão sai do enterro direto para uma noite de marcha, e com uma conta a cobrar. Aquela pedra em Belém é a razão da espada que se abrirá no portão de Hebrom, um capítulo adiante.",
  },
  "tanque-de-gibeom": {
  ...
  "vau-do-jordao": {
    title: "O vau do Jordão",
    subtitle: "2Sm 2:29 — a travessia da noite até Maanaim",
    text: "\"E caminharam Abner e os seus homens toda aquela noite pela planície; e, passando o Jordão, caminharam por todo o Bitrom, e chegaram a Maanaim\" (2Sm 2:29). Os vaus eram os poucos trechos rasos em que o rio se podia atravessar a pé, e por isso valiam mais do que cidades: quem os guardava cortava um país em dois, como fizeram os gileaditas aos efraimitas (Jz 12:5). Aqui o vau é rota de fuga — Abner recua para além das águas e leva consigo o que sobra da casa de Saul, deixando Judá com o ocidente e Israel com Gileade. O Jordão que a nação atravessou uma vez em seco, como um povo só, tornou-se a fronteira entre duas metades do mesmo povo. E será atravessado outra vez, de noite e às pressas, quando o próprio Davi fugir de Absalão (2Sm 17:22): o mesmo rio, o mesmo escuro, outra guerra de família.",
  },

  "banquete-de-hebrom": {
    title: "A taça do banquete de Hebrom",
    subtitle: "2Sm 3:20 — a mesa que garantia a vida do hóspede",
    text: "\"E foi Abner a Davi, em Hebrom, e vinte homens com ele; e Davi fez um banquete a Abner e aos homens que com ele estavam\" (2Sm 3:20). Comer à mesa de alguém, no Oriente antigo, era ato jurídico: o hóspede ficava sob a proteção do anfitrião, e a taça partilhada valia por contrato assinado. Por isso o texto insiste no que veio depois — \"Assim despediu Davi a Abner, e ele foi em paz\" —, e repete a mesma fórmula três vezes em quatro versículos (2Sm 3:21-23). É exatamente essa garantia que Joabe quebra ao matar, à porta da cidade, o homem que acabara de beber do vinho do rei. Davi gastará o resto do capítulo provando ao povo que não teve parte nisso. A taça em cena é a promessa que a espada desmentiu.",
  },
  "espada-de-joabe": {
    title: "A espada de Joabe",
    subtitle: "2Sm 3:27 — a lâmina do sangue de Asael",
    text: "\"Voltando, pois, Abner a Hebrom, Joabe o levou à parte, à entrada da porta, para lhe falar em segredo; e feriu-o ali pela quinta costela, e morreu, por causa do sangue de Asael seu irmão\" (2Sm 3:27). A QUINTA COSTELA é a fórmula deste livro para o golpe baixo sob as costelas — o mesmo que matou Asael (2Sm 2:23), Is-Bosete (2Sm 4:6) e, mais tarde, Amasa (2Sm 20:10). Joabe assume o papel legal do vingador do sangue, mas o exerce no lugar errado e do modo errado: Hebrom era \"cidade do refúgio do homicida\" (Js 21:13), onde justamente não se podia executar ninguém, e o golpe veio de um abraço fingido, em tempo de paz. Davi entende o crime pelo que é, amaldiçoa a casa do sobrinho (2Sm 3:29) e, décadas depois, no leito de morte, ainda o cobra: Joabe \"em paz derramou o sangue de guerra\" (1Rs 2:5). No fim, a espada alcança quem a usou — Joabe foge para o tabernáculo do SENHOR e \"apegou-se às pontas do altar\" (1Rs 2:28), e ali é alcançado.",
  },
  "leito-de-rispa": {
    title: "O leito de Rispa",
    subtitle: "2Sm 3:7 — a concubina do rei morto e a briga que entregou o reino",
    text: "\"E tinha tido Saul uma concubina, cujo nome era Rispa, filha de Aiá; e disse Is-Bosete a Abner: Por que possuíste a concubina de meu pai?\" (2Sm 3:7). No Oriente antigo o harém do rei morto passava ao sucessor, e tomá-lo era declarar-se herdeiro: é a mesma lógica que Absalão exibirá no terraço, à vista de todo o Israel (2Sm 16:22), e que custará a cabeça de Adonias (1Rs 2:22). Por isso a pergunta soou a Abner como acusação de golpe, e a ira foi imediata — \"Sou eu cabeça de cão, que pertença a Judá?\" —, seguida do juramento de transferir o reino da casa de Saul e confirmar o trono de Davi \"desde Dã até Berseba\" (2Sm 3:8-10). Um leito e uma frase mal medida derrubaram a dinastia inteira, e o versículo seguinte é o epitáfio do rei-fantoche: \"E nenhuma palavra podia ele responder a Abner, porque o temia\". A própria Rispa voltará ao livro em cena muito maior, velando os corpos dos filhos sobre a penha \"desde o princípio da sega até que a água do céu caiu sobre eles\" (2Sm 21:10).",
  },
  "pao-do-jejum-de-davi": {
    title: "O pão que Davi recusou",
    subtitle: "2Sm 3:35 — o jejum até o sol se pôr, por Abner",
    text: "Depois de um enterro, os vizinhos levavam comida e vinho à casa enlutada; era o pão dos pranteadores e o \"copo de consolação\" de que fala Jeremias (Jr 16:7), e recusá-lo era ficar de fora do consolo. Em Hebrom o povo inteiro veio insistir com o rei, ainda de dia, e ele jurou: \"Assim Deus me faça, e outro tanto, se, antes que o sol se ponha, eu provar pão ou alguma coisa\" (2Sm 3:35). É o mesmo jejum que ele fizera por Saul e Jônatas em Ziclague (2Sm 1:12) — luto verdadeiro por um adversário político, feito à vista de todos. E funcionou como devia: \"O que todo o povo entendendo, pareceu bem aos seus olhos\", e \"todo o Israel entenderam naquele mesmo dia que não procedera do rei que matasse a Abner\" (2Sm 3:36-37). A taça intocada na mão do servo foi a maneira mais eloquente que um rei fraco encontrou de dizer a verdade sobre o assassinato do seu maior aliado.",
  },
  "poco-de-sira": {
    title: "O poço de Sirá",
    subtitle: "2Sm 3:26 — de onde Abner foi feito voltar",
    text: "\"E Joabe, retirando-se de Davi, enviou mensageiros atrás de Abner, e o fizeram voltar desde o poço de Sirá, sem que Davi o soubesse\" (2Sm 3:26). Era uma cisterna de beira de estrada, pouco ao norte de Hebrom: os poços marcavam as etapas dos caminhos, e uma comitiva que já tinha chegado até ali estava fora do alcance da cidade e, portanto, a salvo. O detalhe geográfico é o que prova a premeditação — Joabe teve de mandar homens atrás de Abner, alcançá-lo longe e trazê-lo de volta com um pretexto. E a cláusula \"sem que Davi o soubesse\" é o eixo do capítulo inteiro: dela depende a inocência do rei diante do povo e diante das tribos do norte. Salomão a repetirá muitos anos depois, ao mandar executar Joabe, lembrando que ele matou dois capitães \"sem que meu pai Davi o soubesse\" (1Rs 2:32). Uma parada banal de estrada foi o ponto em que a paz entre as duas casas se desfez pela mão de um homem só.",
  },
  "portao-de-hebrom": {
    title: "O portão de Hebrom",
    subtitle: "2Sm 3:27 — a entrada da porta, onde se fazia justiça",
    text: "A porta da cidade israelita não era um simples vão no muro: era uma construção de câmaras laterais com bancos de pedra, onde os anciãos julgavam, os contratos se fechavam diante de testemunhas e os negócios se resolviam à vista de todos — foi ali que Boaz sentou os dez anciãos para resgatar o campo de Noemi (Rt 4:1-2). Era o lugar mais público da cidade, e por isso o mais seguro. Joabe usa exatamente isso: \"Joabe o levou à parte, à entrada da porta, para lhe falar em segredo; e feriu-o ali pela quinta costela\" (2Sm 3:27). O SEGREDO no lugar onde tudo era público é a inversão que o texto denuncia: onde a lei devia falar alto, um homem falou baixo e matou. E o agravante é o endereço — Hebrom era \"cidade do refúgio do homicida\" (Js 21:13), o único tipo de cidade em que nem um assassino podia ser tocado.",
  },
  "recado-de-abner": {
    title: "O recado de Abner",
    subtitle: "2Sm 3:12 — \"De quem é a terra?\"",
    text: "\"Então enviou Abner da sua parte mensageiros a Davi, dizendo: De quem é a terra? E disse mais: Comigo faze o teu acordo, e eis que a minha mão será contigo, para tornar a ti todo o Israel\" (2Sm 3:12). A pergunta já é a oferta: quem de fato manda em Israel sabe que não é mais o rei que ele mesmo entronizou. Davi responde com uma única condição, e não é militar — \"não verás a minha face, se primeiro não me trouxeres a Mical, filha de Saul\" (2Sm 3:13) —, porque a filha de Saul devolvida legitima publicamente o genro do rei morto. Antes de voltar a Hebrom, Abner leva a proposta aos anciãos de Israel e aos de Benjamim, e o argumento que usa não é político, é a palavra de Deus: \"porque o Senhor falou a Davi, dizendo: Pela mão de Davi meu servo livrarei o meu povo\" (2Sm 3:18). O rolo em cena é o tratado que quase uniu o reino sem uma batalha — e que a espada de Joabe rasgou no portão da cidade.",
  },
  "sepultura-de-abner": {
    title: "A sepultura de Abner",
    subtitle: "2Sm 3:32 — a cova em Hebrom, e o pranto do rei",
    text: "\"E, sepultando a Abner em Hebrom, o rei levantou a sua voz, e chorou junto da sepultura de Abner; e chorou todo o povo\" (2Sm 3:32). Abner não é enterrado em Benjamim, entre os seus, mas na capital do rival que combateu por sete anos — e é o próprio Davi que segue o féretro, de vestes rasgadas, tendo mandado o exército inteiro cingir-se de sacos. Sobre a cova, o rei canta a elegia mais curta e mais cortante do livro: \"Havia de morrer Abner como morre o vilão?\" (2Sm 3:33), e \"As tuas mãos não estavam atadas, nem os teus pés carregados de grilhões\" (2Sm 3:34) — não foi executado como criminoso, foi abatido de emboscada. \"Não sabeis que hoje caiu em Israel um príncipe e um grande?\", diz aos servos (2Sm 3:38). Nesta mesma boca de sepulcro será posta, um capítulo depois, a cabeça de Is-Bosete (2Sm 4:12): o jazigo dos dois homens que sustentavam a casa de Saul, aberto pela mão de assassinos que julgavam agradar ao rei.",
  },

  "espada-dos-mocos-de-davi": {
    title: "A espada dos moços de Davi",
    subtitle: "2Sm 4:12 — a sentença sobre Recabe e Baaná",
    text: "\"E deu Davi ordem aos seus moços que os matassem; e cortaram-lhes os pés e as mãos, e os penduraram sobre o tanque de Hebrom\" (2Sm 4:12). Os MOÇOS do rei eram a sua guarda pessoal, e esta é a segunda vez em quatro capítulos que a mesma espada executa alguém que chegou a Hebrom convencido de que trazia boas novas — o amalequita da coroa foi o primeiro (2Sm 1:15). Davi não se limita a recusar o serviço prestado: julga o ato. \"Quanto mais a ímpios homens, que mataram um homem justo em sua casa, sobre a sua cama\" (2Sm 4:11) — e chama de HOMEM JUSTO justamente o rival que lhe disputava o trono. Cortar as mãos que feriram e os pés que caminharam toda a noite com a cabeça é justiça talional posta à vista da cidade. A espada em cena não é a de quem conquista um reino, é a de quem se recusa a recebê-lo das mãos de assassinos.",
  },
  "leito-de-is-bosete": {
    title: "O leito de Is-Bosete",
    subtitle: "2Sm 4:5-7 — a cama do rei ao meio-dia",
    text: "A sesta no maior calor do dia era hábito de toda a casa oriental, e o quarto interior, a parte mais protegida dela. É ali que a cena acontece: os dois capitães \"entraram em casa de Is-Bosete no maior calor do dia, estando ele deitado a dormir, ao meio-dia\", passaram \"até ao meio da casa, como que vindo buscar trigo\", e o feriram na quinta costela (2Sm 4:5-6). O narrador repete o detalhe para que ninguém o perca: \"estando ele na cama deitado, no seu quarto\" (2Sm 4:7). Um rei que já perdera o capitão, o reino e o próprio ânimo — \"as mãos se lhe afrouxaram\" (2Sm 4:1) — morre sem sequer acordar, morto por dois oficiais da sua tribo. Davi resume tudo com uma expressão que os assassinos não esperavam ouvir: um homem justo morto \"em sua casa, sobre a sua cama\" (2Sm 4:11). O leito é o oposto do campo de batalha, e é isso que torna o crime indefensável.",
  },
  "tanque-de-hebrom": {
    title: "O tanque de Hebrom",
    subtitle: "2Sm 4:12 — onde os corpos dos assassinos foram pendurados",
    text: "O tanque era o reservatório público da cidade, cavado na rocha e alimentado pelas chuvas do inverno, ponto obrigatório por onde toda a população passava — em Hebrom ele ainda existe, no meio da cidade velha. Foi ali que Davi mandou pendurar os corpos mutilados de Recabe e Baaná: \"e cortaram-lhes os pés e as mãos, e os penduraram sobre o tanque de Hebrom\" (2Sm 4:12). Expor o cadáver era a maneira antiga de fazer uma sentença durar; o que os filisteus fizeram ao corpo de Saul, quando \"o seu corpo o afixaram no muro de Bete-Sã\" (1Sm 31:10), Davi faz agora aos que julgavam ter-lhe prestado serviço. A mensagem é para a cidade e para as tribos do norte que ainda hesitavam: quem matar por conta própria pensando em agradar ao rei paga na praça. E o mesmo versículo fecha com o contraste — a cabeça de Is-Bosete é levada com honra à sepultura de Abner.",
  },

  "amoreiras-de-refaim": {
    title: "As amoreiras de Refaim",
    subtitle: "2Sm 5:23-24 — o estrondo de marcha pelas copas",
    text: "Diante da segunda investida dos filisteus no vale de Refaim, Davi faz a mesma pergunta da primeira vez e recebe a resposta oposta: \"Não subirás; mas rodeia por detrás deles, e virás a eles por defronte das amoreiras\" (2Sm 5:23). E o sinal de atacar não seria uma palavra, seria um SOM: \"ouvindo tu um estrondo de marcha pelas copas das amoreiras, então te apressarás; porque o Senhor saiu então diante de ti, a ferir o arraial dos filisteus\" (2Sm 5:24). As amoreiras do vale eram árvores de copa larga e folha ampla, dessas em que o vento se ouve antes de se sentir. O ruído de um exército passando por cima das árvores é uma das imagens mais estranhas e mais belas da Escritura: o SENHOR dos Exércitos marcha à frente, e o que o soldado percebe da batalha do céu é um farfalhar de folhas. A lição vem antes da vitória — a mesma pergunta pode ter duas respostas, e o rei que venceu ontem tem de consultar de novo hoje.",
  },
  "canal-de-siao": {
    title: "O canal de Sião",
    subtitle: "2Sm 5:8 — o aqueduto por onde se subiu à fortaleza",
    text: "Os jebuseus confiavam de tal modo no penhasco de Sião que zombaram do cerco: \"Não entrarás aqui, pois os cegos e os coxos te repelirão\" (2Sm 5:6) — bastariam aleijados para guardar aquele muro. A cidade tinha, porém, um ponto fraco: a fonte ficava fora das muralhas, e um poço vertical com um canal escavado na rocha a ligava ao interior, para que se pudesse beber sem abrir a porta em tempo de cerco. Foi por ali que Davi mandou subir: \"Qualquer que ferir aos jebuseus, suba ao canal e fira aos coxos e aos cegos\" (2Sm 5:8). O que garantia a vida da fortaleza foi justamente o que a entregou, e a bravata dos jebuseus deixou um dito na cidade: \"Nem cego nem coxo entrará nesta casa\". A ironia do livro é que, quatro capítulos adiante, é um coxo de ambos os pés que Davi manda buscar para comer à sua mesa como um dos filhos do rei (2Sm 9:13).",
  },
  "cedros-do-libano-de-hirao": {
    title: "Os cedros de Hirão",
    subtitle: "2Sm 5:11 — a madeira, os carpinteiros e os pedreiros de Tiro",
    text: "\"E Hirão, rei de Tiro, enviou mensageiros a Davi, e madeira de cedro, e carpinteiros, e pedreiros que edificaram a Davi uma casa\" (2Sm 5:11). O cedro do Líbano era a madeira mais cara do Levante — troncos retos de dezenas de metros, resinosos, resistentes ao apodrecimento e ao caruncho — e os fenícios dominavam o corte, a descida pelas encostas e o transporte por mar em jangadas. Que um rei estrangeiro tome a iniciativa de mandá-los é o reconhecimento internacional do reino novo; Salomão repetiria o mesmo contrato para o templo, pedindo a Hirão que \"do Líbano me cortem cedros\" (1Rs 5:6). Mas o versículo seguinte proíbe a leitura vaidosa: Davi entendeu que o SENHOR \"exaltara o seu reino por amor do seu povo\" (2Sm 5:12) — a casa não é prêmio, é encargo. E é dentro dessa mesma casa de cedro que ele ficará inquieto, no capítulo 7, porque a arca de Deus ainda mora dentro de cortinas.",
  },
  "coroa-de-todo-o-israel": {
    title: "A coroa de todo o Israel",
    subtitle: "2Sm 5:3 — a terceira unção, perante o SENHOR",
    text: "\"todos os anciãos de Israel vieram ao rei, em Hebrom; e o rei Davi fez com eles acordo em Hebrom, perante o Senhor; e ungiram a Davi rei sobre Israel\" (2Sm 5:3). É a terceira unção de Davi — a de Belém, em segredo; a de Judá, em Hebrom; e agora a de todas as tribos —, e vinte anos separam a primeira da última. Repare no que as tribos alegam, e na ordem: primeiro o parentesco (\"somos teus ossos e tua carne\"), depois o serviço militar prestado ainda no tempo de Saul e, por fim, o argumento decisivo, que é a palavra de Deus — \"e também o Senhor te disse: Tu apascentarás o meu povo de Israel\" (2Sm 5:2). A coroa não vem de um golpe nem de um cadáver: vem de um ACORDO feito PERANTE O SENHOR, isto é, um pacto com cláusulas, diante de testemunhas e diante de Deus. O rei de Israel nunca foi monarca absoluto; foi pastor sob contrato, e a coroa posta no meio da praça é a do pastor.",
  },
  "idolos-deixados-em-baal-perazim": {
    title: "Os ídolos deixados em Baal-Perazim",
    subtitle: "2Sm 5:21 — as imagens abandonadas no campo",
    text: "\"E deixaram ali os seus ídolos; e Davi e os seus homens os tomaram\" (2Sm 5:21). Os filisteus levavam as imagens dos seus deuses para a batalha, como Israel um dia arrastara a arca a Afeque — e as perderam do mesmo modo, largadas no chão durante a fuga. É a inversão exata de 1 Samuel 4: ali o povo de Deus levou o que era santo para o campo e viu ser tomado; aqui os pagãos correm e deixam os seus deuses para trás. Um deus que precisa ser carregado não pode salvar quem o carrega — é o escárnio de Isaías sobre Bel e Nebo, que \"não puderam livrar-se da carga\" (Is 46:2). O lugar ficou com o nome do que ali aconteceu: \"Rompeu o Senhor a meus inimigos diante de mim, como quem rompe águas. Por isso chamou o nome daquele lugar Baal-Perazim\" (2Sm 5:20), o senhor das roturas. O crédito da vitória vai inteiro para Deus, e o único despojo digno de nota é um monte de ídolos que ninguém voltou para buscar.",
  },
  "milo-o-baluarte": {
    title: "Milo, o baluarte",
    subtitle: "2Sm 5:9 — o aterro a partir do qual Davi edificou para dentro",
    text: "\"Assim habitou Davi na fortaleza, e a chamou a cidade de Davi; e Davi foi edificando em redor, desde Milo para dentro\" (2Sm 5:9). MILO vem da raiz hebraica de ENCHER: era um aterro de sustentação, terraços de pedra e entulho socados na encosta íngreme de Sião para criar chão firme onde a rocha caía a pique — a engenharia que transforma um penhasco em cidade habitável. Salomão teve de reconstruí-lo (1Rs 9:15), e foi trabalhando nessa mesma obra que Jeroboão se fez notar, pois \"Salomão tinha edificado a Milo, e cerrou as aberturas da cidade de Davi\" (1Rs 11:27). Davi não arrasa a fortaleza jebuseia que tomou: constrói sobre o que já estava ali, e edifica de fora para dentro, a partir do baluarte. É a imagem do reinado inteiro — o que recebe pronto, aproveita; o que falta, aterra; e a cidade que leva o seu nome cresce sobre um alicerce feito à mão, muito antes que qualquer palácio apareça.",
  },
  "porta-da-cidade-de-davi": {
    title: "A porta da Cidade de Davi",
    subtitle: "2Sm 5:7-9 — a entrada da fortaleza de Sião",
    text: "\"Porém Davi tomou a fortaleza de Sião; esta é a cidade de Davi\" (2Sm 5:7) — e o portão que os jebuseus juravam que nem cegos nem coxos deixariam forçar passou a ser a entrada da capital de Israel. A porta de uma cidade daquele tempo era o ponto mais fortificado do muro, com torres dos dois lados e câmaras de guarda, e ao mesmo tempo a sala pública onde se julgava e se negociava. Por ela entrará, no capítulo seguinte, a arca do SENHOR, \"com júbilo, e ao som das trombetas\" (2Sm 6:15) — e é sobre uma porta assim que o salmo manda gritar: \"Levantai, ó portas, as vossas cabeças; levantai-vos, ó entradas eternas, e entrará o Rei da Glória\" (Sl 24:7). A cidade que Davi escolheu não era de Judá nem de Benjamim, e por isso não pertencia a tribo alguma: uma capital neutra, tomada de fora, para um reino que precisava de doze tribos dentro. Da janela do mesmo muro, Mical olhará o rei bailando, e o desprezará no seu coração.",
  },

  "altar-dos-holocaustos-de-davi": {
    title: "O altar dos holocaustos de Davi",
    subtitle: "2Sm 6:17-18 — o culto na tenda, em Jerusalém",
    text: "\"E introduzindo a arca do Senhor, a puseram no seu lugar, na tenda que Davi lhe armara; e ofereceu Davi holocaustos e ofertas pacíficas perante o Senhor\" (2Sm 6:17). São os dois sacrifícios do dia da inauguração, e dizem coisas diferentes: o HOLOCAUSTO subia inteiro no fogo, sem que nada voltasse ao ofertante — entrega total; a OFERTA PACÍFICA era comida em festa diante de Deus, com o povo à mesa (Lv 7:11-15). Por isso o versículo seguinte é a repartição: um bolo de pão, um bom pedaço de carne e um frasco de vinho para cada um, \"desde os homens até às mulheres\" (2Sm 6:19). E o rei encerra abençoando o povo \"em nome do Senhor dos Exércitos\" (2Sm 6:18) — funções sacerdotais exercidas por um homem da tribo de Judá, coisa que só se explica de todo na promessa de um sacerdócio \"segundo a ordem de Melquisedeque\" (Sl 110:4). O fogo neste altar é o fecho da subida que começou errada e foi refeita como devia.",
  },
  "altar-dos-seis-passos": {
    title: "O altar dos seis passos",
    subtitle: "2Sm 6:13 — bois e carneiros cevados a cada seis passos",
    text: "\"E sucedeu que, quando os que levavam a arca do Senhor tinham dado seis passos, sacrificava bois e carneiros cevados\" (2Sm 6:13). A frase muda tudo em relação à primeira tentativa: agora não há carro nem bois puxando — há HOMENS QUE LEVAM a arca, aos ombros e pelos varais, como a lei mandava aos filhos de Coate, a cujo cargo \"estava o santuário e o levavam aos ombros\" (Nm 7:9). O sacrifício a cada seis passos é reverência e penitência ao mesmo tempo: a subida deixa de ser transporte de carga e vira procissão de adoração, lenta, cara e sangrenta. Davi já tinha entendido onde errara, e em Crônicas o diz com todas as letras: \"vós não a levastes na primeira vez, o Senhor nosso Deus fez rotura em nós, porque não o buscamos segundo a ordenança\" (1Cr 15:13). A distância entre Perez-Uzá e Jerusalém continuou a mesma; o que mudou foi o modo. E é entre esses altares, cingido de um éfode de linho, que o rei sobe saltando com todas as suas forças.",
  },
  "carro-novo-de-abinadabe": {
    title: "O carro novo de Abinadabe",
    subtitle: "2Sm 6:3 — o veículo errado para a arca de Deus",
    text: "\"E puseram a arca de Deus em um carro novo, e a levaram da casa de Abinadabe, que está em Gibeá; e Uzá e Aiô, filhos de Abinadabe, guiavam o carro novo\" (2Sm 6:3). Ele é NOVO, isto é, nunca usado em serviço comum: os trinta mil escolhidos de Israel fizeram tudo com a melhor das intenções. O problema é de onde veio a ideia. Um carro novo puxado por bois foi exatamente o que os FILISTEUS improvisaram para devolver a arca — \"tomai e fazei-vos um carro novo, e tomai duas vacas com crias\" (1Sm 6:7) —, e aquele carro tem ficha própria porque foi outra coisa: o recurso de pagãos que não conheciam a lei e só queriam se livrar do que os feria. Este é a solução de Israel para trazer a arca de volta, e Israel tinha a ordenança escrita: a arca se leva aos ombros dos levitas, pelos varais, e no santuário \"não tocarão para que não morram\" (Nm 4:15). Copiar o método filisteu ao som de harpas e saltérios não santifica o método — e foi por causa deste carro que os bois tropeçaram na eira, Uzá estendeu a mão e a festa parou.",
  },
  "eira-de-nacom": {
    title: "A eira de Nacom",
    subtitle: "2Sm 6:6 — onde os bois deixaram a arca pender",
    text: "A eira era um terreiro de rocha lisa ou chão batido, escolhido no alto por causa do vento, onde se debulhava e joeirava o trigo: piso irregular, cheio de palha e grão solto, péssimo para rodas. \"E, chegando à eira de Nacom, estendeu Uzá a mão à arca de Deus, e pegou nela; porque os bois a deixavam pender\" (2Sm 6:6). Crônicas chama o lugar de eira de Quidom e diz simplesmente que \"os bois tropeçavam\" (1Cr 13:9). O gesto de Uzá parece o mais natural do mundo, e é justamente aí que a cena pesa: \"Então a ira do Senhor se acendeu contra Uzá, e Deus o feriu ali por esta imprudência; e morreu ali junto à arca de Deus\" (2Sm 6:7). A lei era explícita — dos objetos do santuário, \"não tocarão para que não morram\" (Nm 4:15) —, e a mão que se estende para escorar o que é santo pressupõe que o santo precise de escora. O lugar mudou de nome para Perez-Uzá, e o júbilo virou medo: \"Como virá a mim a arca do Senhor?\" (2Sm 6:9).",
  },
  "harpas-da-folia-de-israel": {
    title: "As harpas da folia de Israel",
    subtitle: "2Sm 6:5 — a orquestra da primeira subida",
    text: "\"E Davi, e toda a casa de Israel, festejavam perante o Senhor, com toda a sorte de instrumentos de pau de faia, como também com harpas, e com saltérios, e com tamboris, e com pandeiros, e com címbalos\" (2Sm 6:5). A harpa é o instrumento de Davi desde a corte de Saul, aquele com que ele afugentava o espírito mau — \"Davi tomava a harpa, e a tocava com a sua mão; então Saul sentia alívio\" (1Sm 16:23) —, e o homem a quem o livro chamará \"o suave em salmos de Israel\" (2Sm 23:1) pôs a nação inteira a tocar. Nada nesta lista é errado: a alegria é sincera, a música é boa e o destino é certo. O que faltava era a ordenança, e é esse o contraste que o capítulo constrói, porque toda essa orquestra emudece de repente na eira de Nacom. A adoração verdadeira não se mede pelo volume do júbilo, e sim pela obediência de quem o oferece — e, quando a subida se refaz, as mesmas harpas voltam, agora atrás de homens que carregam a arca aos ombros.",
  },
  ...
  "altar-do-arraial-das-tribos": {
    title: "O altar do arraial das tribos",
    subtitle: "2Sm 7:7 — a nenhuma tribo Deus pediu uma casa de cedro",
    text: "No coração da resposta de Deus a Davi há uma pergunta que ninguém tinha feito: \"E em todo o lugar em que andei com todos os filhos de Israel, falei porventura alguma palavra a alguma das tribos de Israel, a quem mandei apascentar o meu povo de Israel, dizendo: Por que não me edificais uma casa de cedro?\" (2Sm 7:7). O altar plantado entre as tendas é a resposta em objeto: durante o deserto inteiro e todo o tempo dos juízes, Deus se contentou com um altar portátil no meio do arraial, montado e desmontado a cada jornada. Ele nunca reclamou de morar em pano. A ausência da queixa é o argumento: o Deus de Israel não é como os deuses das nações, que exigem templo, alimento e teto — Ele é quem edifica, quem apascenta e quem sustenta. O altar entre as tendas, com o povo em volta, é o retrato de uma aliança que não dependia de arquitetura nenhuma.",
  },
  "altar-do-patio-da-arca": {
    title: "O altar do pátio da arca",
    subtitle: "2Sm 7:2,18 — o fogo diante da tenda em Sião",
    text: "É o altar erguido junto à tenda que Davi armou na Cidade de Davi, onde ele ofereceu \"holocaustos e ofertas pacíficas perante o Senhor\" no dia em que a arca entrou (2Sm 6:17). Ele está no primeiro plano da comparação que abre o capítulo 7: \"Eis que eu moro em casa de cedro, e a arca de Deus mora dentro de cortinas\" (2Sm 7:2) — cedro e pedra de um lado; pano e fogo do outro. E é diante dele que acontece a cena mais íntima do livro: recebida a promessa, \"entrou o rei Davi, e ficou perante o SENHOR\" (2Sm 7:18), sem trono, sem coroa e sem exército, para dizer \"Quem sou eu, Senhor DEUS, e qual é a minha casa, para que me tenhas trazido até aqui?\". Um altar aceso é o lugar onde um rei pode ser apenas servo. E é o mesmo fogo que arderá no capítulo 8, quando a prata e o ouro de todas as nações sujeitadas forem consagrados neste pátio.",
  },
  "altar-do-tabernaculo": {
    title: "O altar do tabernáculo",
    subtitle: "2Sm 7:6 — o altar que andou com Deus pelo deserto",
    text: "\"Porque em casa nenhuma habitei desde o dia em que fiz subir os filhos de Israel do Egito até ao dia de hoje; mas andei em tenda e em tabernáculo\" (2Sm 7:6). O altar do holocausto era de madeira de acácia coberta de cobre, oco, com argolas e varais, projetado de propósito para ser carregado (Êx 27:1-8): o mobiliário do culto de Israel foi feito para a estrada, não para um pátio de pedra. Todos os dias, de manhã e de tarde, ardiam ali dois cordeiros, onde quer que o arraial estivesse (Êx 29:38-42). A imagem que Deus escolhe para se descrever a Davi não é a de um Deus assentado, mas a de um Deus que ANDA — e que andou quarenta anos com um povo de nômades sem jamais pedir teto. Antes de prometer trono eterno a um rei, Ele lembra que a sua glória nunca dependeu de um endereço.",
  },
  "casa-de-davi-nos-tempos-distantes": {
    title: "A casa de Davi nos tempos distantes",
    subtitle: "2Sm 7:19 — a promessa que passa do horizonte",
    text: "\"E ainda foi isto pouco aos teus olhos, Senhor DEUS, senão que também falaste da casa de teu servo para tempos distantes; é este o procedimento dos homens, ó Senhor DEUS?\" (2Sm 7:19). Davi percebe que a promessa não cabe na sua biografia: atravessa a morte dele, a de Salomão e a de todos os reis de Judá. TEMPOS DISTANTES é a expressão que faz deste capítulo uma profecia messiânica, e não apenas um contrato dinástico; a pergunta que a segue é de espanto, porque reis não tratam assim os seus servos. Os profetas continuariam a olhar para o mesmo horizonte: \"Nunca faltará a Davi homem que se assente sobre o trono da casa de Israel\" (Jr 33:17). O palco desenha a casa pequena, lá no fim do caminho, porque é assim que ela se vê daqui — real, prometida e ainda longe. E o Novo Testamento diria o nome de quem a habita: \"a raiz e a geração de Davi, a resplandecente estrela da manhã\" (Ap 22:16).",
  },
  "casa-do-povo-plantado": {
    title: "A casa do povo plantado",
    subtitle: "2Sm 7:10 — o lugar preparado, para não mais ser removido",
    text: "\"E prepararei lugar para o meu povo, para Israel, e o plantarei, para que habite no seu lugar, e não mais seja removido, e nunca mais os filhos da perversidade o aflijam, como dantes\" (2Sm 7:10). PLANTAR é palavra de lavrador, e é o contrário de tudo o que Israel tinha sido até ali: escravo no Egito, peregrino no deserto, acossado no tempo dos juízes. Uma casa de pedra, uma árvore crescida, um poço e uma vinha só aparecem onde uma família ficou tempo bastante para criar raiz. Repare na ordem da promessa: antes de falar da casa de Davi, Deus fala da casa do povo — o rei existe por causa de Israel, e não Israel por causa do rei. A imagem do plantio atravessa a Escritura até a videira do Novo Testamento, onde o próprio Senhor diz \"meu Pai é o lavrador\" (Jo 15:1): o povo de Deus não é acampamento provisório, é plantação que Ele mesmo firma no chão.",
  },
  "casa-edificada-ao-nome-do-senhor": {
    title: "A casa edificada ao Nome do SENHOR",
    subtitle: "2Sm 7:13 — o templo que o filho havia de levantar",
    text: "\"Este edificará uma casa ao meu nome, e confirmarei o trono do seu reino para sempre\" (2Sm 7:13). A recusa que Davi ouviu não era um NÃO ao templo, era um NÃO A ELE: a casa viria, mas pela mão do filho, e Salomão a começaria \"no ano de quatrocentos e oitenta, depois de saírem os filhos de Israel do Egito\" (1Rs 6:1). Edificar AO NOME é a expressão técnica da Escritura para consagrar um lugar onde Deus faz habitar o seu Nome — não a sua pessoa, que os céus dos céus não contêm. E note-se a costura do versículo: a casa de pedra e o trono para sempre são prometidos na mesma frase, e é essa junção que o Novo Testamento desata, apontando para Aquele que disse \"Derribai este templo, e em três dias o levantarei\" (Jo 2:19). A casa que aparece em cena é a de Salomão e é mais do que ela: o templo de pedra durou quatro séculos, e o trono confirmado no mesmo fôlego não acabou.",
  },
  "casa-que-o-senhor-fara-a-davi": {
    title: "A casa que o SENHOR fará a Davi",
    subtitle: "2Sm 7:11 — a inversão que funda a aliança davídica",
    text: "\"também o Senhor te faz saber que te fará casa\" (2Sm 7:11). O capítulo inteiro gira sobre uma palavra de dois sentidos: Davi queria edificar uma CASA a Deus — um edifício — e Deus responde que fará uma CASA a Davi — uma dinastia. Quem constrói é sempre Deus; o servo não presenteia o Senhor, é presenteado por Ele. A promessa é incondicional de um modo que assusta: se o herdeiro transgredir, virá castigo \"com vara de homens, e com açoites de filhos de homens\", mas \"a minha benignidade não se apartará dele; como a tirei de Saul\" (2Sm 7:14-15). Das duas casas que este capítulo põe lado a lado, a de pedra caiu e a de Davi não. Israel cantaria isso como juramento — \"O Senhor jurou com verdade a Davi, e não se apartará dela\" (Sl 132:11) —, e Pedro, em Pentecostes, leria o mesmo juramento como profecia da ressurreição de Cristo (At 2:30).",
  },
  "coroa-caida-de-saul": {
    title: "A coroa caída de Saul",
    subtitle: "2Sm 7:15 — \"como a tirei de Saul\"",
    text: "Dentro da maior promessa do livro há uma sombra: \"Mas a minha benignidade não se apartará dele; como a tirei de Saul, a quem tirei de diante de ti\" (2Sm 7:15). Deus garante a Davi exatamente o que negou ao primeiro rei — e o faz nomeando o precedente, para que ninguém confunda aliança com indulgência para com o pecado. A benignidade sobre Saul foi retirada; a de Davi, não. A diferença não está no mérito de dois homens, mas numa aliança que Deus jurou por si mesmo e que não depende do desempenho do herdeiro. A coroa no chão, ao pé do assento vazio, é a lembrança física do que acontece a uma casa real que Deus não se comprometeu a sustentar: foi essa mesma coroa que um amalequita arrancou de um cadáver em Gilboa e levou a Hebrom (2Sm 1:10). É o retrato do que a casa de Davi não vai ser.",
  },
  "coroa-da-casa-de-davi": {
    title: "A coroa da casa de Davi",
    subtitle: "2Sm 7:16 — a casa e o reino firmados para sempre",
    text: "\"Porém a tua casa e o teu reino serão firmados para sempre diante de ti; teu trono será firme para sempre\" (2Sm 7:16). Três palavras na mesma frase — casa, reino e trono — e todas com o mesmo prazo. Nenhum rei do Oriente antigo recebeu promessa assim: os tratados de vassalagem duravam enquanto durasse a lealdade, e a coroa passava enquanto houvesse herdeiro e exército. A coroa de Davi é prometida além disso, e a história a submeteu a teste duro — o trono de Judá foi levado para Babilônia, a linhagem virou uma família de artesãos em Nazaré, e a promessa continuou de pé. \"o Senhor Deus lhe dará o trono de Davi, seu pai\", diria o anjo a Maria, e \"reinará eternamente na casa de Jacó, e o seu reino não terá fim\" (Lc 1:32-33). A coroa aqui está posta ao lado do trono confirmado: pequena diante do que lhe foi prometido, e à espera do herdeiro que lhe cumpra a medida.",
  },
  "deuses-das-nacoes-desterrados": {
    title: "Os deuses das nações desterradas",
    subtitle: "2Sm 7:23 — os ídolos que saíram junto com os seus povos",
    text: "Na oração, Davi chega ao Egito: Israel é \"gente única na terra, a quem Deus foi resgatar para seu povo\", o povo \"que tu resgataste do Egito, desterrando as nações e a seus deuses\" (2Sm 7:23). O ídolo fundido — metal derramado sobre alma de madeira, como o bezerro de Arão e como os de Jeroboão — era o padrão religioso de Canaã, e a conquista não expulsou apenas povos: expulsou os seus deuses junto com eles. É a mesma tese das dez pragas, que o Êxodo enuncia sem rodeio: \"em todos os deuses do Egito farei juízos\" (Êx 12:12). A imagem caída à beira do caminho é o argumento visual da oração — nenhum dos deuses das nações fez pelos seus o que o SENHOR fez por Israel, porque nenhum deles consegue sequer sair do lugar. É por isso que Davi diz, um versículo antes: \"não há semelhante a ti, e não há outro Deus senão tu só\" (2Sm 7:22).",
  },
  "espada-das-vitorias-de-davi": {
    title: "A espada das vitórias de Davi",
    subtitle: "2Sm 7:9 — \"destruí a teus inimigos diante de ti\"",
    text: "\"E fui contigo, por onde quer que foste, e destruí a teus inimigos diante de ti; e fiz grande o teu nome, como o nome dos grandes que há na terra\" (2Sm 7:9). Todos os verbos da frase têm o mesmo sujeito, e não é o rei: fui, destruí, fiz. A espada largada no campo é a de Davi, mas a vitória é atribuída a Deus — e essa é a chave para ler o capítulo 8 inteiro, com o seu refrão: \"o Senhor guardou a Davi por onde quer que ia\" (2Sm 8:6). O nome grande é a promessa feita a Abraão — \"engrandecerei o teu nome\" (Gn 12:2) — cumprida agora num pastor de Belém. E há um limite embutido no elogio: por causa deste mesmo sangue derramado, Davi não pôde edificar o templo, pois Deus lhe disse \"Tu derramaste sangue em abundância, e fizeste grandes guerras; não edificarás casa ao meu nome\" (1Cr 22:8). A espada fez o reino, mas não podia fazer a casa.",
  },
  "harpa-de-davi": {
  ...
  "leito-da-casa-de-cedro": {
    title: "O leito da casa de cedro",
    subtitle: "2Sm 7:1-2 — o descanso de onde nasce a inquietação",
    text: "\"E sucedeu que, estando o rei Davi em sua casa, e tendo o SENHOR lhe dado descanso de todos os seus inimigos em redor\" (2Sm 7:1). O capítulo não começa numa crise: começa num leito. Pela primeira vez em vinte anos, o homem que dormiu em cavernas e em campos de batalha tem casa acabada, paredes de cedro e noites inteiras sem sobressalto. E é o conforto, não a angústia, que produz a pergunta: \"Eis que eu moro em casa de cedro, e a arca de Deus mora dentro de cortinas\" (2Sm 7:2). A cama do rei é o marco do descanso que Deus deu — a mesma palavra que o versículo 11 lhe devolve como promessa, \"te dei descanso de todos os teus inimigos\". Vale notar o reverso: é também deitado, e ocioso na estação em que os reis saem à guerra, que Davi cairá no capítulo 11. O descanso pode gerar gratidão ou apetite; aqui gerou gratidão.",
  },
  "leito-de-nata": {
    title: "O leito de Natã",
    subtitle: "2Sm 7:4 — a palavra que veio naquela mesma noite",
    text: "Natã tinha dado um conselho excelente e apressado — \"Vai, e faze tudo quanto está no teu coração; porque o Senhor é contigo\" (2Sm 7:3) — e Deus o desmentiu antes do amanhecer: \"Porém sucedeu naquela mesma noite, que a palavra do Senhor veio a Natã\" (2Sm 7:4). O leito do profeta é o lugar onde a piedade sincera de um homem de Deus é corrigida pelo próprio Deus: nem tudo o que parece bom ao coração do rei, e ao do conselheiro, é o que o SENHOR quer. Repare na graça do episódio — Natã não é repreendido, é enviado, e sai de casa com uma mensagem infinitamente maior do que aquela que teve de engolir. É deste mesmo profeta que virá, cinco capítulos adiante, o \"Tu és este homem\" (2Sm 12:7). A noite ensina o ofício inteiro: o profeta não fala o que acha, fala o que ouve — e não tem vergonha de voltar atrás quando ouve outra coisa.",
  },
  "malhada-de-belem": {
    title: "A malhada de Belém",
    subtitle: "2Sm 7:8 — \"Eu te tomei da malhada, de detrás das ovelhas\"",
    text: "\"Assim diz o Senhor dos Exércitos: Eu te tomei da malhada, de detrás das ovelhas, para que fosses o soberano sobre o meu povo, sobre Israel\" (2Sm 7:8). A malhada era o aprisco de pedra solta onde o rebanho passava a noite, com uma única abertura, guardada pelo próprio pastor deitado atravessado nela. No ponto mais alto da promessa — casa, trono e reino para sempre —, Deus faz o rei olhar para o lugar mais baixo da sua vida, e a ordem das palavras importa: primeiro DE ONDE saiu, depois PARA QUE foi tomado. O salmo canta o mesmo: \"Também elegeu a Davi seu servo, e o tirou dos apriscos das ovelhas\" (Sl 78:70). O pastoreio não foi acaso na biografia dele, foi o treino do ofício, e por isso a palavra de Deus às tribos usa o verbo do curral: \"Tu apascentarás o meu povo de Israel\" (2Sm 5:2). E o curral de Belém guarda ainda outra coisa: foi na mesma comarca, entre pastores que \"guardavam, durante as vigílias da noite, o seu rebanho\" (Lc 2:8), que se anunciou o nascimento do herdeiro deste trono.",
  },
  "palavra-da-alianca-davidica": {
    title: "A palavra da aliança davídica",
    subtitle: "2Sm 7:17 — \"conforme a toda esta visão, assim falou Natã\"",
    text: "\"Conforme a todas estas palavras, e conforme a toda esta visão, assim falou Natã a Davi\" (2Sm 7:17). O versículo é uma nota de fidelidade textual: o profeta não resumiu, não adoçou e não acrescentou — entregou tudo. É por isso que o capítulo tem peso de documento, e não de impressão pessoal. O que o palco mostra como rolo é o teor de uma aliança, com as suas cláusulas: descendência, trono, filiação (\"Eu lhe serei por pai, e ele me será por filho\"), disciplina com vara de homens e benignidade que não se aparta. A palavra CONCERTO não aparece aqui, mas o próprio Davi chamará isto assim no fim da vida: Deus \"estabeleceu comigo uma aliança eterna, que em tudo será bem ordenado e guardado\" (2Sm 23:5). Toda a esperança messiânica de Israel se desenrola a partir deste rolo — e Hebreus abre o Novo Testamento citando exatamente a cláusula da filiação para provar quem é o Filho: \"Eu lhe serei por Pai, E ele me será por Filho\" (Hb 1:5).",
  },
  "tabernaculo-do-deserto": {
    title: "O tabernáculo do deserto",
    subtitle: "2Sm 7:6 — \"andei em tenda e em tabernáculo\"",
    text: "\"em casa nenhuma habitei desde o dia em que fiz subir os filhos de Israel do Egito até ao dia de hoje; mas andei em tenda e em tabernáculo\" (2Sm 7:6). O tabernáculo era uma estrutura desmontável de tábuas de acácia cobertas de ouro e três camadas de cortinas, feita para ser levantada e recolhida ao sinal da nuvem: \"Quando, pois, a nuvem se levantava de sobre o tabernáculo, então os filhos de Israel caminhavam em todas as suas jornadas\" (Êx 40:36). É o argumento inteiro de Deus condensado numa imagem: quatrocentos anos de mudança, e nenhuma queixa. O verbo é o que espanta — Deus ANDOU. A tenda em cena não representa pobreza, e sim liberdade: um Deus que acompanha o seu povo não se prende a um endereço, e Estêvão usaria esta mesma passagem para dizer que \"o Altíssimo não habita em templos feitos por mãos de homens\" (At 7:48). Quando enfim veio a casa, foi Deus quem a escolheu, no seu tempo e pela mão de outro.",
  },
  "tenda-da-arca": {
    title: "A tenda da arca",
    subtitle: "2Sm 7:2 — \"a arca de Deus mora dentro de cortinas\"",
    text: "É a tenda que Davi armou em Sião e onde pôs a arca no dia da segunda subida (2Sm 6:17). A frase que ele diz a Natã mede tudo por ela: \"Eis que eu moro em casa de cedro, e a arca de Deus mora dentro de cortinas\" (2Sm 7:2) — o contraste é entre madeira nobre e pano de tenda. O palco mantém esta tenda em cena depois da promessa porque é para dentro dela que o rei volta: \"Então entrou o rei Davi, e ficou perante o SENHOR\" (2Sm 7:18), e ali reza a oração mais humilde do livro. Enquanto Israel teve templo, orava voltado para ele; enquanto Davi teve esta tenda, entrava nela. O que faz um lugar ser santo não é o material de que é feito, mas a presença de quem ali se assenta entre os querubins — e a mesma tenda tornará a aparecer no capítulo 8, quando a prata e o ouro das nações forem consagrados no seu pátio.",
  },
  "trono-de-davi": {
  ...
  "trono-firmado-para-sempre": {
    title: "O trono firmado para sempre",
    subtitle: "2Sm 7:13,16 — o assento que funda a esperança messiânica",
    text: "\"Este edificará uma casa ao meu nome, e confirmarei o trono do seu reino para sempre\" (2Sm 7:13); e outra vez, três versículos adiante, \"teu trono será firme para sempre\" (2Sm 7:16). A repetição é deliberada: o objeto da promessa não é um homem nem um edifício, é uma sucessão sem fim. A palavra teve cumprimento parcial em Salomão, que construiu o templo e reinou em paz — mas nenhum filho de Davi assentado naquele trono viveu para sempre, e a monarquia terminou no exílio. Foi então que a promessa deixou de ser leitura política e virou expectativa: o Ungido que havia de vir. \"Eu lhe serei por pai, e ele me será por filho\" (2Sm 7:14) é o versículo que Hebreus cita para mostrar quem é o Filho (Hb 1:5), e o anjo repete a cláusula a Maria: \"o Senhor Deus lhe dará o trono de Davi, seu pai\" (Lc 1:32). O assento desenhado no meio deste quadro não é um móvel: é a maior promessa em aberto do Antigo Testamento.",
  },
  "trono-vazio-de-saul": {
    title: "O trono vazio de Saul",
    subtitle: "2Sm 7:15 — a casa real de que Deus retirou a mão",
    text: "\"como a tirei de Saul, a quem tirei de diante de ti\" (2Sm 7:15). O assento abandonado é o outro lado da promessa feita a Davi: houve, antes dele, um rei ungido pelo mesmo profeta e depois rejeitado — \"rejeitaste a palavra do Senhor, já te rejeitou o Senhor, para que não sejas rei sobre Israel\" (1Sm 15:26). A casa de Saul durou uma geração e desfez-se em quatro capítulos deste livro: o rei morto em Gilboa, a coroa saqueada por um amalequita, o capitão assassinado no portão de Hebrom, o filho degolado na própria cama ao meio-dia. O que sobrou dela foi um menino coxo escondido em Lo-Debar. Ao prometer a Davi o que negou a Saul, Deus não está premiando um homem melhor: está fundando uma aliança que não depende do desempenho do herdeiro. E é por isso que o único móvel iluminado nesta cena é um trono onde ninguém se assenta.",
  },

  "altar-da-consagracao-de-davi": {
    title: "O altar da consagração",
    subtitle: "2Sm 8:11 — o despojo das nações feito coisa santa",
    text: "\"Os quais também o rei Davi consagrou ao Senhor, juntamente com a prata e ouro que já havia consagrado de todas as nações que sujeitara\" (2Sm 8:11). O verbo é o de santificar, separar para Deus: o que entrava em Jerusalém como saque de guerra saía do inventário do rei e passava ao tesouro do santuário. É a diferença entre um conquistador oriental comum e o rei de Israel — os outros enchiam palácios; este esvaziava o seu para o pátio da arca. E o metal tinha destino certo, pois Davi ajuntou para a casa do SENHOR ouro e prata, e \"de cobre e de ferro que não se pesou, porque era em abundância\" (1Cr 22:14). O altar aceso é o ponto em que o metal muda de natureza sem mudar de forma. E é a mesma passagem de Crônicas que dá a razão de ele não poder levantar a casa: \"Tu derramaste sangue em abundância, e fizeste grandes guerras; não edificarás casa ao meu nome\" (1Cr 22:8) — quem trouxe o ouro não construiu o templo.",
  },
  "cavalos-jarretados": {
    title: "Os cavalos jarretados",
    subtitle: "2Sm 8:4 — o tendão cortado para inutilizar a cavalaria",
    text: "\"E tomou-lhe Davi mil carros e setecentos cavaleiros e vinte mil homens de pé; e Davi jarretou a todos os cavalos dos carros\" (2Sm 8:4). JARRETAR é cortar o tendão do jarrete, atrás da articulação da pata traseira: o animal continua vivo e pode pastar, mas nunca mais puxa um carro de guerra. Parece crueldade gratuita, e é obediência — a lei do rei proibia expressamente a corrida armamentista: \"ele não multiplicará para si cavalos, nem fará voltar o povo ao Egito para multiplicar cavalos\" (Dt 17:16). No Antigo Testamento o cavalo é o símbolo da força militar em que não se deve confiar: \"Uns confiam em carros e outros em cavalos, mas nós faremos menção do nome do Senhor nosso Deus\" (Sl 20:7). Davi vence e em seguida desarma a própria vitória. É o gesto mais contraintuitivo do capítulo — e exatamente aquele que Salomão desfaria, ajuntando \"mil e quatrocentos carros e doze mil cavaleiros\" (1Rs 10:26).",
  },
  "cem-carros-reservados": {
    title: "Os cem carros reservados",
    subtitle: "2Sm 8:4 — o que Davi guardou de mil",
    text: "Do exército de rodas de Hadadezer, \"Davi jarretou a todos os cavalos dos carros, e reservou deles cem carros\" (2Sm 8:4). O carro de guerra era a arma mais cara e mais temida da Idade do Ferro — plataforma leve de duas rodas, com auriga e arqueiro, capaz de desfazer infantaria em campo aberto —, e Israel jamais tivera uma força dessas. Davi podia ter ficado com os mil; ficou com um décimo. A conta é teológica antes de ser tática: guarda-se o bastante para o serviço do rei e destrói-se o excedente que criaria confiança na força própria. Crônicas registra a mesma reserva com a mesma precisão: \"Davi jarretou todos os cavalos dos carros; porém reservou deles para cem carros\" (1Cr 18:4). E o contraste com o que vem depois é duro — Absalão começaria a sua revolta mandando \"aparelhar carros e cavalos, e cinqüenta homens que corressem adiante dele\" (2Sm 15:1).",
  },
  "cronicas-do-reino-de-davi": {
    title: "As crônicas do reino",
    subtitle: "2Sm 8:16 — o cronista na lista dos oficiais de Davi",
    text: "\"E Joabe, filho de Zeruia, era sobre o exército; e Jeosafá, filho de Ailude, era cronista\" (2Sm 8:16). O cronista — literalmente O QUE FAZ LEMBRAR — era o oficial encarregado do registro do reino: atos do rei, decisões da corte, memória oficial escrita em rolo, cargo que existia igualmente nas cortes do Egito e da Assíria. A lista em que ele aparece é o retrato de um Estado montado: exército, arquivo, sacerdócio, escrivão e guarda pessoal. Repare em onde o capítulo escolhe terminar — não numa batalha, mas num organograma: a guerra acabou, e o que fica é governo. Os livros dos Reis remeteriam sem parar a arquivos desse tipo, perguntando se tal coisa não está escrita \"no livro das crônicas dos reis de Judá\" (1Rs 14:29). O rolo em cena é a razão de este capítulo existir: alguém foi encarregado de anotar.",
  },
  "jumento-da-embaixada-de-jorao": {
    title: "O jumento da embaixada de Jorão",
    subtitle: "2Sm 8:10 — a caravana de Hamate a Jerusalém",
    text: "Toí, rei de Hamate, no alto Orontes, tinha um inimigo em comum com Israel, \"porque Hadadezer de contínuo fazia guerra a Toí\" (2Sm 8:10). Derrotado o adversário, ele manda o próprio filho, Jorão, com uma embaixada de cortesia — e a carga desce centenas de quilômetros pela estrada do norte no lombo de jumentos, que eram o animal de carga e de paz do Oriente, ao contrário do cavalo, que era de guerra. Uma comitiva assim é o reconhecimento diplomático do reino de Davi por uma corte estrangeira, e o texto deixa ver a agenda inteira: perguntar como o rei estava, dar-lhe os parabéns pela vitória, e trazer na mão vasos de prata, de ouro e de bronze. É tributo com cara de presente. O jumento carregado no caminho de Sião é a medida discreta do que Israel se tornou — uma potência a quem os reis do norte mandam presentes antes de serem obrigados a mandar.",
  },
  "prata-e-ouro-das-nacoes-sujeitadas": {
    title: "A prata e o ouro das nações sujeitadas",
    subtitle: "2Sm 8:11-12 — o tributo que virou tesouro do santuário",
    text: "Davi consagrou os vasos de Jorão \"juntamente com a prata e ouro que já havia consagrado de todas as nações que sujeitara\", e o versículo seguinte faz a lista: \"Da Síria, e de Moabe, e dos filhos de Amom, e dos filisteus, e de Amaleque, e dos despojos de Hadadezer\" (2Sm 8:11-12). É o mapa das guerras do reinado condensado num inventário de baixela. Prata e ouro lavrados eram a forma normal de riqueza móvel no mundo antigo — pesavam-se em siclos e funcionavam como moeda —, e o que a cena mostra é a inversão do costume: o saque não engorda o palácio, sobe para o pátio da arca. Israel já vira isso uma vez, quando Israel pediu aos egípcios \"jóias de prata, e jóias de ouro\" (Êx 12:35) e \"despojaram aos egípcios\" (Êx 12:36) — metal que acabou nos utensílios do tabernáculo. E há uma sentença antiga por trás de tudo: \"Minha é a prata, e meu é o ouro, disse o Senhor dos Exércitos\" (Ag 2:8) — o tributo apenas volta ao dono.",
  },
  "trono-de-toi-em-hamate": {
    title: "O trono de Toí em Hamate",
    subtitle: "2Sm 8:9-10 — o rei do norte que manda parabéns",
    text: "Hamate era uma cidade-reino no vale do Orontes, no extremo norte da Síria, e a \"entrada de Hamate\" ficou na Escritura como marco do limite ideal da terra prometida (Nm 34:8). \"Então ouvindo Toí, rei de Hamate, que Davi ferira a todo o exército de Hadadezer\" (2Sm 8:9), o velho rei fez o que faz um Estado pequeno espremido entre potências: mandou o filho cumprimentar o vencedor e alinhar-se com ele. O texto explica a sinceridade e o interesse na mesma linha, pois Hadadezer \"de contínuo fazia guerra a Toí\" (2Sm 8:10). Este trono estrangeiro é o único do capítulo que ninguém derrubou: Zobá foi ferida, Moabe medido com cordel, Edom guarnecido — mas Hamate veio pela porta da frente, com presentes na mão. E é assim que o reino de Davi alcança o Eufrates: parte por espada, parte por aliança.",
  },
  "vasos-de-jorao": {
    title: "Os vasos de Jorão",
    subtitle: "2Sm 8:10 — prata, ouro e bronze nas mãos do filho do rei",
    text: "\"e na sua mão trazia vasos de prata, e vasos de ouro, e vasos de bronze\" (2Sm 8:10). Os três metais aparecem em ordem decrescente de valor, e a lista é a fórmula do presente diplomático oriental: baixela lavrada, o tipo de riqueza que se transporta, se pesa e se exibe diante da corte. Vinham de Hamate como cortesia entre reis — e Davi fez com eles a única coisa que não se esperava de um vencedor: não os pôs em sua casa. \"Os quais também o rei Davi consagrou ao Senhor\" (2Sm 8:11). Vasos que iam ser ornamento de palácio tornaram-se utensílios do santuário, e o metal reunido nesses anos é o que Salomão encontraria pronto para a casa do SENHOR. É a lição miúda de um capítulo grande: o que se recebe pelas vitórias que Deus deu volta para Deus.",
  },
  // ---- 2 SAMUEL 9: a benevolência de Deus achada num aleijado ----
  "casa-de-maquir-em-lo-debar": {
    title: "A casa de Maquir, em Lo-Debar",
    subtitle: "2Sm 9:4-5 — o esconderijo do neto de Saul",
    text: "Lo-Debar ficava em Gileade, do outro lado do Jordão, e o nome soa em hebraico como \"sem pasto\" — lugar nenhum. Foi ali, na casa de um particular, que a casa de Saul escondeu o que restava dela: \"Eis que está em casa de Maquir, filho de Amiel, em Lo-Debar\" (9:4). Maquir era homem de posses e provaria a sua palavra até o fim: é ele quem, capítulos adiante, leva camas e mantimento a Davi em Maanaim (17:27-29). Aqui ele guarda um coxo que é herdeiro de um trono caído, longe dos olhos do rei novo, porque rei novo costumava exterminar a linhagem do antigo. Quando a chamada chega, o texto é seco: \"Então mandou o rei Davi, e o tomou da casa de Maquir, filho de Amiel, de Lo-Debar\" (9:5). Do lugar sem pasto para a mesa do rei — é o desenho inteiro do capítulo, medido entre duas casas.",
  },
  "casa-de-ziba": {
    title: "A casa de Ziba",
    subtitle: "2Sm 9:9-12 — a granja que passou a servir ao aleijado",
    text: "Ziba fora \"um servo na casa de Saul\" (9:2), e com a queda do seu senhor a fazenda do rei morto lhe ficou na mão. Davi devolve tudo ao neto de Jônatas e transforma o antigo administrador em lavrador de outro dono: \"Trabalhar-lhe-ás, pois, a terra, tu e teus filhos, e teus servos, e recolherás os frutos, para que o filho de teu senhor tenha pão para comer\" (9:10). A casa não era pequena — \"E tinha Ziba quinze filhos e vinte servos\" (9:10) —, e o capítulo fecha o inventário sem deixar dúvida sobre quem serve a quem: \"todos quantos moravam em casa de Ziba eram servos de Mefibosete\" (9:12). Uma granja inteira posta a trabalhar para um homem que não anda. O mesmo Ziba reaparece em 16:1-4 com jumentos, pão e uma denúncia contra o seu senhor, e em 19:24-30 com a versão contrária na boca do outro — e o leitor nunca mais saberá de que lado ele estava.",
  },
  "jumento-que-trouxe-mefibosete": {
    title: "O jumento do coxo",
    subtitle: "2Sm 9:5 — como se traz quem não anda",
    text: "A Escritura não descreve a viagem, diz apenas: \"Então mandou o rei Davi, e o tomou da casa de Maquir, filho de Amiel, de Lo-Debar\" (9:5). Mas o próprio Mefibosete dirá mais tarde qual era o seu único modo de ir a qualquer lugar: \"Albardarei um jumento, e nele montarei, e irei com o rei; pois o teu servo é coxo\" (19:26). O jumento não era montaria de guerra — para isso havia cavalo e carro —, e sim o animal doméstico de quem viaja em paz; para um homem \"aleijado de ambos os pés\" (9:3), era a perna que lhe faltava. Ele atravessa o Jordão sem saber se vai a um julgamento ou a um cadafalso, e chega prostrando-se com o rosto por terra. \"Quem é teu servo, para teres olhado para um cão morto tal como eu?\" (9:8), diz ele — e o que o esperava era uma cadeira à mesa, por causa de um pacto feito entre Davi e Jônatas anos antes (1Sm 20:14-15).",
  },
  "mesa-do-rei-davi": {
    title: "A mesa do rei",
    subtitle: "2Sm 9:7,11,13 — o móvel que esconde os pés",
    text: "Comer à mesa do rei, no Oriente antigo, era muito mais que ser alimentado: era ficar dentro da casa, sob o nome e a proteção do senhor dela — e, por isso mesmo, sob a sua vista. Davi promete a mesma coisa três vezes, e o capítulo repete o refrão como quem carimba um documento: \"tu sempre comerás pão à minha mesa\" (9:7), \"sempre comerá pão à minha mesa\" (9:10) e, a que muda o estatuto do homem, \"comerá à minha mesa como um dos filhos do rei\" (9:11). Não hóspede tolerado: filho. E então o versículo final junta as duas coisas que só uma mesa consegue segurar juntas: \"Morava, pois, Mefibosete em Jerusalém, porquanto sempre comia à mesa do rei, e era coxo de ambos os pés\" (9:13). Sentado, ninguém vê os pés de ninguém. É a figura mais delicada da graça em todo o livro: o defeito não foi curado, foi coberto — e o lugar não se ganhou, herdou-se de uma promessa feita a outro.",
  },

  // ---- 2 SAMUEL 11: a tarde em que o rei não saiu à guerra ----
  "leito-do-rei": {
  ...
  "banho-de-bate-seba": {
    title: "O tanque do banho",
    subtitle: "2Sm 11:2 — o que se via do terraço",
    text: "As casas de Jerusalém tinham telhado plano e se apinhavam encosta abaixo, de modo que o terraço do palácio, no ponto mais alto da cidade de Davi, dava para os pátios de meio mundo. Lá embaixo uma mulher se lavava — provavelmente o banho ritual do fim do seu período, e o narrador faz questão de anotar \"pois já estava purificada da sua imundícia\" (11:4), detalhe que serve de prova de que a criança não podia ser de Urias. Davi \"viu do terraço a uma mulher que se estava lavando; e era esta mulher mui formosa à vista\" (11:2). O verbo que perde o rei é o mesmo de Eva diante do fruto: viu. E entre o ver e o mandar buscar houve tempo de perguntar o nome — e a resposta já vinha com o marido dentro dela: \"Porventura não é esta Bate-Seba, filha de Eliã, mulher de Urias, o heteu?\" (11:3).",
  },
  "presente-da-mesa-do-rei": {
    title: "O presente da mesa do rei",
    subtitle: "2Sm 11:8 — a cortesia que era encobrimento",
    text: "Porção enviada da mesa real à casa de um súdito, o presente era honra pública e sinal de favor — o mesmo gesto com que José distinguiu Benjamim no banquete do Egito (Gn 43:34). Aqui é isca: \"Depois disse Davi a Urias: Desce à tua casa, e lava os teus pés. E, saindo Urias da casa real, logo lhe foi mandado um presente da mesa do rei\" (11:8). Lavar os pés é ir dormir em casa; a bandeja atrás dele é o empurrão delicado para que o soldado passe a noite com a mulher e a gravidez ganhe um pai plausível. O plano encalha no umbral — Urias não desce. O encobrimento, neste capítulo, tem boas maneiras: manda comida quente, pergunta pela guerra, sorri. É exatamente por isso que a cena põe o prato no palco.",
  },
  "carta-de-davi-a-joabe": {
    title: "A carta levada pela própria vítima",
    subtitle: "2Sm 11:14-15 — a sentença na mão do sentenciado",
    text: "\"E sucedeu que pela manhã Davi escreveu uma carta a Joabe; e mandou-lha por mão de Urias\" (11:14). Cartas assim eram tiras de papiro dobradas e seladas com argila, e o portador não tinha como ler o que levava: a fidelidade do mensageiro era toda a segurança do remetente. Urias, que se recusara a dormir em casa enquanto a arca estava em tendas, carrega ao acampamento a ordem da sua própria morte: \"Ponde a Urias na frente da maior força da peleja; e retirai-vos de detrás dele, para que seja ferido e morra\" (11:15). O rei não sujou a mão nem a espada — escreveu. E ao escrever fez de Joabe cúmplice, o que lhe custaria caro pelo resto do reinado, porque um general que guarda um bilhete desses nunca mais pode ser demitido. É o único documento que Davi assina contra um dos seus valentes, e Urias está na lista deles (23:39).",
  },
  "mo-corredora-de-tebes": {
    title: "O pedaço de mó de Tebes",
    subtitle: "2Sm 11:21 — a pedra que Joabe põe na boca do rei",
    text: "A mó corredora era a pedra de cima do moinho doméstico: um disco pesado que a mulher da casa girava sobre a mó fixa para moer o grão do dia. Em Tebes, uma mulher arrancou a sua do moinho e a atirou do alto do muro sobre o cabeça de guerra que cercava a cidade: \"Porém uma mulher lançou um pedaço de uma mó sobre a cabeça de Abimeleque; e quebrou-lhe o crânio\" (Jz 9:53). Todo oficial de Israel conhecia o caso como o exemplo clássico do erro tático de chegar perto demais da muralha. Joabe antecipa a repreensão do rei citando-o de cor — \"Não lançou uma mulher sobre ele do muro um pedaço de uma mó corredora, de que morreu em Tebes?\" (11:21) — e emenda a senha que fecha a boca de Davi: \"Então dirás: Também morreu teu servo Urias, o heteu\" (11:21). A pedra é o código entre dois homens que já se entenderam sem precisar escrever o nome do crime.",
  },
  "espada-que-consome": {
    title: "A espada que tanto consome este como aquele",
    subtitle: "2Sm 11:25 — o provérbio com que o rei se absolve",
    text: "Recebida a notícia da matança, Davi manda de volta ao general o conselho mais frio que já lhe saiu da boca: \"Não te pareça isto mal aos teus olhos; pois a espada tanto consome este como aquele; esforça a tua peleja contra a cidade, e a derrota\" (11:25). É um dito de soldado, verdadeiro no seu lugar — a guerra não escolhe quem leva. Mas aqui serve para dissolver um assassinato encomendado dentro de uma estatística de campanha, e a espada que ele nomeia era a sua. O narrador deixa a frase de pé por dois versículos e então põe a resposta do Céu ao lado dela: \"Porém esta coisa que Davi fez pareceu mal aos olhos do Senhor\" (11:27). Um homem disse \"Não te pareça isto mal aos teus olhos\"; Deus disse que pareceu mal aos seus. E a espada, uma vez chamada ao palco, não volta mais para a bainha (12:10).",
  },
  "berco-do-filho-de-bate-seba": {
    title: "O berço do filho de Bate-Seba",
    subtitle: "2Sm 11:27 — a última linha do capítulo",
    text: "Passado o luto que o costume dava à viúva, \"enviou Davi, e a recolheu em sua casa, e lhe foi por mulher, e deu-lhe à luz um filho\" (11:27). Do lado de fora, tudo está resolvido: o marido morreu na guerra, a viúva casou com o rei, a criança nasceu dentro do casamento e não há em Jerusalém quem tenha o que dizer. O berço é o fecho perfeito de um encobrimento perfeito. Só que o versículo não termina aí: \"Porém esta coisa que Davi fez pareceu mal aos olhos do Senhor\" (11:27). O menino não recebe nome nesta cena e não receberá nenhum em todo o livro — será sempre \"a criança\" (12:15-23). A cama pequena no canto escuro é o que sobra quando o crime já está arrumado e ainda há um Juiz que não entrou na combinação.",
  },

  // ---- 2 SAMUEL 12: a parábola, o juízo e a coroa ----
  "palavra-do-senhor-a-nata": {
    title: "A palavra do SENHOR na boca de Natã",
    subtitle: "2Sm 12:1-7 — a parábola que virou sentença",
    text: "O capítulo não começa com um profeta indignado; começa com um envio: \"E o SENHOR enviou Natã a Davi\" (12:1). E Natã não acusa — conta um caso, exatamente como se levava uma demanda ao rei para juízo: havia numa cidade dois homens, um rico e outro pobre. Davi julga com fúria e assina sem saber a própria sentença: \"Vive o Senhor, que digno de morte é o homem que fez isso\" (12:5). Só então o profeta gasta quatro palavras: \"Tu és este homem\" (12:7). É a maior aula de pregação da Bíblia: a história entrou por onde a acusação direta jamais teria entrado, e o culpado se condenou antes de perceber que falava de si. E o que Natã traz não é opinião sua — do versículo 7 em diante corre o \"assim diz o Senhor Deus de Israel\", com a conta inteira do que foi dado e a fatura exata do que foi feito.",
  },
  "copo-do-homem-pobre": {
    title: "O copo de que a cordeirinha bebia",
    subtitle: "2Sm 12:3 — a única coisa que o pobre tinha",
    text: "O rico da parábola tinha rebanhos — \"O rico possuía muitíssimas ovelhas e vacas\" (12:2); o pobre tinha uma bicha só, e Natã gasta nela o versículo mais terno de 2 Samuel: \"Mas o pobre não tinha coisa nenhuma, senão uma pequena cordeira que comprara e criara; e ela tinha crescido com ele e com seus filhos; do seu bocado comia, e do seu copo bebia, e dormia em seu regaço, e a tinha como filha\" (12:3). Cada cláusula puxa o animal um passo mais para dentro de casa: comprada com dinheiro contado, criada junto dos meninos, comendo do prato do dono, bebendo do copo dele, dormindo no colo — e no fim já nem é rebanho, é filha. O copo largado no chão do quintal é o que resta dessa intimidade depois que o rico \"tomou a cordeira do homem pobre, e a preparou para o homem que viera a ele\" (12:4). O crime da parábola não é o furto de uma ovelha: é matar um afeto para servir um jantar a quem estava só de passagem. Davi, que fora pastor e sabia ao certo o que aquilo custava, explodiu: \"E pela cordeira tornará a dar o quadruplicado, porque fez tal coisa, e porque não se compadeceu\" (12:6) — e pagou o quádruplo na própria carne, em quatro filhos.",
  },
  "leito-da-crianca": {
    title: "O leito da criança",
    subtitle: "2Sm 12:15-23 — os sete dias no chão",
    text: "\"Então Natã foi para sua casa; e o Senhor feriu a criança que a mulher de Urias dera a Davi, e adoeceu gravemente\" (12:15). Ao lado da cama pequena, o rei faz o que nenhum rei fazia: \"E buscou Davi a Deus pela criança; e jejuou Davi, e entrou, e passou a noite prostrado sobre a terra\" (12:16) — e não se levanta por sete dias, nem quando os anciãos da casa vêm erguê-lo do chão. Os servos têm medo de lhe dar a notícia; ele lê o cochicho deles e pergunta. Então vem o que ninguém na casa entendeu: \"Então Davi se levantou da terra, e se lavou, e se ungiu, e mudou de roupas, e entrou na casa do Senhor, e adorou\" (12:20). Enquanto havia vida, havia oração; morta a criança, restava adoração — porque orar nunca foi forçar a mão de Deus. E a única esperança que ele formula é sobre o caminho, não sobre a volta: \"Eu irei a ela, porém ela não voltará para mim\" (12:23).",
  },
  "berco-de-salomao": {
    title: "O berço de Salomão",
    subtitle: "2Sm 12:24-25 — Jedidias, o amado do SENHOR",
    text: "Depois do luto, o texto guarda um verbo que muda tudo: \"Então consolou Davi a Bate-Seba, sua mulher\" (12:24). É a primeira vez que ela deixa de ser \"a mulher de Urias\" e é nomeada esposa — e consolada como gente, não usada. Nasce um segundo filho: \"e ela deu à luz um filho, e deu-lhe o nome de Salomão; e o Senhor o amou\" (12:24). Salomão soa como shalom, paz, e é o nome que entra numa casa onde a espada acabara de ser prometida. O Céu ainda manda um nome próprio pelo mesmo profeta que trouxera a sentença: \"E enviou pela mão do profeta Natã, dando-lhe o nome de Jedidias, por amor ao Senhor\" (12:25) — Jedidias quer dizer \"amado do SENHOR\". Este berço, sob as estrelas, é a resposta de Deus ao berço vazio do capítulo anterior: o perdão não cancela a colheita, mas também não é estéril.",
  },
  "espada-dos-filhos-de-amom": {
    title: "A espada dos filhos de Amom",
    subtitle: "2Sm 12:9 — a arma emprestada ao crime",
    text: "A acusação de Natã nomeia o instrumento duas vezes na mesma frase, e é a segunda que fere: \"A Urias, o heteu, feriste à espada, e a sua mulher tomaste por tua mulher; e a ele mataste com a espada dos filhos de Amom\" (12:9). Davi não desembainhou nada: usou a espada do inimigo, que já estava no campo por outro motivo, como quem pega uma ferramenta emprestada. Diante do tribunal do Céu isso não vale um argumento — quem arma a mão é o mandante, e uma guerra estrangeira não lava sangue derramado dentro de casa. E antes do instrumento vem a pergunta que resume o processo inteiro: \"Por que, pois, desprezaste a palavra do Senhor, fazendo o mal diante de seus olhos?\" (12:9). Não foi tropeço de paixão: foi desprezo por uma palavra que ele conhecia de cor.",
  },
  "espada-sobre-a-casa-de-davi": {
    title: "A espada que não se aparta",
    subtitle: "2Sm 12:10-12 — o juízo que atravessa o resto do livro",
    text: "\"Agora, pois, não se apartará a espada jamais da tua casa, porquanto me desprezaste, e tomaste a mulher de Urias, o heteu, para ser tua mulher\" (12:10). É a sentença que organiza tudo o que vem depois em 2 Samuel: Amnom caído entre as talhas do vinho (13:29), Absalão traspassado no bosque (18:14), e adiante ainda Adonias. Segue a segunda camada, mais exata: \"Eis que suscitarei da tua própria casa o mal sobre ti, e tomarei tuas mulheres perante os teus olhos, e as darei a teu próximo\" (12:11) — cumprida ao pé da letra na tenda do terraço, em 16:22. E a terceira: \"Porque tu o fizeste em oculto, mas eu farei este negócio perante todo o Israel e perante o sol\" (12:12). O pecado foi perdoado logo no versículo seguinte — \"Também o Senhor perdoou o teu pecado; não morrerás\" (12:13) —, mas a espada fica fincada diante do trono, e é essa a lição dura do capítulo: perdão não é anulação da colheita.",
  },
  "cidade-das-aguas-de-raba": {
    title: "A cidade das águas de Rabá",
    subtitle: "2Sm 12:26-28 — o bairro do rio que rendeu a capital",
    text: "Rabá dos filhos de Amom — a atual Amã — era uma acrópole em rocha alta, e a sua fraqueza era a de toda cidade antiga: a água ficava embaixo, no vale do Jaboque. Tomado o bairro das nascentes, a cidadela lá em cima estava sentenciada, e é isso que Joabe comunica: \"Pelejei contra Rabá, e também tomei a cidade das águas\" (12:27). O que ele faz em seguida diz muito do general: chama o rei para dar o último golpe e ficar com o nome — \"Ajunta, pois, agora o restante do povo, e cerca a cidade, e toma-a, para que tomando eu a cidade, não se aclame sobre ela o meu nome\" (12:28). É lealdade e é advertência: Joabe sabe medir o que um rei deve a ele. E é o mesmo cerco que a carta do capítulo 11 usara como matadouro — Davi só volta ao campo depois que o profeta o quebrou (12:29).",
  },
  "coroa-de-raba": {
    title: "A coroa do rei de Amom",
    subtitle: "2Sm 12:30 — um talento de ouro sobre a cabeça de Davi",
    text: "\"E tirou a coroa da cabeça do seu rei, cujo peso era de um talento de ouro, e havia nela pedras preciosas, e foi posta sobre a cabeça de Davi; e da cidade levou mui grande despojo\" (12:30). Um talento passava dos trinta quilos: não é peça de uso diário, é insígnia de tesouro — coroas desse porte costumavam repousar sobre a cabeça do ídolo nacional, e o hebraico daqui admite ler \"Milcom\", o deus de Amom. Sobre um homem, uma coisa dessas só se põe por um instante, como gesto de posse. A cena é gloriosa e vem no pior lugar possível do livro: o rei recebe o maior troféu da sua carreira no mesmo capítulo em que ouviu \"não se apartará a espada jamais da tua casa\" (12:10) e enterrou um filho sem nome. Ouro sobre a cabeça, espada sobre a casa — é assim que 2 Samuel fecha a sua primeira metade.",
  },

  // ---- 2 SAMUEL 13: a casa do rei se rasga por dentro ----
  "cama-de-amnom": {
    title: "A cama do fingimento",
    subtitle: "2Sm 13:5-11 — o leito que serviu de armadilha",
    text: "O conselho de Jonadabe, \"homem mui sagaz\" (13:3), começa por um móvel: \"Deita-te na tua cama, e finge-te doente; e, quando teu pai te vier visitar, dize-lhe: Peço-te que minha irmã Tamar venha\" (13:5). Doença era o único pretexto capaz de abrir a casa de um filho do rei ao serviço pessoal de uma irmã virgem, e Amnom obedece à risca: \"Deitou-se, pois, Amnom, e fingiu-se doente\" (13:6). Da cama ele governa a cena inteira — manda a irmã cozinhar à sua vista, manda esvaziar a casa, manda trazer a comida ao quarto de dentro —, e o narrador marca a encenação com um parêntese frio, enquanto ela amassa a massa: \"E foi Tamar à casa de Amnom, seu irmão (ele porém estava deitado)\" (13:8). O que a Escritura mostra é isto: um homem deitado, uma porta e uma ordem de cada vez. A violência ela nomeia sem exibir (13:14) — e o mesmo leito volta ao palco dois anos depois, como o lugar de onde saiu tudo o que o pai não puniu e o irmão não esqueceu.",
  },
  "forno-dos-bolos-de-tamar": {
    title: "O forno dos bolos de Tamar",
    subtitle: "2Sm 13:6-8 — o pão feito diante dos olhos dele",
    text: "O pedido tinha forma de capricho de doente e substância de cilada: \"Peço-te que minha irmã Tamar venha, e prepare dois bolos diante dos meus olhos, para que eu coma de sua mão\" (13:6). Os bolos eram pães pequenos de massa sovada e assados na hora, comida que se faz para quem não tem apetite — e o essencial do pedido não está no pão, está no \"diante dos meus olhos\". Tamar cumpre com o esmero de uma princesa: \"e tomou massa, e a amassou, e fez bolos diante dos seus olhos, e cozeu os bolos\" (13:8). A cozinha é doméstica, o gesto é de cuidado, e uma filha do rei está servindo um irmão que se diz enfermo. Todo o horror deste capítulo passa primeiro por aqui: um forno aceso e uma moça fazendo exatamente o que o pai lhe mandou fazer (13:7).",
  },
  "frigideira-de-tamar": {
    title: "A frigideira de Tamar",
    subtitle: "2Sm 13:9 — o prato recusado e a casa esvaziada",
    text: "\"E tomou a frigideira, e os tirou diante dele; porém ele recusou comer\" (13:9). A recusa é o sinal de que nunca houve fome. Da mesma respiração sai a ordem que fecha o cerco: \"E disse Amnom: Fazei retirar a todos da minha presença. E todos se retiraram dele\" (13:9). Na casa de um filho do rei havia sempre criados por perto, e é justamente essa gente que ele manda embora antes de chamar a irmã ao quarto de dentro. A travessa largada na sala de fora é a última coisa inocente da cena: comida quente que ninguém comeu. Tamar ainda tentaria a razão, a lei e o costume — \"Não, meu irmão, não me forces, porque não se faz assim em Israel; não faças tal loucura\" (13:12) —, e o texto responde por ele em seis palavras: \"Porém ele não quis dar ouvidos à sua voz\" (13:14).",
  },
  "porta-ferrolhada-de-amnom": {
    title: "A porta fechada após ela",
    subtitle: "2Sm 13:17-18 — o ferrolho que o texto conta duas vezes",
    text: "Terminado o crime, o ódio de Amnom foi maior que o desejo — \"pois maior era o ódio que sentiu por ela do que o amor com que a amara\" (13:15) —, e a última coisa que ele faz é dar uma ordem a respeito de uma porta: \"Ponha fora a esta, e fecha a porta após ela\" (13:17). Nem sequer a nomeia: \"esta\". O narrador repete o gesto inteiro para que ninguém o perca: \"e seu servo a pôs para fora, e fechou a porta após ela\" (13:18). Pela lei de Israel, quem humilhasse assim uma moça lhe devia casa e sustento por toda a vida, sem poder despedi-la em todos os seus dias (Dt 22:29); Amnom lhe dá o batente. Essa porta é a imagem de tudo o que o capítulo faz com Tamar: expulsa pelo irmão que a violou, calada pelo irmão que a vingaria — \"Ora, pois, minha irmã, cala-te; é teu irmão\" (13:20) — e deixada \"solitária em casa de Absalão seu irmão\" (13:20).",
  },
  "atalaia-de-jerusalem": {
    title: "A atalaia do muro",
    subtitle: "2Sm 13:34 — o moço que levantou os olhos",
    text: "Toda cidade murada mantinha um vigia no alto, e a sua função era simples: ver primeiro. Enquanto no palácio corria a notícia falsa de que \"Absalão feriu a todos os filhos do rei, e nenhum deles ficou\" (13:30) e o rei já estava por terra com as vestes rasgadas, foi da torre que veio a correção: \"E Absalão fugiu; e o moço que estava de guarda, levantou os seus olhos, e olhou; e eis que muito povo vinha pelo caminho por detrás dele, pelo lado do monte\" (13:34). O que ele avista são os filhos do rei vivos, subindo pela estrada. A atalaia é o contraponto do capítulo inteiro: numa casa onde ninguém enxergou o que Amnom tramava, nem o que Absalão guardou calado por dois anos, o único que viu a tempo foi um rapaz posto num muro só para olhar o caminho.",
  },
  "vinho-de-baal-hazor": {
    title: "O vinho da tosquia de Baal-Hazor",
    subtitle: "2Sm 13:23-29 — a festa que era emboscada",
    text: "A tosquia era a colheita do pastor e terminava sempre em banquete de dias, com vinho farto e casa cheia — foi numa festa dessas que Nabal ficou \"muito embriagado\" (1Sm 25:36). Absalão monta a sua \"em Baal-Hazor, que está junto a Efraim\" (13:23), dois anos depois do crime, e convida todos os filhos do rei, insistindo com o pai até conseguir levar Amnom. A ordem aos servos tem o vinho por relógio: \"Tomai sentido; quando o coração de Amnom estiver alegre do vinho, e eu vos disser: Feri a Amnom, então o matareis\" (13:28). Não é o vinho que mata: é a hospitalidade transformada em arma, e um homem bebendo à mesa de quem já lhe contou os dias. Amnom cai junto às talhas — a espada de 12:10 entrando na casa de Davi pela primeira vez.",
  },
  "espada-dos-servos-de-absalao": {
    title: "A espada dos servos de Absalão",
    subtitle: "2Sm 13:28-29 — a ordem que o senhor assume inteira",
    text: "Absalão não fere ninguém com a própria mão: monta uma cadeia de comando e a assume em voz alta diante dos moços, com palavras de general antes da batalha ditas para um assassinato à mesa — \"não temais: porque porventura não sou eu quem vo-lo ordenei? Esforçai-vos, e sede valentes\" (13:28). E foi feito: \"E os servos de Absalão fizeram a Amnom como Absalão lho havia ordenado\" (13:29). O silêncio dos dois anos anteriores já estava explicado desde antes: \"Porém Absalão não falou com Amnom, nem mal nem bem; porque Absalão odiava a Amnom, por ter forçado a Tamar sua irmã\" (13:22). E Jonadabe, o mesmo primo que armara a cilada de Amnom, sabia de tudo o tempo todo: \"porque assim tinha resolvido fazer Absalão, desde o dia em que forçou a Tamar sua irmã\" (13:32). Esta é a espada que Natã prometeu, agora empunhada por criados.",
  },
  "mulos-dos-filhos-do-rei": {
    title: "Os mulos dos filhos do rei",
    subtitle: "2Sm 13:29 — a debandada de Baal-Hazor",
    text: "A mula era a montaria da realeza em Israel: nela Salomão seria levado a Giom para ser ungido — \"fazei subir a meu filho Salomão na mula que é minha\" (1Rs 1:33) —, e nela andaria Absalão até o dia do carvalho (18:9). Cada príncipe tinha a sua, e é isso que faz da fuga uma cena de família desfeita: \"Então todos os filhos do rei se levantaram, e montaram cada um no seu mulo, e fugiram\" (13:29). Os mesmos animais que os trouxeram à festa os levam de volta a Jerusalém, mas a notícia errada corre mais depressa e chega antes deles, dando por mortos todos os irmãos (13:30). No portão, os mulos param suados e o texto guarda o som do reencontro: \"os filhos do rei vieram, e levantaram a sua voz, e choraram; e também o rei e todos os seus servos choraram amargamente\" (13:36).",
  },
  "fortaleza-de-gesur": {
    title: "A fortaleza de Gesur",
    subtitle: "2Sm 13:37-38 — o exílio na casa do avô",
    text: "Gesur era um pequeno reino arameu a leste do mar da Galileia, e o seu rei era o avô materno de Absalão: entre os filhos nascidos a Davi em Hebrom está \"o terceiro Absalão, filho de Maaca, filha de Talmai, rei de Gesur\" (3:3). Por isso o fugitivo não corre para o deserto — corre para a família: \"Assim Absalão fugiu, e foi a Talmai, filho de Amiur, rei de Gesur\" (13:37). Ali está fora do alcance dos vingadores do sangue de Israel e fora do alcance do pai: \"Assim Absalão fugiu, e foi para Gesur; esteve ali três anos\" (13:38). O capítulo se encerra num coração dividido que não toma providência nenhuma: \"Então tinha o rei Davi saudades de Absalão; porque já se tinha consolado acerca da morte de Amnom\" (13:39). Saudade que não chama de volta é o que abre o capítulo seguinte — e, no fim, a revolta.",
  },

  // ---- 2 SAMUEL 14: a parábola da tecoíta e o desterrado que voltou pela metade ----
  "poco-de-tecoa": {
    title: "O poço de Tecoa",
    subtitle: "2Sm 14:2 — a aldeia de onde Joabe tirou a sua atriz",
    text: "Tecoa ficava nos montes secos de Judá, poucas milhas ao sul de Belém, na borda do deserto: terra de pastores e de gente calejada, que séculos depois daria um profeta ao Reino do Norte — \"As palavras de Amós, que estava entre os pastores de Tecoa\" (Am 1:1). O poço da praça era o centro da vida de uma aldeia assim: onde as mulheres se juntavam de manhã, onde as histórias corriam e onde se aprendia a falar por caso e por provérbio. É de lá que o general manda buscar a sua peça: \"Enviou Joabe a Tecoa, e tomou de lá uma mulher\" (14:2). Ela não é profetisa nem nobre; é uma aldeã instruída a fingir luto — \"veste roupas de luto, e não te unjas com óleo\" (14:2) — e a quem \"Joabe lhe pôs as palavras na boca\" (14:3). Toda a volta de Absalão a Jerusalém começa neste poço.",
  },
  "jumento-da-tecoita": {
    title: "O jumento da mulher de Tecoa",
    subtitle: "2Sm 14:2-4 — a subida a Jerusalém com a causa na boca",
    text: "De Tecoa a Jerusalém eram horas de subida pela montanha, e quem levava demanda ao rei fazia esse caminho no lombo de um jumento, o animal de carga e de viagem da gente comum. O texto não descreve a jornada, só a chegada: \"E a mulher tecoíta falou ao rei, e, deitando-se com o rosto em terra, se prostrou e disse: Salva-me, ó rei\" (14:4). Ela vem vestida de um luto encomendado, com um caso inventado na boca — dois filhos, uma briga no campo, \"e não houve quem os apartasse\" (14:6) — e com a linhagem inteira pedindo a cabeça do que sobrou. O jumento parado no pátio completa o disfarce: uma viúva pobre do interior, sem nada e sem ninguém por trás dela, a não ser o comandante do exército de Israel.",
  },
  "brasa-que-me-ficou": {
    title: "A brasa que me ficou",
    subtitle: "2Sm 14:7 — a última chama de uma casa",
    text: "Numa casa antiga o fogo não apagava de todo: guardava-se uma brasa sob a cinza da noite para acender o lume do dia seguinte, e a imagem virou o modo de dizer \"o último herdeiro\" — aquele em quem o nome de um homem morto ainda respira. É com isso que a tecoíta encurrala o rei: se entregarem aos vingadores do sangue o filho que lhe resta, \"Assim apagarão a brasa que me ficou, de sorte que não deixam a meu marido nome, nem remanescente sobre a terra\" (14:7). Davi julga o caso alheio e jura com solenidade: \"Vive o Senhor, que não há de cair no chão nem um dos cabelos de teu filho\" (14:11). Só então ela vira o espelho para ele — o rei tem um filho fora, banido, e é a sua própria casa que está com a brasa ao relento (14:13). E vem, na boca de uma aldeã contratada, a frase mais bonita do capítulo: \"Deus, pois, lhe não tirará a vida, mas cogita meios, para que não fique banido dele o seu desterrado\" (14:14).",
  },
  "porta-da-face-do-rei": {
    title: "A porta da face do rei",
    subtitle: "2Sm 14:24,28 — o perdão pela metade",
    text: "Ver a face do rei era, na corte oriental, o mesmo que estar restituído: significava audiência, favor e lugar reconhecido na casa. Davi traz o filho de volta do exílio e lhe nega exatamente isso: \"E disse o rei: Torne para a sua casa, e não veja a minha face. Tornou, pois, Absalão para sua casa, e não viu a face do rei\" (14:24). Perdão sem reconciliação tem a forma precisa de uma porta fechada — e ela fica fechada muito tempo: \"Assim ficou Absalão dois anos inteiros em Jerusalém, e não viu a face do rei\" (14:28). Nesses dois anos cresce tudo o que estoura no capítulo seguinte: a fila da porta da cidade, os carros, os cinquenta corredores, a conjuração. Quando o beijo enfim chega (14:33), já é tarde: um filho perdoado sem ser recebido acaba indo buscar por conta própria o que não lhe deram.",
  },
  "peso-real": {
    title: "O peso real da balança",
    subtitle: "2Sm 14:26 — duzentos siclos de cabelo",
    text: "Cada praça tinha os seus pesos de pedra, e havia um padrão oficial, aferido pela corte, para as pesagens de valor: o peso real. O narrador o invoca para dar exatidão a um detalhe que parece apenas vaidade: \"E, quando tosquiava a sua cabeça (e sucedia que no fim de cada ano a tosquiava, porquanto muito lhe pesava, e por isso a tosquiava), pesava o cabelo da sua cabeça duzentos siclos, segundo o peso real\" (14:26). São mais de dois quilos de cabelo por ano, cortados em cerimônia anual e postos na balança como se fossem prata. Vem logo antes o retrato do homem: \"Não havia, porém, em todo o Israel homem tão belo e tão aprazível como Absalão; desde a planta do pé até à cabeça não havia nele defeito algum\" (14:25). A Escritura pesa a cabeleira do príncipe porque é por ela que ele ficará preso ao carvalho, \"pendurado entre o céu e a terra\" (18:9).",
  },
  "cevada-de-joabe": {
    title: "A cevada do campo de Joabe",
    subtitle: "2Sm 14:30 — a courela pegada à do príncipe",
    text: "A cevada amadurecia antes do trigo e era o pão do povo miúdo e a ração dos animais; um pedaço de campo com a cevada em pé representava o ano inteiro de trabalho de uma casa. Joabe, que arriscara o pescoço para trazer Absalão de volta, agora se recusa duas vezes seguidas a atendê-lo. O príncipe então aponta para o que dói: \"Vedes ali o pedaço de campo de Joabe pegado ao meu, e tem cevada nele; ide, e ponde-lhe fogo\" (14:30). Não é vandalismo cego: é uma intimação calculada, feita na propriedade do homem mais poderoso do reino depois do rei, para forçar uma conversa que ele vinha evitando. E funciona no mesmo dia. O leitor guarda o método, porque ele vai voltar em escala maior: este é um homem que consegue o que quer queimando o que é dos outros.",
  },
  "fogo-no-campo-de-joabe": {
    title: "O fogo posto pelos servos de Absalão",
    subtitle: "2Sm 14:30-31 — a chantagem que deu certo",
    text: "\"E os servos de Absalão puseram fogo ao pedaço de campo\" (14:30). Um campo de cevada seca arde em minutos e não deixa nada de pé; a coluna de fumaça é visível de toda a Jerusalém, e era essa a intenção. Joabe, que ignorara dois chamados, aparece imediatamente: \"Então Joabe se levantou, e veio a Absalão, em casa, e disse-lhe: Por que puseram os teus servos fogo ao pedaço de campo que é meu?\" (14:31). A resposta não traz pedido de desculpa nenhum — traz uma exigência de audiência com o pai e uma bravata: \"Agora, pois, veja eu a face do rei; e, se há ainda em mim alguma culpa, que me mate\" (14:32). O incêndio arranca num dia o que dois anos de espera não deram. É o primeiro ato público de força de Absalão, e quem aprende a queimar o campo do general acabará por armar tenda no terraço do rei.",
  },

  // ---- 2 SAMUEL 15: o golpe, a fuga descalça e o Cedrom ----
  "carro-de-absalao": {
    title: "O carro de Absalão",
    subtitle: "2Sm 15:1 — a revolta começa por uma escolta",
    text: "\"E aconteceu depois disto que Absalão fez aparelhar carros e cavalos, e cinqüenta homens que corressem adiante dele\" (15:1). O carro de guerra não era transporte, era insígnia — Israel jarretava os cavalos dos reis que vencia, e Davi \"jarretou a todos os cavalos dos carros, e reservou deles cem carros\" (8:4) —, e a Lei advertia que o rei não devia multiplicar cavalos para si (Dt 17:16). Absalão faz o contrário, e à vista de todos. Os corredores à frente são o detalhe caro do arranjo: homens pagos apenas para abrir caminho e anunciar quem vem — o mesmo aparato que Adonias copiaria depois (1Rs 1:5). Ninguém o coroou; ele simplesmente começou a parecer rei, e em política aparência que ninguém contesta acaba virando posse. O primeiro objeto do golpe não é uma arma: é um desfile.",
  },
  "cavalos-de-absalao": {
    title: "Os cavalos do príncipe",
    subtitle: "2Sm 15:1 — o luxo que Israel não punha na rua",
    text: "Cavalo, em Israel, era coisa de exército estrangeiro e de rei confiado na própria força: \"Uns confiam em carros e outros em cavalos, mas nós faremos menção do nome do Senhor nosso Deus\" (Sl 20:7). O próprio Davi, depois de vencer Hadadezer, aleijou os animais tomados e guardou só o mínimo (8:4). Agora um filho seu atrela os seus na rua da cidade de Davi — \"fez aparelhar carros e cavalos\" (15:1) — e passa por ali todas as manhãs, de modo que o povo o veja antes de ver o rei. O luxo faz parte do argumento: um homem com aquilo tudo à disposição deve ser mesmo alguém a quem vale a pena levar as próprias causas. É propaganda antes de ser conspiração.",
  },
  "porta-da-cidade-de-jerusalem": {
    title: "A porta da cidade",
    subtitle: "2Sm 15:2-6 — o tribunal onde se furtavam corações",
    text: "O vão da porta era o fórum da cidade antiga: ali se sentavam os anciãos, fechavam-se contratos, ouviam-se demandas, e por ali passava obrigatoriamente todo aquele que chegava de fora. Absalão instala-se nesse gargalo: \"Também Absalão se levantou pela manhã, e parava a um lado do caminho da porta\" (15:2). Intercepta o litigante antes do rei, dá razão à causa sem ter ouvido a outra parte — \"Olha, os teus negócios são bons e retos, porém não tens quem te ouça da parte do rei\" (15:3) — e promete o cargo que não tem: \"Ah, quem me dera ser juiz na terra\" (15:4). Depois abraça e beija quem vinha para se inclinar (15:5), abolindo com um gesto a distância entre o povo e o trono. O narrador dá o veredito com um verbo de furto: \"assim furtava Absalão o coração dos homens de Israel\" (15:6).",
  },
  "altar-do-voto-de-absalao": {
    title: "O altar do voto de Hebrom",
    subtitle: "2Sm 15:7-9 — a religião usada como salvo-conduto",
    text: "Pagar um voto era ato público de culto — sacrifício, festa, gente convocada de longe —, e nenhum rei de Israel podia negar licença para uma coisa dessas. Absalão usa a piedade como cobertura de tropa: \"Deixa-me ir pagar em Hebrom o meu voto que fiz ao Senhor\", e ainda acrescenta o detalhe comovente de que o fizera no exílio, \"morando eu em Gesur, na Síria\" (15:7-8). Hebrom não é escolha devota: é a cidade onde ele nasceu (3:2-3) e onde o próprio Davi fora ungido rei (2:4; 5:3), com um ressentimento antigo por ter perdido a capital para Jerusalém. O pai responde duas palavras — \"Vai em paz\" (15:9) — e o altar acende. Enquanto a fumaça sobe, \"a conjuração se fortificava, e vinha o povo, e ia crescendo com Absalão\" (15:12). O culto virou logística de golpe.",
  },
  "trombetas-de-hebrom": {
    title: "As trombetas de Hebrom",
    subtitle: "2Sm 15:10 — a senha combinada por todas as tribos",
    text: "A trombeta de chifre de carneiro servia para convocar assembleia, dar alarme e aclamar rei; era ouvida de monte em monte e funcionava como o rádio do mundo antigo. Absalão distribui espias por todo o Israel com uma ordem única: \"Quando ouvirdes o som das trombetas, direis: Absalão reina em Hebrom\" (15:10). O golpe não é dado por um exército, é dado por um som e por uma frase repetida ao mesmo tempo em muitos lugares — quando Jerusalém souber, o país inteiro já estará dizendo a mesma coisa. E foram com ele duzentos convidados de Jerusalém que não sabiam de nada: \"porém iam na sua simplicidade, porque nada sabiam daquele negócio\" (15:11), gente respeitável servindo de fachada. A mesma trombeta anunciaria, capítulos depois, o fim dele (18:16).",
  },
  "ribeiro-de-cedrom": {
  ...
  "lugar-de-adorar-no-cume": {
    title: "O cume onde se adorava a Deus",
    subtitle: "2Sm 15:30-32 — o alto do Olival, no pior dia do reinado",
    text: "No topo do monte das Oliveiras havia um lugar consagrado à oração, com Jerusalém inteira visível lá embaixo, e é para lá que a fuga sobe: \"E seguiu Davi pela encosta do monte das Oliveiras, subindo e chorando, e com a cabeça coberta; e caminhava com os pés descalços\" (15:30). Descalço e de cabeça coberta era traje de luto e penitência, não de rei. No alto, o texto marca a razão da subida: \"chegando Davi ao cume, para adorar ali a Deus\" (15:32). Um homem que acaba de perder tudo faz a única coisa que ainda lhe é possível, e no mesmo fôlego solta a oração mais curta e mais atendida do livro: \"Ó Senhor, peço-te que torne em loucura o conselho de Aitofel\" (15:31) — a resposta chega em carne e osso, no versículo do cume, com Husai aparecendo de roupa rasgada e terra na cabeça. Deste mesmo alto, olhando esta mesma cidade, o Filho de Davi choraria por ela (Lc 19:41).",
  },

  // ---- 2 SAMUEL 16: as pedras, as provisões e a tenda no terraço ----
  "jumentos-albardados-de-ziba": {
    title: "O par de jumentos albardados",
    subtitle: "2Sm 16:1-2 — o socorro que chegou cedo demais",
    text: "\"E passando Davi um pouco mais adiante do cume, eis que Ziba, o servo de Mefibosete, veio encontrar-se com ele, com um par de jumentos albardados\" (16:1). Albardado é o animal já selado e carregado, pronto para montar — e Ziba explica sem que lhe perguntem: \"Os jumentos são para a casa do rei, para se montarem neles\" (16:2). É uma cortesia rara para um rei que vai a pé e descalço pelo meio da montanha. O que incomoda é a hora: para estar naquele ponto do caminho com a carga arrumada, o servo saiu de Jerusalém antes de se saber por onde a fuga passaria. E ele aproveita o momento exato para acusar o próprio senhor de traição (16:3), saindo dali com a herança inteira de Mefibosete na mão (16:4). Em 19:24-30 a outra versão será contada, e o rei nunca mais conseguirá saber qual dos dois mentiu.",
  },
  "provisao-de-ziba": {
    title: "Os duzentos pães, as passas e as frutas de verão",
    subtitle: "2Sm 16:1-2 — a despensa de um presente calculado",
    text: "A carga vem inventariada com precisão de recibo: \"duzentos pães, com cem cachos de passas, e cem de frutas de verão e um odre de vinho\" (16:1). Passas e figos prensados eram a ração de marcha do mundo antigo — açúcar concentrado que não estraga no caminho —, exatamente o que se leva para atravessar um deserto com gente cansada. Ziba explica item por item, como quem já ensaiou o discurso: \"o pão e as frutas de verão para comerem os moços; e o vinho para beberem os cansados no deserto\" (16:2). Abigail levara uma carga quase igual a este mesmo Davi, anos antes, sem segunda intenção nenhuma: \"duzentos pães, e dois odres de vinho... e cem cachos de passas\" (1Sm 25:18). Aqui o presente é generoso, oportuno e verdadeiro no seu efeito — e a Escritura simplesmente o coloca ao lado da denúncia que veio na mesma frase, e deixa o leitor pesar as duas coisas.",
  },
  "odre-de-vinho-de-ziba": {
    title: "O odre de vinho",
    subtitle: "2Sm 16:1-2 — para os cansados no deserto",
    text: "O odre era um couro inteiro de cabra, costurado e curtido: o vasilhame de viagem por excelência, leve, inquebrável e capaz de levar dezenas de litros no lombo de um jumento. Na lista de Ziba ele é o único item que vem no singular — \"e um odre de vinho\" (16:1) —, e o uso declarado não é festa, é remédio de estrada: \"e o vinho para beberem os cansados no deserto\" (16:2). É o mesmo emprego sóbrio que Paulo recomendaria a Timóteo, \"por causa do teu estômago e das tuas freqüentes enfermidades\" (1Tm 5:23). A cena inteira vive de contraste: o rei sobe o monte descalço, chorando e sem provisão nenhuma, e recebe da mão de um servo alheio o que a sua própria casa não lhe soube dar.",
  },
  "pedras-de-simei": {
    title: "As pedras de Simei",
    subtitle: "2Sm 16:5-13 — o apedrejamento que Davi não deixou vingar",
    text: "Baurim era aldeia de Benjamim, a tribo de Saul, e o caminho do rei passava por baixo da encosta — posição perfeita para quem quer atirar e não ser alcançado. \"E atirava pedras contra Davi, e contra todos os servos do rei Davi; ainda que todo o povo e todos os valentes iam à sua direita e à sua esquerda\" (16:6). Simei acompanha o cortejo pela ladeira o dia inteiro: \"e também Simei ia ao longo do monte, defronte dele, caminhando e amaldiçoando, e atirava pedras contra ele, e levantava poeira\" (16:13). A acusação — \"Sai, sai, homem de sangue, e homem de Belial\" (16:7) — era injusta quanto à casa de Saul e dolorosamente certeira quanto a Urias. E Davi não se defende: \"Ora deixai-o amaldiçoar; pois o Senhor lhe disse: Amaldiçoa a Davi\" (16:10). Um rei que recebe a pedra como castigo merecido é a coisa mais parecida com arrependimento que este livro mostra.",
  },
  "espada-de-abisai": {
    title: "A espada de Abisai",
    subtitle: "2Sm 16:9-12 — a lâmina que não saiu da bainha",
    text: "Abisai, filho de Zeruia, era o mesmo homem que já quisera encravar Saul na terra com a lança, no arraial adormecido (1Sm 26:8), e reage aqui do mesmo jeito: \"Por que amaldiçoaria este cão morto ao rei meu senhor? Deixa-me passar, e lhe tirarei a cabeça\" (16:9). Pela Lei, maldizer o príncipe do povo era crime capital (Êx 22:28), de modo que o pedido é tecnicamente legítimo — e é justamente por isso que a recusa pesa. O rei responde duas vezes, e a segunda razão dói: \"Eis que meu filho, que saiu das minhas entranhas, procura a minha morte; quanto mais ainda este benjamita?\" (16:11). Depois entrega a causa ao Juiz certo: \"Porventura o Senhor olhará para a minha miséria; e o Senhor me pagará com bem a sua maldição deste dia\" (16:12). A espada fica embainhada — e no dia do regresso Davi ainda a manteria longe de Simei: \"Não morrerás. E o rei lho jurou\" (19:23).",
  },
  "tenda-do-terraco": {
    title: "A tenda armada no terraço",
    subtitle: "2Sm 16:20-22 — a palavra de Natã cumprida à letra",
    text: "O conselho foi de Aitofel, e foi dado como ato de Estado: possuir as mulheres do rei anterior era declarar em público que o trono mudara de dono e que não havia mais volta atrás — \"e assim todo o Israel ouvirá que te fizeste aborrecível para com teu pai; e se fortalecerão as mãos de todos os que estão contigo\" (16:21). \"Estenderam, pois, para Absalão uma tenda no terraço; e Absalão possuiu as concubinas de seu pai, perante os olhos de todo o Israel\" (16:22). O terraço é o mesmo de onde o pai vira Bate-Seba se lavando (11:2), e o texto não precisa comentar nada: quatro capítulos antes, Natã dissera \"tomarei tuas mulheres perante os teus olhos, e as darei a teu próximo\" (12:11) e \"tu o fizeste em oculto, mas eu farei este negócio perante todo o Israel e perante o sol\" (12:12). O que foi feito à sombra de uma tarde volta armado sobre o telhado, à vista da cidade inteira. As dez mulheres deixadas \"para guardarem a casa\" (15:16) pagam a conta e ficariam \"encerradas até ao dia da sua morte, vivendo como viúvas\" (20:3).",
  },
  "leito-do-terraco": {
    title: "O leito arrastado para o telhado",
    subtitle: "2Sm 16:22 — o pecado do pai devolvido em público",
    text: "Os telhados de Jerusalém eram planos e serviam de quarto de verão; armar tenda em cima de um deles era coisa comum, e o escandaloso está no que se põe dentro. Este leito é o gêmeo público daquele de 11:2, aquele de que Davi \"se levantou\" numa tarde para ir olhar o terraço vizinho. Agora é a cidade que olha para cima: \"Absalão possuiu as concubinas de seu pai, perante os olhos de todo o Israel\" (16:22). O narrador não descreve nada além do fato, e o horror inteiro está no advérbio — perante os olhos. A cama que o pai usou em segredo, o filho a põe no lugar mais alto e mais visível da casa, e o faz por frio cálculo político: era preciso queimar em público toda ponte de reconciliação, para que os conjurados soubessem que não havia recuo possível.",
  },
  "trono-vazio-de-davi": {
    title: "O trono vazio de Davi",
    subtitle: "2Sm 16:15-23 — o salão com outro homem sentado",
    text: "\"Absalão, pois, e todo o povo, os homens de Israel, vieram a Jerusalém; e Aitofel com ele\" (16:15). O palácio não foi saqueado nem incendiado: o rei saiu a pé por um lado e o outro entrou pelo portão principal, e o cenário continuou o mesmo — as mesmas colunas, o mesmo candelabro, o mesmo salão onde uma mulher de Tecoa pedira justiça. Mudou apenas quem se assenta. É diante desse vazio que Husai grita \"Viva o rei, viva o rei!\" (16:16) sem dizer qual dos dois, e é ali que se dá o conselho da tenda no terraço. O trono desocupado é o retrato exato do que uma conjuração consegue e do que não consegue: tomou-se a cadeira, mas não se tocou no juramento que Deus fizera a Davi — \"a tua casa e o teu reino serão firmados para sempre diante de ti\" (7:16).",
  },
  "conselho-de-aitofel": {
    title: "O conselho de Aitofel",
    subtitle: "2Sm 16:23 — ouvido como se fosse oráculo",
    text: "Aitofel, o gilonita, fora conselheiro de Davi (15:12) e tinha a maior reputação do reino: \"E era o conselho de Aitofel, que aconselhava naqueles dias, como se a palavra de Deus se consultara; tal era todo o conselho de Aitofel, assim para com Davi como para com Absalão\" (16:23). Repare no fecho: servia igualmente aos dois lados — é o elogio e a condenação do homem numa linha só. Ele passou para a revolta logo no início, e a notícia arrancou de Davi a única oração de dano de todo o livro: \"Ó Senhor, peço-te que torne em loucura o conselho de Aitofel\" (15:31). O rolo posto entre os dois tronos é o verdadeiro poder daquele salão, e é exatamente ele que Deus vai desmanchar no capítulo seguinte — não com um exército, mas com um discurso mais bonito e pior, \"porém assim o Senhor o ordenara, para aniquilar o bom conselho de Aitofel\" (17:14).",
  },

  // ---- 2 SAMUEL 17: o poço, o jumento e as camas de Maanaim ----
  "poco-de-baurim": {
    title: "O poço do pátio de Baurim",
    subtitle: "2Sm 17:18-20 — a tampa e o grão descascado",
    text: "Poços de pátio eram cisternas cavadas na rocha, estreitas na boca e largas no fundo, quase secas no fim do verão: bom esconderijo para dois homens, e péssimo lugar para se estar quando alguém os procura. Aimaás e Jônatas levavam a Davi o aviso que salvaria o exército inteiro, e foram vistos; correram para Baurim — a mesma aldeia hostil onde Simei atirara pedras — e entraram \"em casa de um homem, em Baurim, o qual tinha um poço no seu pátio, e ali dentro desceram\" (17:18). O que vem depois é obra de uma mulher que a Bíblia não nomeia: \"E tomou a mulher a tampa, e a estendeu sobre a boca do poço, e espalhou grão descascado sobre ela; assim nada se soube\" (17:19). O grão posto a secar ao sol é o detalhe genial — não esconde a tampa, explica-a. E aos perseguidores ela responde com sangue-frio: \"Já passaram o vau das águas\" (17:20). Como Raabe em Jericó (Js 2:4-6), uma dona de casa com uma coberta na mão decidiu o desfecho de uma guerra.",
  },
  "jumento-de-aitofel": {
    title: "O jumento que Aitofel albardou",
    subtitle: "2Sm 17:23 — a viagem de um homem que vai pôr a casa em ordem",
    text: "O versículo é uma fila de verbos sem uma palavra de comentário: \"Vendo, pois, Aitofel que se não tinha seguido o seu conselho, albardou o jumento, e levantou-se, e foi para sua casa e para a sua cidade, e deu ordem à sua casa, e se enforcou e morreu, e foi sepultado na sepultura de seu pai\" (17:23). Ele não morre de vaidade ferida: morre de cálculo. Sabia melhor que ninguém que a demora aconselhada por Husai daria a Davi o Jordão, e que, vencendo Davi, o conselheiro traidor estaria morto de qualquer maneira — de modo que escolhe a hora, deixa os negócios em ordem e garante o próprio lugar no sepulcro da família. O jumento albardado à porta é a imagem da inteligência sem Deus indo tranquilamente para o fim: monta-se nela com tudo resolvido. O seu único paralelo na Escritura é outro conselheiro de mesa que traiu o seu Senhor e \"foi-se enforcar\" (Mt 27:5).",
  },
  "camas-de-barzilai": {
    title: "As camas de Maanaim",
    subtitle: "2Sm 17:27-29 — o socorro dos três homens de Gileade",
    text: "Chegando o rei exausto ao outro lado do Jordão, três homens do lugar aparecem sem terem sido chamados: Sobi, filho de Naás, de Rabá — da mesma cidade amonita que Davi tomara (12:29) —, Maquir de Lo-Debar, o mesmo que escondera Mefibosete (9:4), e \"Barzilai, o gileadita, de Rogelim\" (17:27). O que trazem está listado como quem despeja uma despensa inteira no chão: \"Tomaram camas e bacias, e vasilhas de barro, e trigo, e cevada, e farinha, e grão torrado, e favas, e lentilhas, também torradas\" (17:28), e ainda \"mel, e manteiga, e ovelhas, e queijos de vacas\" (17:29). As camas vêm primeiro na lista porque eram o que mais faltava: aquela gente dormia no chão havia dias. E a razão está dita sem retórica nenhuma: \"porque disseram: Este povo no deserto está faminto, cansado e sedento\" (17:29). É a cena mais gentil dos capítulos da fuga, e Davi não a esqueceu: no leito de morte, encomendou os filhos de Barzilai a Salomão, \"porque assim se chegaram eles a mim, quando eu fugia por causa de teu irmão Absalão\" (1Rs 2:7).",
  },
  "carros-de-adonias": {
    title: "Os carros e os cavaleiros de Adonias",
    subtitle: "1Rs 1:5 — a cavalaria de quem se coroou sozinho",
    text: "\"Então Adonias, filho de Hagite, se levantou, dizendo: Eu reinarei. E preparou carros, e cavaleiros, e cinqüenta homens, que corressem adiante dele\" (1Rs 1:5). É a cópia exata do irmão morto: Absalão \"fez aparelhar carros e cavalos, e cinqüenta homens que corressem adiante dele\" (2Sm 15:1) — e acabou pendurado num carvalho. O pai nunca o contrariara, \"dizendo: Por que fizeste assim?\" (1Rs 1:6); mas o reino não se toma com cavalaria, e sim se recebe da mão de Deus." },
  "fonte-de-giom": {
    title: "A fonte de Giom",
    subtitle: "1Rs 1:33-45 — onde Salomão foi ungido rei",
    text: "\"fazei subir a meu filho Salomão na mula que é minha; e levai-o a Giom\" (1Rs 1:33). A fonte no vale, abaixo da cidade, era a água que sustentava Jerusalém; ali Zadoque e Natã \"o ungiram rei em Giom, e dali subiram alegres\" (1Rs 1:45). Enquanto Adonias banqueteava em En-Rogel sem trombeta nenhuma, o verdadeiro rei era feito junto às águas, e \"com o seu clamor a terra retiniu\" (1Rs 1:40)." },
  "fonte-de-rogel": {
    title: "A fonte de Rogel",
    subtitle: "1Rs 1:9 — a água do banquete de Adonias",
    text: "\"E matou Adonias ovelhas, e vacas, e animais cevados, junto à pedra de Zoelete, que está perto da fonte de Rogel\" (1Rs 1:9). En-Rogel ficava fora dos muros, no fundo do vale — longe dos olhos do rei velho e longe da mesa de quem não foi convidado: \"Porém a Natã, o profeta, e a Benaia, e aos poderosos, e a Salomão, seu irmão, não convidou\" (1Rs 1:10). Foi junto a esta mesma fonte que os mensageiros de Davi se esconderam na fuga de Absalão, \"porque não podiam ser vistos entrar na cidade\" (2Sm 17:17): a água que já servira à lealdade agora serve à conspiração." },
  "mula-do-rei-davi": {
    title: "A mula do rei Davi",
    subtitle: "1Rs 1:33,44 — a montaria que declara o herdeiro",
    text: "\"fazei subir a meu filho Salomão na mula que é minha\" (1Rs 1:33) — e assim se fez: \"o fizeram montar na mula do rei\" (1Rs 1:44). Montar o animal do rei é vestir a autoridade do rei; por isso o gesto pesou mais do que toda a proclamação de Adonias. Enquanto o usurpador desfilava com carros e cavaleiros próprios, o escolhido de Davi desceu ao vale na mula emprestada do pai — e voltou dela rei." },
  "pedra-de-zoelete": {
    title: "A pedra de Zoelete",
    subtitle: "1Rs 1:9 — o marco do banquete da usurpação",
    text: "Foi \"junto à pedra de Zoelete, que está perto da fonte de Rogel\" (1Rs 1:9) que Adonias matou \"ovelhas, e vacas, e animais cevados\" e ajuntou à sua volta os filhos do rei e os homens de Judá. A grande pedra do vale serviu de mesa e de altar a uma coroação que Deus não mandara fazer. Bastou o som que subiu de Giom para tudo se desmanchar: \"Então estremeceram e se levantaram todos os convidados que estavam com Adonias; e cada um se foi ao seu caminho\" (1Rs 1:49)." },
  "pontas-do-altar": {
    title: "As pontas do altar",
    subtitle: "1Rs 1:50 • 2:28 — o último refúgio de quem teme o rei",
    text: "\"Porém Adonias temeu a Salomão; e levantou-se, e foi, e apegou-se às pontas do altar\" (1Rs 1:50); depois dele, Joabe fugiu para o tabernáculo do Senhor e \"apegou-se às pontas do altar\" (1Rs 2:28). As quatro pontas de cobre nos cantos do altar (Êx 27:2) eram o asilo de quem matara sem querer, mas a lei já dissera do assassino a sangue-frio: \"tirá-lo-ás do meu altar, para que morra\" (Êx 21:14). Por isso um foi poupado sob condição — \"Se for homem de bem, nem um de seus cabelos cairá em terra\" (1Rs 1:52) — e o outro morreu abraçado ao altar que não podia salvá-lo." },
  "trombeta-da-uncao-de-salomao": {
    title: "A trombeta da unção de Salomão",
    subtitle: "1Rs 1:34,39 — o som que desfez a festa de En-Rogel",
    text: "\"então tocareis a trombeta, e direis: Viva o rei Salomão!\" (1Rs 1:34). Depois que Zadoque tomou \"o chifre de azeite do tabernáculo\" e ungiu o moço, \"tocaram a trombeta, e todo o povo disse: Viva o rei Salomão!\" (1Rs 1:39). O sopro subiu o vale até a mesa dos conspiradores, e Joabe entendeu o que era antes de saber a notícia: \"Por que há tal ruído de cidade alvoroçada?\" (1Rs 1:41)." },
  "trono-de-salomao": {
    title: "O trono de Salomão",
    subtitle: "1Rs 1:46 • 2:12 — o assento prometido ao filho de Davi",
    text: "\"E também Salomão está assentado no trono do reino\" (1Rs 1:46); \"E Salomão se assentou no trono de Davi, seu pai, e o seu reino se fortificou sobremaneira\" (1Rs 2:12). O assento cumpre o juramento feito a Bate-Seba — \"Certamente teu filho Salomão reinará depois de mim, e ele se assentará no meu trono\" (1Rs 1:30) — e a palavra dada a Davi: \"confirmarei o trono do seu reino para sempre\" (2Sm 7:13). Dele saíram as quatro sentenças do capítulo 2, e por elas \"assim foi confirmado o reino na mão de Salomão\" (1Rs 2:46)." },
  "cadeira-da-rainha-mae": {
    title: "A cadeira da rainha-mãe",
    subtitle: "1Rs 2:19 — o assento posto à direita do rei",
    text: "\"o rei se levantou a encontrar-se com ela, e se inclinou diante dela; então se assentou no seu trono, e fez pôr uma cadeira para a sua mãe, e ela se assentou à sua direita\" (1Rs 2:19). O rei mais poderoso de Israel se põe de pé e se curva diante de Bate-Seba: a mãe do rei tem lugar de honra no salão, à mão direita do trono. Mas honra não é cheque em branco — quando o pedido trazido daquela cadeira serviu a Adonias, Salomão o negou na mesma hora: \"E por que pedes a Abisague, a sunamita, para Adonias?\" (1Rs 2:22)." },
  "casa-de-abiatar-em-anatote": {
    title: "A casa de Abiatar em Anatote",
    subtitle: "1Rs 2:26 — o desterro do sacerdote deposto",
    text: "\"Vai para Anatote, para os teus campos, porque és homem digno de morte; porém hoje não te matarei, porquanto levaste a arca do Senhor DEUS diante de Davi, meu pai\" (1Rs 2:26). A vida foi poupada por causa da arca carregada; o sacerdócio, não: Salomão o lançou fora \"para cumprir a palavra do Senhor, que tinha falado sobre a casa de Eli em Siló\" (1Rs 2:27), a sentença de 1Sm 2:31-35. Séculos depois, sairia destes mesmos campos outro homem com uma palavra dura na boca — Jeremias, \"um dos sacerdotes que estavam em Anatote, na terra de Benjamim\" (Jr 1:1)." },
  "casa-de-joabe-no-deserto": {
    title: "A casa de Joabe no deserto",
    subtitle: "1Rs 2:34 — a sepultura do capitão de Davi",
    text: "\"E subiu Benaia, filho de Joiada, e arremeteu contra ele, e o matou; e foi sepultado em sua casa, no deserto\" (1Rs 2:34). O homem que comandou o exército de Israel por quarenta anos não teve cortejo nem túmulo dentro da cidade: foi enterrado no seu próprio chão seco, longe de tudo. Assim se pagou o sangue de Abner e de Amasa, \"porque deu sobre dois homens mais justos e melhores do que ele\" (1Rs 2:32); e enquanto o sangue recaía sobre a descendência de Joabe, à casa de Davi o Senhor daria \"paz para todo o sempre\" (1Rs 2:33)." },
  "espada-de-abner-e-amasa": {
    title: "A espada que matou Abner e Amasa",
    subtitle: "1Rs 2:5 — o sangue de guerra derramado em paz",
    text: "\"e o que fez aos dois capitães do exército de Israel, a Abner filho de Ner, e a Amasa, filho de Jeter, os quais matou, e em paz derramou o sangue de guerra\" (1Rs 2:5). Davi entrega ao filho a conta que ele mesmo nunca cobrou: \"não permitas que suas cãs desçam à sepultura em paz\" (1Rs 2:6). Joabe matou dois homens \"mais justos e melhores do que ele\" com a saudação ainda na boca (2Sm 3:27; 20:9-10), e a lâmina que o denuncia é a mesma que Benaia lhe leva junto ao altar (1Rs 2:32-34)." },
  "jumento-de-simei": {
    title: "O jumento albardado de Simei",
    subtitle: "1Rs 2:40 — a montaria que custou a vida",
    text: "\"Então Simei se levantou, e albardou o seu jumento, e foi a Gate, ter com Aquis, em busca de seus servos\" (1Rs 2:40). Três anos de obediência dentro de Jerusalém foram desfeitos por dois escravos fugidos: bastou selar o animal e passar o ribeiro. O rei o avisara: \"no dia em que saíres e passares o ribeiro de Cedrom, de certo que sem dúvida morrerás; o teu sangue será sobre a tua cabeça\" (1Rs 2:37) — e a maldição atroz que ele lançara contra Davi em Baurim voltou sobre a sua própria cabeça (1Rs 2:44)." },
  "sepulcro-de-davi": {
    title: "O sepulcro de Davi",
    subtitle: "1Rs 2:10 — a sepultura na cidade de Davi",
    text: "\"E Davi dormiu com seus pais, e foi sepultado na cidade de Davi\" (1Rs 2:10), ao fim de quarenta anos de reinado: \"sete anos reinou em Hebrom, e em Jerusalém reinou trinta e três anos\" (1Rs 2:11). O pastor que virou rei é enterrado dentro da fortaleza que tomou dos jebuseus, e o trono passa ao filho sem uma só batalha. Mil anos depois, Pedro apontaria para esta mesma laje ao pregar a ressurreição: Davi \"morreu e foi sepultado, e entre nós está até hoje a sua sepultura\" (At 2:29) — o rei ficou no túmulo, mas a promessa do trono eterno não ficou." },
  "altar-do-alto-de-gibeao": {
    title: "O altar do alto de Gibeão",
    subtitle: "1Rs 3:4 — mil holocaustos antes de haver templo",
    text: "\"E foi o rei a Gibeom para lá sacrificar, porque aquele era o alto maior; mil holocaustos sacrificou Salomão naquele altar\" (1Rs 3:4). Enquanto não havia casa ao Nome, o tabernáculo estava ali, e \"o povo sacrificava sobre os altos; porque até àqueles dias ainda não se havia edificado casa ao nome do Senhor\" (1Rs 3:2). Foi sobre as brasas deste altar, dormindo no lugar alto, que Salomão ouviu a pergunta que decidiu o seu reinado: \"Pede o que queres que eu te dê\" (1Rs 3:5)." },
  "arca-da-alianca-em-jerusalem": {
    title: "A arca da aliança na tenda de Jerusalém",
    subtitle: "1Rs 3:15 — onde o rei foi adorar ao acordar do sonho",
    text: "\"E acordou Salomão, e eis que era sonho. E indo a Jerusalém, pôs-se perante a arca da aliança do Senhor, e sacrificou holocausto\" (1Rs 3:15). A arca estava na tenda que Davi lhe armara na cidade, enquanto o altar maior ficava em Gibeão — um culto ainda partido em dois, que o templo viria reunir. O rei que pedira \"um coração entendido para julgar a teu povo\" (1Rs 3:9) volta primeiro à arca, onde estavam \"as duas tábuas de pedra, que Moisés ali pusera junto a Horebe\" (1Rs 8:9): a sabedoria pedida se ajoelha diante da lei já dada." },
  "espada-do-juizo-de-salomao": {
    title: "A espada do juízo de Salomão",
    subtitle: "1Rs 3:24 — a lâmina que não cortou o menino",
    text: "\"Disse mais o rei: Trazei-me uma espada. E trouxeram uma espada diante do rei\" (1Rs 3:24). A ordem seguinte foi terrível — \"Dividi em duas partes o menino vivo; e dai metade a uma, e metade a outra\" (1Rs 3:25) —, mas era bisturi, e não sentença: só o amor de mãe grita \"dai-lhe o menino vivo, e de modo nenhum o mateis\" (1Rs 3:26). A espada nunca desceu, e foi por ela que todo o Israel viu \"que havia nele a sabedoria de Deus, para fazer justiça\" (1Rs 3:28)." },
  "leito-da-mae-falsa": {
    title: "O leito da mulher cujo filho morreu",
    subtitle: "1Rs 3:19-20 — a cama onde o menino foi sufocado",
    text: "\"E de noite morreu o filho desta mulher, porquanto se deitara sobre ele\" (1Rs 3:19). Deste lado do quarto começa o crime: ela levantou-se \"à meia-noite, e tirou o meu filho do meu lado, enquanto dormia a tua serva, e o deitou no seu seio; e a seu filho morto deitou no meu seio\" (1Rs 3:20). A troca foi feita no escuro e sem testemunha alguma — \"nenhum estranho estava conosco na casa; somente nós duas naquela casa\" (1Rs 3:18) —, e por isso no tribunal não havia prova a examinar, só um coração a ser lido." },
  "leito-da-mae-verdadeira": {
    title: "O leito da verdadeira mãe",
    subtitle: "1Rs 3:21 — a cama de onde o filho foi roubado",
    text: "\"E, levantando-me eu pela manhã, para dar de mamar a meu filho, eis que estava morto; mas, atentando pela manhã para ele, eis que não era meu filho, que eu havia tido\" (1Rs 3:21). Neste leito uma mulher acordou com um cadáver que não era o seu e sem nada que provasse a sua palavra. A prova veio quando a espada foi trazida: \"as suas entranhas se lhe enterneceram por seu filho\", e ela preferiu perdê-lo vivo a vê-lo dividido (1Rs 3:26). Então o rei sentenciou: \"Dai a esta o menino vivo, e de maneira nenhuma o mateis, porque esta é sua mãe\" (1Rs 3:27)." },
  "a-sua-figueira": {
    title: "A sua figueira",
    subtitle: "1Rs 4:25 — a sombra do quintal em tempo de paz",
    text: "\"E Judá e Israel habitavam seguros, cada um debaixo da sua videira, e debaixo da sua figueira, desde Dã até Berseba, todos os dias de Salomão\" (1Rs 4:25). A figueira leva anos para dar fruto: só a planta quem não espera guerra — é o retrato de um reino em que \"adversário não há, nem algum mau encontro\" (1Rs 5:4). Os profetas tomaram a imagem para descrever o reino que há de vir: \"assentar-se-á cada um debaixo da sua videira, e debaixo da sua figueira, e não haverá quem os espante\" (Mq 4:4); e foi \"debaixo da figueira\" que Jesus viu Natanael antes de Filipe o chamar (Jo 1:48)." },
  "a-sua-videira": {
    title: "A sua videira",
    subtitle: "1Rs 4:25 — a parreira à porta de casa, de Dã até Berseba",
    text: "\"cada um debaixo da sua videira, e debaixo da sua figueira, desde Dã até Berseba, todos os dias de Salomão\" (1Rs 4:25). A parreira só dá uva a quem fica: plantá-la é apostar que a vindima será sua, e não do invasor. Este é o único versículo do capítulo que mede o reinado não pelo ouro nem pela cavalaria, mas pelo homem comum sentado à sua própria sombra — e Zacarias o promete outra vez para o dia do Senhor: \"cada um de vós convidará o seu próximo para debaixo da videira e para debaixo da figueira\" (Zc 3:10)." },
  "cedro-do-libano": {
    title: "O cedro que está no Líbano",
    subtitle: "1Rs 4:33 — a maior das árvores na aula do rei",
    text: "\"Também falou das árvores, desde o cedro que está no Líbano até ao hissopo que nasce na parede; também falou dos animais e das aves, e dos répteis e dos peixes\" (1Rs 4:33). O cedro é o extremo alto da lista: a árvore mais nobre do Levante, a madeira que o próprio Salomão mandaria cortar para a casa do Senhor (1Rs 5:6). A sabedoria que Deus lhe deu não ficou presa ao tribunal — desceu à criação inteira, e \"vinham de todos os povos a ouvir a sabedoria de Salomão\" (1Rs 4:34)." },
  "estrebarias-de-salomao": {
    title: "As estrebarias de Salomão",
    subtitle: "1Rs 4:26 — quarenta mil manjedouras de cavalos",
    text: "\"Tinha também Salomão quarenta mil estrebarias de cavalos para os seus carros, e doze mil cavaleiros\" (1Rs 4:26), e todo dia chegavam \"a cevada e a palha para os cavalos e para os ginetes\" (1Rs 4:28). É a maior obra civil do reino depois do templo — e a primeira sombra sobre ele, porque a lei do rei dizia: \"ele não multiplicará para si cavalos, nem fará voltar o povo ao Egito para multiplicar cavalos\" (Dt 17:16). O mesmo capítulo que celebra a paz mostra, no verso seguinte, a cavalaria de que essa paz não precisava." },
  "ferrolhos-de-cobre-de-argobe": {
    title: "Os ferrolhos de cobre de Argobe",
    subtitle: "1Rs 4:13 — as trancas das sessenta cidades muradas de Basã",
    text: "O provedor de Ramote de Gileade tinha também \"o termo de Argobe, o qual está em Basã, sessenta grandes cidades, com muros e ferrolhos de cobre\" (1Rs 4:13). Eram as praças tomadas de Ogue no tempo de Moisés: \"todas estas cidades eram fortificadas com altos muros, portas e ferrolhos\" (Dt 3:5). As mesmas trancas que um dia barraram Israel agora se fecham por dentro, para um reino em paz — e a conquista do Jordão virou apenas mais uma linha no rol dos que mandavam farinha para a mesa do rei." },
  "hissopo-que-nasce-na-parede": {
    title: "O hissopo que nasce na parede",
    subtitle: "1Rs 4:33 — a menor das plantas na aula do rei",
    text: "\"desde o cedro que está no Líbano até ao hissopo que nasce na parede\" (1Rs 4:33): a sabedoria de Salomão ia do gigante da serra ao matinho que brota numa fresta de muro. O hissopo era planta pobre e santa — com um molho dele o sangue foi passado nas ombreiras na noite da Páscoa (Êx 12:22), e com ele se purificava o leproso (Lv 14:4). Davi, pai deste rei, já orara com ela na boca: \"Purifica-me com hissopo, e ficarei puro; lava-me, e ficarei mais branco do que a neve\" (Sl 51:7)." },
  "mil-e-cinco-canticos-de-salomao": {
    title: "Os mil e cinco cânticos de Salomão",
    subtitle: "1Rs 4:32 — o cancioneiro do rei sábio",
    text: "\"E disse três mil provérbios, e foram os seus cânticos mil e cinco\" (1Rs 4:32). Deste milheiro a Escritura guardou o Cântico dos Cânticos — \"cântico dos cânticos, que é de Salomão\" (Ct 1:1) — e os salmos que trazem o seu nome. O dom não era erudição fria: a mesma \"largueza de coração, como a areia que está na praia do mar\" (1Rs 4:29) que julgava causas no tribunal também compunha música." },
  "provisao-de-um-dia-de-salomao": {
    title: "A provisão de um dia da casa do rei",
    subtitle: "1Rs 4:22-23 — o que a mesa de Salomão consumia em um dia",
    text: "\"Era, pois, o provimento de Salomão cada dia, trinta coros de flor de farinha, e sessenta coros de farinha\" (1Rs 4:22), mais \"Dez bois cevados, e vinte bois de pasto, e cem carneiros; afora os veados e as cabras montesas, e os corços, e aves cevadas\" (1Rs 4:23). Doze provedores se revezavam para pôr isto no chão da cozinha, cada um no seu mês, e \"coisa nenhuma deixavam faltar\" (1Rs 4:27). A fartura é sinal de bênção — e também de peso: esta mesma mesa é a conta que Israel viria reclamar diante de Roboão, \"o pesado jugo que nos impôs\" (1Rs 12:4)." },
  "registros-do-reino-de-salomao": {
    title: "Os registros do reino de Salomão",
    subtitle: "1Rs 4:3 — os rolos dos secretários e do cronista",
    text: "Entre os príncipes do rei estavam \"Eliorefe e Aías, filhos de Sisa, secretários; Jeosafá, filho de Ailude, cronista\" (1Rs 4:3). O reino não se governava só do trono: havia escrivães que punham em rolo as ordens, as causas e os anos, e um cronista encarregado da memória. É desses arquivos que sai a fonte citada no fim da história — \"porventura não está escrito no livro dos feitos de Salomão?\" (1Rs 11:41) —, e por eles a Escritura pôde depois contar o que aqui foi apenas vivido." },
  "rol-dos-doze-provedores": {
    title: "O rol dos doze provedores",
    subtitle: "1Rs 4:7 — um oficial para cada mês do ano",
    text: "\"E tinha Salomão doze oficiais sobre todo o Israel, que proviam ao rei e à sua casa; e cada um tinha que abastecê-lo por um mês no ano\" (1Rs 4:7). O rol que vem a seguir corta o país por regiões, e não pelas doze tribos: é administração nova, desenhada por cima da herança das tribos. Funcionou — \"coisa nenhuma deixavam faltar\" (1Rs 4:27) —, mas o preço apareceria uma geração adiante, quando o povo viesse pedir alívio da \"dura servidão\" que este sistema pôs sobre ele (1Rs 12:4)." },
  "tres-mil-proverbios-de-salomao": {
    title: "Os três mil provérbios de Salomão",
    subtitle: "1Rs 4:32 — o rolo dos ditos do rei sábio",
    text: "\"E disse três mil provérbios\" (1Rs 4:32) — dos quais um livro inteiro da Escritura recolheu uma parte, e se abre justamente assim: \"Provérbios de Salomão, filho de Davi, rei de Israel\" (Pv 1:1). A sabedoria que ele pedira para julgar o povo transbordou do tribunal em sentenças curtas para o dia a dia de qualquer um. E era dom, não talento: \"E deu Deus a Salomão sabedoria, e muitíssimo entendimento, e largueza de coração\" (1Rs 4:29)." },
  "cedros-do-libano-para-o-templo": {
    title: "Os cedros do Líbano para o templo",
    subtitle: "1Rs 5:6 — a madeira encomendada a Hirão de Tiro",
    text: "\"Dá ordem, pois, agora, que do Líbano me cortem cedros, e os meus servos estarão com os teus servos\" (1Rs 5:6), \"porque bem sabes tu que entre nós ninguém há que saiba cortar a madeira como os sidônios\". Israel comprou de fora a perícia que não tinha, e o rei de Tiro se alegrou com o pedido: \"Bendito seja hoje o Senhor, que deu a Davi um filho sábio sobre este tão grande povo\" (1Rs 5:7). A casa do Senhor começa com um gentio bendizendo o Nome — sinal, desde a primeira tora, de que ela seria chamada \"casa de oração para todos os povos\" (Is 56:7)." },
  "jangadas-de-hirao": {
    title: "As jangadas de Hirão",
    subtitle: "1Rs 5:9 — a floresta que viajou deitada sobre o mar",
    text: "\"Os meus servos as levarão desde o Líbano até ao mar, e eu as farei conduzir em jangadas pelo mar até ao lugar que me designares, e ali as desamarrarei\" (1Rs 5:9). Amarrados uns aos outros, os troncos desciam a costa boiando, e o pagamento voltava em trigo e azeite, ano após ano (1Rs 5:11). Assim \"houve paz entre Hirão e Salomão, e ambos fizeram acordo\" (1Rs 5:12): a madeira do templo chegou por um tratado, e não por uma guerra." },
  "pedras-grandes-para-fundar-a-casa": {
    title: "As pedras grandes do fundamento",
    subtitle: "1Rs 5:17 — os blocos com que se fundou a casa",
    text: "\"E mandou o rei que trouxessem pedras grandes, e pedras valiosas, pedras lavradas, para fundarem a casa\" (1Rs 5:17). Oitenta mil homens \"talhavam pedras nas montanhas\" (1Rs 5:15), e os edificadores de Hirão e os giblitas as preparavam para que subissem prontas ao seu lugar. O que ficaria escondido debaixo do chão foi o que custou mais caro — como no alicerce da casa que Deus edifica hoje, onde tudo se apoia na \"pedra principal da esquina, eleita e preciosa\" (1Pe 2:6)." },
  "trigo-e-azeite-para-a-casa-de-hirao": {
    title: "O trigo e o azeite para a casa de Hirão",
    subtitle: "1Rs 5:11 — o pagamento anual que subia para Tiro",
    text: "\"E Salomão deu a Hirão vinte mil coros de trigo, para sustento da sua casa, e vinte coros de azeite batido; isto dava Salomão a Hirão anualmente\" (1Rs 5:11). Tiro tinha cedro e não tinha campo; Israel tinha campo e não tinha cedro — o acordo trocou floresta por pão. O trigo da terra da promessa passou a sustentar a casa de um rei estrangeiro, e a madeira dele a cobrir o teto da casa do Senhor." },
  "arca-da-alianca-no-oraculo": {
    title: "A arca da aliança no oráculo",
    subtitle: "1Rs 6:19 — o lugar para o qual o cômodo inteiro foi feito",
    text: "\"E por dentro da casa, na parte mais interior, preparou o oráculo, para pôr ali a arca da aliança do Senhor\" (1Rs 6:19). Todo o templo — sessenta côvados de casa, sete anos de obra, ouro puro nas paredes — existe por causa de uma caixa em que \"nada havia, senão só as duas tábuas de pedra, que Moisés ali pusera junto a Horebe\" (1Rs 8:9). O Santo dos Santos é de \"vinte côvados de comprimento, e de vinte côvados de largura, e de vinte côvados de altura\" (1Rs 6:20), um cubo perfeito; e o que o enche não é o ouro, mas a promessa: \"habitarei no meio dos filhos de Israel, e não desampararei o meu povo de Israel\" (1Rs 6:13)." },
  ...
  "pedras-preparadas-na-pedreira": {
    ...
    text: "\"E edificava-se a casa com pedras preparadas, como as traziam se edificava; de maneira que nem martelo, nem machado, nem nenhum outro instrumento de ferro se ouviu na casa quando a edificavam\" (1Rs 6:7). Cada bloco era cortado longe, na pedreira, e chegava pronto para o seu lugar exato na parede. O silêncio era reverência, e vinha de longe: do altar Deus já dissera \"não o farás de pedras lavradas; se sobre ele levantares o teu buril, profaná-lo-ás\" (Êx 20:25) — no chão santo não se ouve a violência da ferramenta." },
  "porta-do-templo-de-cipreste": {
    title: "As portas de cipreste do templo",
    subtitle: "1Rs 6:34 — as folhas dobradiças da entrada da nave",
    text: "\"E eram as duas portas de madeira de cipreste; e as duas folhas de uma porta eram dobradiças\" (1Rs 6:34), com ombreiras de oliveira \"da quarta parte da parede\" (1Rs 6:33). Também estas foram lavradas \"de querubins e de palmas, e de flores abertas\", e revestidas de ouro \"acomodado ao lavor\" (1Rs 6:35). É a porta por onde o sacerdote entra no santo: quem passa por ela caminha entre guardas de ouro e um jardim entalhado, andando para dentro, na direção do oráculo." },
  "portas-de-oliveira-do-oraculo": {
    title: "As portas de oliveira do oráculo",
    subtitle: "1Rs 6:31 — as folhas à entrada do Santo dos Santos",
    text: "\"E à entrada do oráculo fez portas de madeira de oliveira; o umbral de cima com as ombreiras faziam a quinta parte da parede\" (1Rs 6:31). Nelas Salomão lavrou \"entalhes de querubins, e de palmas, e de flores abertas, os quais revestiu de ouro\" (1Rs 6:32) — a mesma madeira de que eram feitos os dois querubins de dentro. São as portas mais fechadas de Israel: atrás delas entrava um só homem, uma vez por ano; e foi o véu deste lugar que \"se rasgou em dois, de alto a baixo\" na hora em que Cristo morreu (Mt 27:51)." },
  "querubins-de-madeira-de-oliveira": {
    title: "Os querubins de madeira de oliveira",
    subtitle: "1Rs 6:23 — os dois guardas de dez côvados no oráculo",
    text: "\"E no oráculo fez dois querubins de madeira de oliveira, cada um da altura de dez côvados\" (1Rs 6:23), depois revestidos de ouro. Postos no meio da casa de dentro, \"a asa de um tocava na parede, e a asa do outro querubim tocava na outra parede; e as suas asas no meio da casa tocavam uma na outra\" (1Rs 6:27) — vinte côvados de asa aberta sobre a arca. Desde o Éden o querubim guarda o que é santo (Gn 3:24), e sobre o propiciatório ele já estendia as asas em ouro batido (Êx 25:18-20); aqui a guarda cresce até encostar nas duas paredes." },
  "altar-de-ouro": {
    title: "O altar de ouro",
    subtitle: "1Rs 7:48 — o altar do incenso diante do oráculo",
    text: "\"Também fez Salomão todos os objetos que convinham à casa do Senhor; o altar de ouro, e a mesa de ouro, sobre a qual estavam os pães da proposição\" (1Rs 7:48). É o altar do incenso, que fica dentro do santo, diante do véu — não o do holocausto, que fica no pátio: aqui não se mata nada, aqui só se queima perfume. Moisés fizera o seu de madeira de acácia forrada de ouro, com \"as suas pontas\" e \"uma coroa de ouro ao redor\" (Êx 30:3); deste lugar sobe a oração do povo, e a casa toda foi construída em volta dele." },
  "casa-da-filha-de-farao": {
    title: "A casa da filha de Faraó",
    subtitle: "1Rs 7:8 — o palácio construído para a rainha egípcia",
    text: "\"também para a filha de Faraó, que Salomão tomara por mulher, fez uma casa semelhante àquele pórtico\" (1Rs 7:8). O casamento abrira o relato do reinado — \"E Salomão se aparentou com Faraó, rei do Egito; e tomou a filha de Faraó\" (1Rs 3:1) — e agora ganha paredes próprias dentro do complexo real. Prédio de aliança política e semente de ruína: o mesmo texto que a nomeia com honra aqui a põe à frente da lista que perderia o rei — \"o rei Salomão amou muitas mulheres estrangeiras, além da filha de Faraó\" (1Rs 11:1) —, contra a lei que dizia \"tampouco para si multiplicará mulheres, para que o seu coração não se desvie\" (Dt 17:17)." },
  "casa-de-salomao": {
    title: "A casa do rei Salomão",
    subtitle: "1Rs 7:1 — treze anos para o palácio",
    text: "\"Porém a sua casa edificou Salomão em treze anos; e acabou toda a sua casa\" (1Rs 7:1). O contraste é do próprio narrador, e a conjunção \"porém\" o denuncia: a casa do Senhor levara sete anos (1Rs 6:38), a do rei levou quase o dobro. O capítulo não acusa ninguém — apenas põe as duas obras lado a lado e deixa o leitor comparar os números, como fará depois com o ouro, os cavalos e as mulheres." },
  "casa-do-bosque-do-libano": {
    title: "A casa do bosque do Líbano",
    subtitle: "1Rs 7:2 — o salão de cem côvados sobre colunas de cedro",
    text: "\"Também edificou a casa do bosque do Líbano de cem côvados de comprimento, e de cinqüenta côvados de largura, e de trinta côvados de altura, sobre quatro ordens de colunas de cedro\" (1Rs 7:2). O nome vem das fileiras de troncos por dentro: quarenta e cinco colunas, quinze em cada ordem (1Rs 7:3), davam a quem entrava a impressão de andar por uma floresta coberta. Ali o rei guardaria depois a sua ostentação — os trezentos escudos de ouro batido, que \"o rei os pôs na casa do bosque do Líbano\" (1Rs 10:17), e os vasos em que não havia prata alguma (1Rs 10:21)." },
  "coluna-boaz": {
    title: "A coluna Boaz",
    subtitle: "1Rs 7:21 — a coluna esquerda do pórtico do templo",
    text: "\"e levantando a coluna esquerda, pôs-lhe o nome de Boaz\" (1Rs 7:21). Eram dezoito côvados de cobre fundido, com capitel de cinco côvados \"de obra de lírios\" (1Rs 7:19) e duzentas romãs em fileiras em redor. O nome quer dizer \"nele há força\": ao lado de Jaquim, prega em metal, à porta da casa, que o firmar e o fortalecer não vêm de quem entra, mas de Quem habita ali — promessa que reaparece no fim da Escritura: \"A quem vencer, eu o farei coluna no templo do meu Deus, e dele nunca sairá\" (Ap 3:12)." },
  "coluna-jaquim": {
    title: "A coluna Jaquim",
    subtitle: "1Rs 7:21 — a coluna direita do pórtico do templo",
    text: "\"Depois levantou as colunas no pórtico do templo; e levantando a coluna direita, pôs-lhe o nome de Jaquim\" (1Rs 7:21). Fundida por Hirão de Tiro, tinha dezoito côvados de altura, e \"um fio de doze côvados cercava cada uma das colunas\" (1Rs 7:15). O nome significa \"ele estabelecerá\": as duas colunas não sustentam teto nenhum — estão ali só para dizer, à entrada, que é Deus quem firma o que edificou, como jurara a Davi: \"confirmarei o trono do seu reino para sempre\" (2Sm 7:13)." },
  "fundicao-da-campina-do-jordao": {
    title: "A fundição da planície do Jordão",
    subtitle: "1Rs 7:46 — as formas abertas na terra barrenta",
    text: "\"Na planície do Jordão, o rei os fundiu em terra barrenta; entre Sucote e Zaretã\" (1Rs 7:46). Os grandes objetos de cobre não foram feitos em Jerusalém: desceram para o vale, onde o barro do rio dava molde e onde havia lenha e água para os fornos. Saiu tanto metal que \"deixou Salomão de pesar todos os objetos, pelo seu excessivo número; nem se averiguou o peso do cobre\" (1Rs 7:47) — o cobre que Davi ajuntara sem pesar, \"porque era em abundância\" (1Cr 22:14), voltou do fogo em forma de mar, de bases e de pias." },
  "mar-de-fundicao": {
    title: "O mar de fundição",
    subtitle: "1Rs 7:23 — a grande bacia de cobre sobre doze bois",
    text: "\"Fez mais o mar de fundição, de dez côvados de uma borda até à outra borda, perfeitamente redondo, e de cinco côvados de alto; e um cordão de trinta côvados o cingia em redor\" (1Rs 7:23). \"E firmava-se sobre doze bois\", três voltados para cada ponto do horizonte, e levava dois mil batos de água (1Rs 7:25-26). É a pia de cobre do tabernáculo (Êx 30:18) crescida até virar mar: nele \"os sacerdotes se lavassem\" (2Cr 4:6), porque ninguém serve na casa de Deus com as mãos como chegou da rua." },
  "navio-de-tiro": {
    title: "O navio de Tiro",
    subtitle: "1Rs 7:13-14 — de onde veio o mestre do cobre",
    text: "\"E enviou o rei Salomão um mensageiro e mandou trazer a Hirão de Tiro\" (1Rs 7:13). Não era o rei do mesmo nome, mas \"filho de uma mulher viúva, da tribo de Naftali\", cujo pai fora \"um homem de Tiro, que trabalhava em cobre\"; e chegou \"cheio de sabedoria, e de entendimento, e de ciência para fazer toda a obra de cobre\" (1Rs 7:14). Metade Israel, metade Tiro: as colunas, o mar e as bases da casa do Senhor saíram das mãos de um artífice trazido de fora — o mesmo dom que Deus dera a Bezalel para o tabernáculo, chamado agora de além-mar." },
  "obra-de-roda-de-carro": {
    title: "As rodas das bases de cobre",
    subtitle: "1Rs 7:33 — \"como a obra da roda de carro\"",
    text: "\"E era a obra das rodas como a obra da roda de carro; seus eixos, e suas cambas e seus cubos, e seus raios, todos eram fundidos\" (1Rs 7:33). Cada uma das dez bases tinha \"quatro rodas de metal, e lâminas de cobre\" (1Rs 7:30), de côvado e meio de altura: eram carrinhos de cobre para levar as pias de um lado ao outro do pátio. O serviço do santuário não é estátua parada — a água que lava o holocausto precisa chegar aonde o sangue está." },
  "pia-de-cobre": {
    title: "A pia de cobre sobre a base",
    subtitle: "1Rs 7:38 — uma das dez pias do pátio",
    text: "\"Também fez dez pias de cobre; em cada pia cabiam quarenta batos, e cada pia era de quatro côvados, e sobre cada uma das dez bases estava uma pia\" (1Rs 7:38). Cinco ficaram \"à direita da casa, e cinco à esquerda da casa\" (1Rs 7:39). Enquanto o mar servia aos sacerdotes, nestas se lavava \"o que pertencia ao holocausto\" (2Cr 4:6): a vítima subia limpa ao altar, porque nada entra no fogo de Deus sujo do caminho." },
  "portas-do-lugar-santissimo": {
    title: "As portas do lugar santíssimo",
    subtitle: "1Rs 7:50 — até as dobradiças eram de ouro",
    text: "Entre os últimos objetos da obra estavam \"as dobradiças para as portas da casa interior para o lugar santíssimo, e as das portas da casa do templo, também de ouro\" (1Rs 7:50). Nem o gonzo era coisa menor: tudo na casa toca no lugar onde Deus põe o seu nome, e por isso tudo é de ouro finíssimo. São estas as portas que separam o povo do oráculo — e o Evangelho anuncia que temos agora \"ousadia para entrar no santuário, pelo sangue de Jesus\" (Hb 10:19), \"pelo novo e vivo caminho\" aberto através do véu (Hb 10:20)." },
  "portico-das-colunas": {
    title: "O pórtico das colunas",
    subtitle: "1Rs 7:6 — o vão de cinqüenta côvados diante do palácio",
    text: "\"Depois fez um pórtico de colunas de cinqüenta côvados de comprimento e de trinta côvados de largura; e o pórtico estava defronte delas, e as colunas com as grossas vigas defronte delas\" (1Rs 7:6). É o átrio de passagem da casa real: quem tinha causa ou negócio com o rei esperava aqui, antes de ser levado ao pórtico do juízo. Palco largo e quase vazio de gente — a grandeza de Salomão se anunciava primeiro pelo espaço, e só depois pela palavra." },
  "querubins-das-bases": {
    title: "Os querubins entalhados nas bases",
    subtitle: "1Rs 7:29 — o lavor das dez bases de cobre",
    text: "Nas cintas das dez bases \"havia leões, bois, e querubins\" (1Rs 7:29), e nas placas dos esteios Hirão \"lavrou querubins, leões, e palmas, segundo o espaço de cada uma\" (1Rs 7:36). Os mesmos seres que guardam o oráculo lá dentro reaparecem aqui, em miniatura, num utensílio de pátio feito para lavar carne de sacrifício. Nada no serviço da casa é profano: do Santo dos Santos ao carrinho da água, tudo leva a marca do que cerca o trono de Deus." },
  "tesouros-consagrados-por-davi": {
    title: "Os tesouros consagrados por Davi",
    subtitle: "1Rs 7:51 — a prata e o ouro que o pai separou",
    text: "\"então trouxe Salomão as coisas que seu pai Davi havia consagrado; a prata, e o ouro, e os objetos pôs entre os tesouros da casa do Senhor\" (1Rs 7:51). É o último versículo da obra e o único que traz o nome de um morto: Davi, que \"não pôde edificar uma casa ao nome do Senhor seu Deus, por causa da guerra\" (1Rs 5:3), passara a vida ajuntando o material — \"na minha aflição preparei para a casa do Senhor cem mil talentos de ouro\" (1Cr 22:14). O filho acabou o que o pai não recebeu licença para começar: a casa é de Salomão nas paredes e de Davi no coração." },
  "trono-do-juizo": {
    title: "O trono do pórtico do juízo",
    subtitle: "1Rs 7:7 — o assento onde o rei julgava",
    text: "\"Também fez o pórtico para o trono onde julgava, isto é, o pórtico do juízo, que estava revestido de cedro de soalho a soalho\" (1Rs 7:7). No meio de treze anos de obra particular, o rei manda erguer um cômodo público, para o ofício que ele mesmo pedira a Deus: \"dá um coração entendido para julgar a teu povo, para que prudentemente discirna entre o bem e o mal\" (1Rs 3:9). Foi por um assento assim que se orou: \"Ó Deus, dá ao rei os teus juízos, e a tua justiça ao filho do rei\" (Sl 72:1) — e é \"com juízo e com justiça\" que se firma o trono que não acaba (Is 9:7)." },
  "altar-de-cobre": {
    title: "O altar de cobre do átrio",
    subtitle: "1Rs 8:64 — o altar que ficou pequeno demais",
    text: "É o altar do holocausto que ficava diante da entrada da casa, e no dia da dedicação ele não deu conta: \"o altar de cobre que estava diante da face do Senhor era muito pequeno para nele caberem os holocaustos e as ofertas\" (1Rs 8:64). Por isso o rei teve de santificar o meio do átrio para receber o que sobrava. Vinte e duas mil vacas e cento e vinte mil ovelhas (1Rs 8:63): a medida do bronze foi vencida pela medida da alegria." },
  "casa-do-senhor": {
  ...
  "coroa-de-salomao": {
    ...
    text: "No discurso da dedicação, Salomão junta as duas coisas que Deus cumpriu no mesmo dia: \"me levantei em lugar de Davi, meu pai, e me assentei no trono de Israel, como tem falado o Senhor; e edifiquei uma casa ao nome do Senhor\" (1Rs 8:20). A coroa não veio de conquista, e sim de promessa — a mesma que ele pede que continue: \"Não te faltará sucessor diante de mim, que se assente no trono de Israel\" (1Rs 8:25). A condição vem grudada no versículo: somente que os filhos guardem o caminho e andem diante do Senhor." },
  "forno-de-ferro-do-egito": {
    title: "O forno de ferro do Egito",
    subtitle: "1Rs 8:51 — a servidão de onde o povo foi tirado",
    text: "No fim da oração, pedindo perdão para um Israel que um dia estaria cativo em terra inimiga, Salomão apela ao começo de tudo: \"Porque são o teu povo e a tua herança que tiraste da terra do Egito, do meio do forno de ferro\" (1Rs 8:51). A figura é a fornalha do fundidor e vem de Moisés (Dt 4:20): o Egito foi o forno onde Israel se fez povo, e a saída de lá é o único argumento que o rei apresenta. Quem já tirou uma nação do forno pode trazê-la de volta do exílio." },
  "meio-do-atrio-santificado": {
    title: "O meio do átrio santificado",
    subtitle: "1Rs 8:64 — o pátio que virou altar por um dia",
    text: "\"No mesmo dia santificou o rei o meio do átrio que estava diante da casa do Senhor; porquanto ali preparara os holocaustos e as ofertas com a gordura dos sacrifícios pacíficos\" (1Rs 8:64). O altar de bronze não comportava a oferta, e o chão do pátio foi separado às pressas para o serviço. É um lugar santo improvisado — não por descuido, mas por excesso: a casa foi consagrada com mais culto do que a sua própria estrutura podia conter." },
  "nuvem-da-gloria": {
    title: "A nuvem que encheu a casa",
    subtitle: "1Rs 8:10-11 — a glória que interrompeu o serviço",
    text: "\"E sucedeu que, saindo os sacerdotes do santuário, uma nuvem encheu a casa do Senhor\" (1Rs 8:10). Não era fumaça de incenso: \"os sacerdotes não podiam permanecer em pé para ministrar, por causa da nuvem, porque a glória do Senhor enchera a casa do Senhor\" (1Rs 8:11) — a mesma nuvem que descera sobre o tabernáculo no deserto (Êx 40:34-35). Diante dela Salomão diz só uma frase: \"O Senhor disse que ele habitaria nas trevas\" (1Rs 8:12). Quando Deus se muda para dentro, o ministério humano para." },
  "querubins-do-oraculo": {
    title: "Os querubins do oráculo",
    subtitle: "1Rs 8:6-7 — as asas estendidas sobre a arca",
    text: "Os dois querubins de madeira de oliveira ocupavam de parede a parede o fundo da casa, e foi debaixo deles que a arca desceu ao seu lugar: \"ao oráculo da casa, ao lugar santíssimo, até debaixo das asas dos querubins\" (1Rs 8:6). \"Porque os querubins estendiam ambas as asas sobre o lugar da arca; e os querubins cobriam, por cima, a arca e os seus varais\" (1Rs 8:7). Desde o Éden os querubins guardam o que é santo (Gn 3:24); aqui guardam o trono do Deus que \"habitaria nas trevas\" (1Rs 8:12), e não há imagem alguma assentada entre eles." },
  "rio-do-egito": {
    title: "O rio do Egito",
    subtitle: "1Rs 8:65 — o limite sul da grande congregação",
    text: "A festa de catorze dias juntou uma grande congregação \"desde a entrada de Hamate até ao rio do Egito\" (1Rs 8:65) — do extremo norte ao extremo sul da terra prometida a Abraão (Gn 15:18). Esse ribeiro que corre no deserto a caminho do Egito era a fronteira marcada por Deus para Israel (Nm 34:5), e naquele dia ela estava toda dentro do pátio de uma festa só. É o ponto mais alto da história do reino: a promessa medida de ponta a ponta e cheia de gente." },
  "tabuas-da-alianca": {
    title: "As duas tábuas de pedra",
    subtitle: "1Rs 8:9 — o que havia dentro da arca",
    text: "Aberto o inventário do lugar santíssimo, a notícia é o que NÃO está lá: \"Na arca nada havia, senão só as duas tábuas de pedra, que Moisés ali pusera junto a Horebe, quando o Senhor fez a aliança com os filhos de Israel, saindo eles da terra do Egito\" (1Rs 8:9). Sem imagem, sem ídolo, sem tesouro — só a palavra escrita no monte. O coração do templo mais rico do mundo era um par de pedras com dez mandamentos." },
  "altar-da-casa-do-senhor": {
    title: "O altar do átrio, três vezes por ano",
    subtitle: "1Rs 9:25 — o culto ordinário depois da dedicação",
    text: "Passada a festa, fica a rotina: \"E oferecia Salomão três vezes cada ano holocaustos e sacrifícios pacíficos sobre o altar que edificaram ao Senhor, e queimava incenso sobre o que estava perante o Senhor; e assim acabou a casa\" (1Rs 9:25). As três vezes são as três festas anuais que a lei manda guardar (Êx 23:14-17). O versículo fecha a obra não com pedra nem com ouro, mas com adoração — a casa só está pronta quando está em uso." },
  "naus-de-eziom-geber": {
    title: "As naus de Eziom-Geber",
    subtitle: "1Rs 9:26-28 — o estaleiro do rei no mar de Sufe",
    text: "\"Também o rei Salomão fez naus em Eziom-Geber, que está junto a Elate, à praia do mar de Sufe, na terra de Edom\" (1Rs 9:26). Israel nunca foi povo de mar, e o rei teve de tomar emprestados os marinheiros de Hirão, \"que sabiam do mar\" (1Rs 9:27); as naus foram a Ofir e voltaram com quatrocentos e vinte talentos de ouro (1Rs 9:28). O porto na ponta de Edom mostra até onde o reino chegou — e por onde o ouro começou a entrar." },
  "naus-de-tarsis": {
    title: "As naus de Társis",
    subtitle: "1Rs 10:22 — a frota que voltava de três em três anos",
    text: "\"Porque o rei tinha no mar as naus de Társis, com as naus de Hirão; uma vez em três anos tornavam as naus de Társis, e traziam ouro e prata, marfim, e bugios, e pavões\" (1Rs 10:22). São navios de longo curso, e a carga é de luxo, não de mantimento: o sinal visível de um rei que excedeu \"a todos os reis da terra, tanto em riquezas como em sabedoria\" (1Rs 10:23). Gerações depois, Josafá tentaria refazer essa frota e ela se quebraria no mesmo porto (1Rs 22:48)." },
  "trono-de-marfim-de-salomao": {
    title: "O grande trono de marfim",
    subtitle: "1Rs 10:18-20 — o assento dos seis degraus e dos doze leões",
    text: "\"Fez mais o rei um grande trono de marfim, e o revestiu de ouro puríssimo\" (1Rs 10:18): seis degraus, o alto redondo por detrás, encostos dos dois lados com dois leões em pé, e doze leões sobre os degraus (1Rs 10:19-20). O texto arremata: \"nunca se tinha feito obra semelhante em nenhum dos reinos\" (1Rs 10:20). Mas quem explica para que serve o assento é a rainha de Sabá: o Senhor \"teve agrado em ti, para te pôr no trono de Israel... para fazeres juízo e justiça\" (1Rs 10:9)." },
  "altar-de-astarote": {
    title: "O altar de Astarote",
    subtitle: "1Rs 11:5 — a deusa dos sidônios dentro de Israel",
    text: "\"Porque Salomão seguiu a Astarote, deusa dos sidônios, e Milcom, a abominação dos amonitas\" (1Rs 11:5). O culto entrou pela porta de casa, com as mulheres estrangeiras que \"lhe perverteram o coração\" (1Rs 11:3), exatamente como o Senhor avisara: \"perverterão o vosso coração para seguirdes os seus deuses\" (1Rs 11:2). Aías repetirá o nome desta deusa como a causa do reino rasgado: \"me deixaram, e se encurvaram a Astarote, deusa dos sidônios\" (1Rs 11:33)." },
  "alto-de-moloque": {
    title: "O alto de Moloque",
    subtitle: "1Rs 11:7 — a abominação dos filhos de Amom",
    text: "No mesmo monte diante de Jerusalém, ao lado do alto de Quemós, Salomão levantou um alto \"a Moloque, a abominação dos filhos de Amom\" (1Rs 11:7). A lei chamava esse culto pelo nome e o punia com apedrejamento, porque a Moloque se davam os próprios filhos (Lv 20:2-5). O alto ficaria de pé por três séculos, olhando para o templo, até Josias o contaminar e derrubar (2Rs 23:13)." },
  "alto-de-quemos": {
    title: "O alto de Quemós",
    subtitle: "1Rs 11:7 — o altar moabita diante da cidade santa",
    text: "\"Então edificou Salomão um alto a Quemós, a abominação dos moabitas, sobre o monte que está diante de Jerusalém\" (1Rs 11:7). O endereço é a pior parte da notícia: não num canto de deserto, mas de frente para a casa que ele mesmo edificara ao nome do Senhor. Foi por isto que \"o Senhor se indignou contra Salomão; porquanto desviara o seu coração do Senhor Deus de Israel, o qual duas vezes lhe aparecera\" (1Rs 11:9)." },
  "coroa-do-reino-unido": {
    title: "A coroa do reino unido",
    subtitle: "1Rs 11:42 — os quarenta anos sobre todo o Israel",
    text: "\"E o tempo que reinou Salomão, em Jerusalém, sobre todo o Israel foi quarenta anos\" (1Rs 11:42). É a última contagem de um reino inteiro, porque a sentença já fora dada: \"certamente rasgarei de ti este reino, e o darei a teu servo\" (1Rs 11:11), adiada por amor de Davi para os dias do filho (1Rs 11:12). Salomão adormece com seus pais, e a coroa que desce a Roboão já não é a mesma coroa (1Rs 11:43)." },
  "incenso-das-mulheres-estrangeiras": {
    title: "O incenso das mulheres estrangeiras",
    subtitle: "1Rs 11:8 — o culto que passou a andar sozinho",
    text: "\"E assim fez para com todas as suas mulheres estrangeiras, as quais queimavam incenso e sacrificavam a seus deuses\" (1Rs 11:8). Setecentas princesas e trezentas concubinas (1Rs 11:3), e para cada nação o seu altar aceso: o rei que edificou a única casa do Nome acabou sustentando o incenso de todas as outras. O primeiro mandamento não se perde num dia — perde-se num arranjo de família." },
  "leito-da-velhice-de-salomao": {
    title: "O leito da velhice de Salomão",
    subtitle: "1Rs 11:4 — \"o seu coração não era perfeito\"",
    text: "\"Porque sucedeu que, no tempo da velhice de Salomão, suas mulheres lhe perverteram o coração para seguir outros deuses; e o seu coração não era perfeito para com o Senhor seu Deus, como o coração de Davi, seu pai\" (1Rs 11:4). O moço que pedira \"um coração entendido para julgar a teu povo\" (1Rs 3:9) termina com um coração dividido — e é o coração, não o templo nem o ouro, que a Escritura pesa. A queda não foi um ato: foi uma velhice inteira." },
  "livro-dos-feitos-de-salomao": {
    title: "O livro dos feitos de Salomão",
    subtitle: "1Rs 11:41 — o arquivo de quarenta anos de reinado",
    text: "\"Quanto ao mais dos atos de Salomão, e a tudo quanto fez, e à sua sabedoria, porventura não está escrito no livro dos feitos de Salomão?\" (1Rs 11:41). O historiador sagrado remete o leitor curioso a outro rolo, hoje perdido, e guarda para si somente o que interessa à aliança. Obras, frotas, provérbios e cânticos cabem numa remissão de uma linha; o que o texto conta por extenso é o coração que se desviou." },
  "milo": {
    title: "Milo, o aterro da cidade de Davi",
    subtitle: "1Rs 11:27 — a obra que pôs Jeroboão em evidência",
    text: "Milo era o aterro que sustentava a cidade de Davi, refeito com o tributo que Salomão impôs para edificar \"a casa do Senhor e a sua casa, e Milo, e o muro de Jerusalém\" (1Rs 9:15). Foi ali que a história virou: \"Salomão tinha edificado a Milo, e cerrou as aberturas da cidade de Davi, seu pai\" (1Rs 11:27), e nessa obra o rei viu que o jovem de Zereda era laborioso e lhe pôs sobre todo o cargo da casa de José (1Rs 11:28). O mesmo tributo que levantou Milo seria a queixa que rasgaria o reino em Siquém (1Rs 12:4)." },
  "trono-de-farao": {
    title: "O trono de Faraó, no Egito",
    subtitle: "1Rs 11:18-20 — a corte que criou o adversário de Israel",
    text: "Fugido ainda menino da matança de Joabe em Edom, Hadade achou abrigo no Egito: Faraó \"lhe deu uma casa, e lhe prometeu sustento, e lhe deu uma terra\" (1Rs 11:18) e depois a irmã da rainha Tafnes por mulher (1Rs 11:19). O filho deles, Genubate, \"estava na casa de Faraó, entre os filhos de Faraó\" (1Rs 11:20). O mesmo trono acolheria Jeroboão pouco depois (1Rs 11:40): o Egito guarda os adversários que o Senhor levanta contra Salomão." },
  "altar-de-betel": {
    title: "O altar de Jeroboão em Betel",
    subtitle: "1Rs 12:33 • 13:2-5 — o altar imaginado no coração do rei",
    text: "\"E sacrificou no altar que fizera em Betel, no dia décimo quinto do oitavo mês, que ele tinha imaginado no seu coração\" (1Rs 12:33) — festa inventada, mês trocado, sacerdotes que não eram dos filhos de Levi (1Rs 12:31). Contra esta pedra, e não contra o rei, o homem de Deus clamou: \"Altar, altar! Assim diz o Senhor\" (1Rs 13:2), anunciando Josias pelo nome três séculos antes de ele nascer. No mesmo dia ela se rachou: \"E o altar se fendeu, e a cinza se derramou do altar\" (1Rs 13:5)." },
  "bezerro-de-betel": {
    title: "O bezerro de ouro de Betel",
    subtitle: "1Rs 12:29 — o ídolo posto na casa de Deus de Jacó",
    text: "Dos dois bezerros que Jeroboão fundiu, \"pôs um em Betel, e colocou o outro em Dã\" (1Rs 12:29). Betel era o lugar do sonho da escada, onde Jacó acordara dizendo \"a casa de Deus\" e levantara a pedra por coluna (Gn 28:17-19); agora a casa de Deus tem um bezerro dentro. O culto ficou perto e ficou fácil — e é exatamente por isso que \"este feito se tornou em pecado\" (1Rs 12:30)." },
  "bezerro-de-da": {
    title: "O bezerro de ouro de Dã",
    subtitle: "1Rs 12:30 — o ídolo do extremo norte",
    text: "O segundo bezerro foi colocado em Dã (1Rs 12:29), na ponta norte da terra, e o texto mede o estrago pela estrada que o povo passou a andar: \"pois que o povo ia até Dã para adorar o bezerro\" (1Rs 12:30). Dã já tinha história antiga de imagem e de sacerdócio comprado, desde os dias dos juízes (Jz 18:30-31). De Betel a Dã, Israel ficou com dois santuários de estado e nenhum altar legítimo." },
  "bezerros-de-ouro-de-jeroboao": {
    title: "Os dois bezerros de ouro",
    subtitle: "1Rs 12:28 — \"vês aqui teus deuses, ó Israel\"",
    text: "\"Assim o rei tomou conselho, e fez dois bezerros de ouro; e lhes disse: Muito trabalho vos será o subir a Jerusalém; vês aqui teus deuses, ó Israel, que te fizeram subir da terra do Egito\" (1Rs 12:28). A frase é decalcada do bezerro de Arão no Sinai (Êx 32:4) — o mesmo pecado, agora como política de Estado, nascido do medo de perder o povo para Roboão (1Rs 12:26-27). Foi esta fundição que virou \"os pecados de Jeroboão\", o epitáfio que o livro dos Reis repetirá sobre reinado após reinado (1Rs 14:16)." },
  "carro-de-roboao": {
    title: "O carro da fuga de Roboão",
    subtitle: "1Rs 12:18 — a saída de Siquém debaixo de pedras",
    text: "Depois de responder duramente ao povo, o rei ainda mandou a Siquém o homem que estava sobre os tributos: \"e todo o Israel o apedrejou, e ele morreu; mas o rei Roboão se animou a subir ao carro para fugir para Jerusalém\" (1Rs 12:18). Adorão morreu no lugar do rei, e o carro que devia ser pompa virou salvação de última hora. Dali em diante, \"assim se rebelaram os israelitas contra a casa de Davi, até ao dia de hoje\" (1Rs 12:19)." },
  "casa-de-jeroboao-em-siquem": {
    title: "A casa de Jeroboão em Siquém",
    subtitle: "1Rs 12:25 — a primeira capital do reino do norte",
    text: "\"E Jeroboão edificou a Siquém, no monte de Efraim, e habitou ali; e saiu dali, e edificou a Penuel\" (1Rs 12:25). A praça onde o reino se partiu virou o palácio de quem ficou com as dez tribos. Siquém tinha memória longa — o primeiro altar de Abraão em Canaã (Gn 12:6-7) e a renovação da aliança de Josué (Js 24:1) — e agora recebe um rei a quem Deus prometera casa firme, mas sob condição: \"se ouvires tudo o que eu te mandar, e andares pelos meus caminhos\" (1Rs 11:38)." },
  "coroa-de-roboao": {
    title: "A coroa de Roboão",
    subtitle: "1Rs 12:1 — a coroação que nunca se completou",
    text: "\"E foi Roboão para Siquém; porque todo o Israel se reuniu em Siquém, para o fazerem rei\" (1Rs 12:1). A nação inteira veio coroá-lo, com uma condição na mão: \"alivia tu a dura servidão de teu pai... e nós te serviremos\" (1Rs 12:4). Ele deixou o conselho dos anciãos, tomou o dos jovens e prometeu escorpiões (1Rs 12:14); saiu de Siquém rei de uma tribo só, porque \"esta revolta vinha do Senhor\" (1Rs 12:15)." },
  "torre-de-penuel": {
    title: "A torre de Penuel",
    subtitle: "1Rs 12:25 — a praça-forte além do Jordão",
    text: "Depois de Siquém, Jeroboão \"saiu dali, e edificou a Penuel\" (1Rs 12:25), fortificando o vau do Jaboque para guardar o oriente do reino novo. É o lugar onde Jacó lutou até o romper do dia e deu nome ao sítio, \"porque dizia: Tenho visto a Deus face a face, e a minha alma foi salva\" (Gn 32:30). O rei que fortifica Peniel é o mesmo que, com medo de perder o povo para Jerusalém, funde dois bezerros (1Rs 12:26-28): pedra forte por fora, coração sem Deus por dentro." },
  "bezerro-de-ouro-de-betel": {
    title: "O bezerro do alto de Betel",
    subtitle: "1Rs 12:32 • 13:1-5 — o ídolo de pé ao lado do altar fendido",
    text: "É o bezerro entronizado no santuário de estado, ao lado do altar: na festa do oitavo mês Jeroboão fez em Betel \"como a festa que se fazia em Judá\", \"sacrificando aos bezerros que fizera\" (1Rs 12:32). Quando o homem de Deus veio de Judá, foi contra o altar que ele clamou, anunciando que Josias queimaria ali os ossos dos sacerdotes dos altos (1Rs 13:2) — e o bezerro ficou de pé, mudo, vendo a pedra rachar (1Rs 13:5). Josias cumpriria a palavra à risca, queimando o alto de Betel e desfazendo-o em pó (2Rs 23:15)." },
  "carvalho-do-homem-de-deus": {
    title: "O carvalho do caminho de Betel",
    subtitle: "1Rs 13:14 — a sombra onde o profeta velho o alcançou",
    text: "O homem de Deus tinha ordem de não comer pão, não beber água e não voltar pelo caminho por onde viera (1Rs 13:9); parou à sombra, e ali o acharam: \"achou-o assentado debaixo de um carvalho, e disse-lhe: És tu o homem de Deus que vieste de Judá? E ele disse: Sou\" (1Rs 13:14). A árvore marca o ponto exato em que a obediência que resistira ao rei cedeu a um colega de ofício. O convite veio embrulhado numa mentira piedosa: \"Também eu sou profeta como tu\" (1Rs 13:18)." },
  "cinza-derramada-de-betel": {
    title: "A cinza derramada do altar",
    subtitle: "1Rs 13:3,5 — o sinal cumprido no mesmo dia",
    text: "O sinal foi anunciado antes de acontecer: \"Eis que o altar se fenderá, e a cinza, que nele está, se derramará\" (1Rs 13:3). E aconteceu à vista do rei, cuja mão estendida contra o profeta acabara de secar: \"E o altar se fendeu, e a cinza se derramou do altar, segundo o sinal que o homem de Deus apontara por ordem do Senhor\" (1Rs 13:5). A cinza no chão é o resto das ofertas de um culto que Deus não recebeu — o santuário de Jeroboão condenado pela sua própria sujeira." },
  "jumento-do-profeta-velho": {
    title: "O jumento do profeta velho",
    subtitle: "1Rs 13:13 — a montaria das duas viagens do capítulo",
    text: "\"Albardai-me um jumento. E albardaram-lhe o jumento no qual ele montou\" (1Rs 13:13): nele o velho de Betel foi buscar o hóspede que fez voltar, e nele o hóspede seguiu de novo o caminho (1Rs 13:23). Depois do leão, o mesmo animal ficou parado ao lado do cadáver, sem fugir e sem ser tocado — \"o leão não tinha devorado o corpo, nem tinha despedaçado o jumento\" (1Rs 13:28). A fera e o jumento quietos na estrada dizem que aquilo não foi acidente: foi juízo." },
  "mesa-do-profeta-velho": {
    title: "A mesa do profeta velho",
    subtitle: "1Rs 13:19-20 — o pão que não devia ter sido comido",
    text: "\"Assim voltou com ele, e comeu pão em sua casa e bebeu água\" (1Rs 13:19). E foi à mesa, no meio da refeição proibida, que a palavra chegou — pela boca do próprio homem que mentira: \"E sucedeu que, estando eles à mesa, a palavra do Senhor veio ao profeta que o tinha feito voltar\" (1Rs 13:20). A sentença foi curta: \"o teu cadáver não entrará no sepulcro de teus pais\" (1Rs 13:22). Nenhum anjo alegado revoga uma ordem que Deus já deu (Gl 1:8)." },
  "sepulcro-do-homem-de-deus": {
    title: "O sepulcro do homem de Deus, em Betel",
    subtitle: "1Rs 13:30-31 — a cova que o velho cedeu ao estranho",
    text: "\"E colocou o cadáver no seu próprio sepulcro; e prantearam-no, dizendo: Ah, irmão meu!\" (1Rs 13:30). O mesmo velho que o enganara pediu depois aos filhos: \"sepultai-me no sepulcro em que o homem de Deus está sepultado; ponde os meus ossos junto aos ossos dele\" (1Rs 13:31), porque cria que a palavra clamada contra o altar certamente se cumpriria (1Rs 13:32). E cumpriu-se: Josias queimou os ossos de todos os sepulcros daquele monte e mandou poupar apenas este (2Rs 23:17-18)." },
  "botija-de-mel": {
    title: "A botija de mel",
    subtitle: "1Rs 14:3 — o presente levado ao profeta de Siló",
    text: "\"E leva contigo dez pães, e bolos, e uma botija de mel, e vai a ele; ele te declarará o que há de suceder a este menino\" (1Rs 14:3). É o presente comum que se levava a um vidente (1Sm 9:7-8), escolhido para combinar com o disfarce de mulher qualquer. Mas de Deus não se compra resposta com mel: o profeta cego reconheceu a rainha pelo ruído dos pés e a recebeu assim — \"eu sou enviado a ti com duras novas\" (1Rs 14:6)." },
  "coroa-da-mulher-de-jeroboao": {
    title: "A coroa da mulher de Jeroboão",
    subtitle: "1Rs 14:2 — a realeza deixada para trás no disfarce",
    text: "\"Levanta-te agora, e disfarça-te, para que não conheçam que és mulher de Jeroboão\" (1Rs 14:2). O rei que fundira bezerros para não perder o povo agora esconde a própria rainha para poder consultar o profeta que o fizera rei. O disfarce não durou o tempo de atravessar a porta: \"Entra, mulher de Jeroboão; por que te disfarças assim?\" (1Rs 14:6). Diante de Deus ninguém chega incógnito." },
  "cronicas-dos-reis-de-israel": {
    title: "O livro das crônicas dos reis de Israel",
    subtitle: "1Rs 14:19 — o arquivo do reino do norte",
    text: "\"Quanto ao mais dos atos de Jeroboão, como guerreou, e como reinou, eis que está escrito no livro das crônicas dos reis de Israel\" (1Rs 14:19). É a primeira das dezenas de vezes em que Reis remete a esse arquivo, hoje perdido. Vinte e dois anos de guerra e de governo cabem numa remissão; o que a Escritura guarda de Jeroboão é outra coisa — que ele \"pecou, e fez pecar a Israel\" (1Rs 14:16)." },
  "cronicas-dos-reis-de-juda": {
    title: "O livro das crônicas dos reis de Judá",
    subtitle: "1Rs 14:29 — o arquivo do reino do sul",
    text: "\"Quanto ao mais dos atos de Roboão, e a tudo quanto fez, porventura não está escrito no livro das crônicas dos reis de Judá?\" (1Rs 14:29). Dois reinos, dois arquivos, e entre eles uma só notícia comum: \"houve guerra entre Roboão e Jeroboão todos os seus dias\" (1Rs 14:30). O historiador sagrado não escreve os anais dos reis — escreve o juízo de Deus sobre eles." },
  "dez-paes-e-bolos": {
    title: "Os dez pães e os bolos",
    subtitle: "1Rs 14:3 — a oferta da consulta disfarçada",
    text: "\"E leva contigo dez pães, e bolos, e uma botija de mel, e vai a ele\" (1Rs 14:3). Pão de gente simples, escolhido a dedo para combinar com o disfarce: nada de rainha, nada de Tirza. O presente chegou, a resposta veio, e não foi a que se esperava — \"entrando os teus pés na cidade, o menino morrerá\" (1Rs 14:12). Deus não atende ao personagem, mas à pessoa." },
  "escudos-de-cobre-de-roboao": {
    title: "Os escudos de cobre de Roboão",
    subtitle: "1Rs 14:27 — o bronze que substituiu o ouro levado",
    text: "Saqueado o templo por Sisaque, \"em lugar deles fez o rei Roboão escudos de cobre, e os entregou nas mãos dos chefes da guarda que guardavam a porta da casa do rei\" (1Rs 14:27). A cerimônia continuou igualzinha: cada vez que o rei entrava na casa do Senhor, a guarda os levava e depois os tornava à câmara (1Rs 14:28). É o retrato do reino depois da glória — o mesmo ritual em metal barato: a aparência preservada, a substância perdida." },
  "escudos-de-ouro-de-salomao": {
    title: "Os escudos de ouro de Salomão",
    subtitle: "1Rs 14:26 — o ouro do bosque do Líbano levado ao Egito",
    text: "Salomão mandara bater duzentos paveses e trezentos escudos de ouro, e os pôs \"na casa do bosque do Líbano\" (1Rs 10:16-17). No quinto ano de Roboão, Sisaque subiu contra Jerusalém e \"tomou todos os escudos de ouro que Salomão tinha feito\" (1Rs 14:26). Cinco anos depois da morte do rei mais rico da terra, a glória dele saiu pela porta em carga egípcia — e no lugar dela ficou cobre (1Rs 14:27)." },
  "estatuas-e-imagens-de-asera": {
    title: "As estátuas e imagens de Aserá",
    subtitle: "1Rs 14:23 — os altos de Judá sob toda árvore verde",
    text: "\"Porque também eles edificaram altos, e estátuas, e imagens de Aserá sobre todo o alto outeiro e debaixo de toda a árvore verde\" (1Rs 14:23). O norte tinha os bezerros; o sul tinha isto — e a lei mandava justamente derrubar essas colunas e cortar esses bosques em todo o alto monte e debaixo de toda árvore verde (Dt 12:2-3). O resultado é o veredito do capítulo: \"E fez Judá o que era mau aos olhos do Senhor... provocaram-no a zelos, mais do que todos os seus pais fizeram\" (1Rs 14:22)." },
  "leito-de-abias": {
    title: "O leito de Abias, filho de Jeroboão",
    subtitle: "1Rs 14:1 — a criança doente no palácio de Tirza",
    text: "\"Naquele tempo adoeceu Abias, filho de Jeroboão\" (1Rs 14:1), e foi esta cama que pôs a casa real de Israel a consultar, disfarçada, um profeta cego. A sentença veio dupla: o menino morreria, mas seria o único da casa a receber sepultura e pranto, \"porquanto se achou nele coisa boa para com o Senhor Deus de Israel em casa de Jeroboão\" (1Rs 14:13). Numa casa condenada inteira, Deus enxergou uma coisa boa — e a recolheu antes da ruína." },
  "limiar-da-porta-de-tirza": {
    title: "O limiar da porta de Tirza",
    subtitle: "1Rs 14:17 — a soleira exata onde a palavra se cumpriu",
    text: "Aías dissera à mãe: \"levanta-te, e vai para tua casa; entrando os teus pés na cidade, o menino morrerá\" (1Rs 14:12). E foi ao pé da letra: \"Então a mulher de Jeroboão se levantou, e foi, e chegou a Tirza; chegando ela ao limiar da porta, morreu o menino\" (1Rs 14:17). Todo o Israel o pranteou \"conforme a palavra do Senhor\" (1Rs 14:18) — a profecia medida em passos, para que ninguém tivesse dúvida de quem a dissera." },
  "tenda-de-silo": {
    title: "A tenda de Siló",
    subtitle: "1Rs 14:2 — a cidade do santuário antigo, onde morava Aías",
    text: "\"vai a Siló. Eis que lá está o profeta Aías, o qual falou de mim, que eu seria rei sobre este povo\" (1Rs 14:2). Siló fora a casa do tabernáculo desde Josué (Js 18:1) até a derrota diante dos filisteus, e a sua ruína virou provérbio de aviso na boca dos profetas (Jr 7:12); restou dela um velho cego que ainda ouvia a Deus. Quem rasgou a capa nova em doze pedaços para dar dez tribos a Jeroboão (1Rs 11:30-31) é o mesmo que agora anuncia o fim da casa dele (1Rs 14:10)." },
  "tesouros-da-casa-do-senhor": {
    title: "Os tesouros da casa do Senhor",
    subtitle: "1Rs 14:26 — o que Sisaque levou de Jerusalém",
    text: "\"E tomou os tesouros da casa do Senhor e os tesouros da casa do rei; e levou tudo\" (1Rs 14:26). É o mesmo depósito que Salomão enchera com o ouro de Ofir e de Társis, esvaziado num quinto ano de reinado por um rei do Egito. O saque começa a cumprir o aviso dado na própria dedicação: se o povo se apartasse, a casa exaltada seria lançada longe da presença de Deus (1Rs 9:6-7)." },
  "bezerro-de-ouro-de-da": {
    title: "O bezerro de ouro de Dã",
    subtitle: "1Rs 12:29 • 15:26 — o ídolo do extremo norte",
    text: "Jeroboão \"fez dois bezerros de ouro\" para que o povo não subisse mais a Jerusalém, \"E pôs um em Betel, e colocou o outro em Dã\" (1Rs 12:28-29). O de Dã ficava no limite mais distante da terra, e por ele \"o povo ia até Dã para adorar o bezerro\" (1Rs 12:30). É a estrada por onde todos os reis do Norte andaram depois: de Nadabe se diz que \"andou nos caminhos de seu pai, e no seu pecado com que seu pai fizera pecar a Israel\" (1Rs 15:26), e a mesma sentença se repete sobre Baasa, Elá, Zinri, Onri e Acabe." },
  "idolo-de-maaca": {
    title: "O ídolo horrível de Maaca",
    subtitle: "1Rs 15:13 — o abominável de Aserá queimado no Cedrom",
    text: "A rainha-mãe de Judá \"tinha feito um horrível ídolo a Aserá\", e por isso Asa a \"removeu para que não fosse rainha\"; \"também Asa desfez o seu ídolo horrível, e o queimou junto ao ribeiro de Cedrom\" (1Rs 15:13). A crônica acrescenta que o rei ainda \"o despedaçou, e o queimou junto ao ribeiro de Cedrom\" (2Cr 15:16) — nem o sangue da própria mãe comprou tolerância para a imagem. É a lei de Deuteronômio cumprida ao pé da letra: \"e os seus bosques queimareis a fogo\" (Dt 12:3)." },
  "lampada-de-davi-em-jerusalem": {
    title: "A lâmpada de Davi em Jerusalém",
    subtitle: "1Rs 15:4 — a promessa que não se apaga por mérito de rei nenhum",
    text: "Abias andou nos pecados do pai, \"Mas por amor de Davi o Senhor seu Deus lhe deu uma lâmpada em Jerusalém, levantando a seu filho depois dele\" (1Rs 15:4). A palavra vinha de longe: Deus prometera que \"Davi, meu servo, sempre tenha uma lâmpada diante de mim em Jerusalém\" (1Rs 11:36), e o Salmo canta o mesmo: \"preparei uma lâmpada para o meu ungido\" (Sl 132:17). O candelabro aceso na cena não é prêmio do rei que está reinando — é a fidelidade de Deus a uma aliança que o pecado de Judá não conseguiu soprar." },
  "pedras-de-rama": {
    title: "As pedras de Ramá",
    subtitle: "1Rs 15:22 — o bloqueio desmanchado vira muro de Judá",
    text: "Baasa \"edificou a Ramá, para que a ninguém fosse permitido sair, nem entrar a ter com Asa, rei de Judá\" (1Rs 15:17): um posto de estrangulamento a poucos quilômetros de Jerusalém. Quando a Síria comprada com o ouro do templo obrigou Baasa a largar a obra, Asa apregoou que todos \"trouxessem as pedras de Ramá, e a sua madeira com que Baasa edificara\" (1Rs 15:22). \"e com elas edificou o rei Asa a Geba de Benjamim e a Mizpá\" — a pedra do cerco terminou como pedra de guarda." },
  "vasos-consagrados-de-asa": {
    title: "Os vasos consagrados de Asa",
    subtitle: "1Rs 15:15 — a prata que o rei devolveu à casa do Senhor",
    text: "\"E à casa do Senhor trouxe as coisas consagradas por seu pai, e as coisas que ele mesmo consagrara; prata, ouro e vasos\" (1Rs 15:15). É o retrato do rei cujo \"coração de Asa reto para com o Senhor todos os seus dias\" (1Rs 15:14) — o tesouro entra no templo em vez de sair dele. A tragédia do capítulo é que, poucos versículos adiante, o mesmo rei \"tomou toda a prata e ouro que ficaram nos tesouros da casa do Senhor\" para comprar a Síria (1Rs 15:18): o que a fé consagrou, o medo gastou." },
  "bosque-de-acabe": {
    title: "O bosque de Acabe",
    subtitle: "1Rs 16:33 — a Aserá plantada em Samaria",
    text: "\"Também Acabe fez um ídolo; de modo que Acabe fez muito mais para irritar ao Senhor Deus de Israel, do que todos os reis de Israel que foram antes dele\" (1Rs 16:33). O poste sagrado de Aserá, plantado ao lado do altar, é exatamente o que a lei proibira: \"Não plantarás nenhuma árvore junto ao altar do Senhor teu Deus\" (Dt 16:21). É a mesma coisa que Asa desfizera e queimara no Cedrom uma geração antes (1Rs 15:13), replantada agora na capital do Norte — e são estes \"os quatrocentos profetas de Aserá, que comem da mesa de Jezabel\" (1Rs 18:19)." },
  "idolo-de-baal": {
    title: "O ídolo de Baal em Samaria",
    subtitle: "1Rs 16:32 — a imagem na casa que Acabe edificou",
    text: "Casado com Jezabel, filha do rei dos sidônios, Acabe \"foi e serviu a Baal, e o adorou\" (1Rs 16:31). \"E levantou um altar a Baal, na casa de Baal que edificara em Samaria\" (1Rs 16:32): não um alto escondido no campo, mas um templo oficial no coração da capital, ao lado do palácio. A imagem só cairia gerações depois, quando \"quebraram a estátua de Baal; e derrubaram a casa de Baal\" (2Rs 10:27)." },
  "leito-de-ela-na-casa-de-arsa": {
    title: "O leito de Elá na casa de Arsa",
    subtitle: "1Rs 16:9-10 — o divã onde o rei bêbado foi morto",
    text: "Enquanto o exército de Israel cercava Gibetom, o rei estava \"em Tirza, bebendo e embriagando-se em casa de Arsa, mordomo em Tirza\" (1Rs 16:9). Zinri, capitão de metade dos carros, conspirou: \"Entrou, pois, Zinri, e o feriu, e o matou\" (1Rs 16:10). O divã do banquete virou o lugar da execução, e com Elá caiu toda a casa de Baasa — \"conforme à palavra do Senhor\" dita pelo profeta Jeú (1Rs 16:12)." },
  "monte-de-samaria": {
    title: "O monte de Semer",
    subtitle: "1Rs 16:24 — a capital que nasceu de uma escritura",
    text: "\"E de Semer comprou o monte de Samaria por dois talentos de prata, e edificou nele\" (1Rs 16:24). Onri, que subira ao trono num arraial de guerra, comprou uma encosta pelada e fundou ali a cidade que seria a capital do Norte por dois séculos; \"e chamou a cidade que edificou Samaria, do nome de Semer, dono do monte\". O nome do vendedor ficou gravado na cidade — mas o veredito sobre quem a edificou foi outro: \"fez pior do que todos quantos foram antes dele\" (1Rs 16:25)." },
  "paco-da-casa-do-rei": {
    title: "O paço da casa do rei em Tirza",
    subtitle: "1Rs 16:18 — o palácio queimado sobre o próprio rei",
    text: "O reinado inteiro cabe numa linha: \"reinou Zinri sete dias em Tirza\" (1Rs 16:15). Quando Onri e todo o Israel cercaram a cidade, \"Zinri, vendo que a cidade era tomada, foi ao paço da casa do rei e queimou-a sobre si; e morreu\" (1Rs 16:18). O reinado mais curto da Escritura acaba num incêndio ateado pelo próprio ocupante do trono, e o texto não deixa dúvida sobre a causa: \"Por causa dos pecados que cometera, fazendo o que era mau aos olhos do Senhor\" (1Rs 16:19)." },
  "portas-de-jerico": {
    title: "As portas de Jericó",
    subtitle: "1Rs 16:34 — a maldição de Josué cobrada nos filhos de Hiel",
    text: "\"Em seus dias Hiel, o betelita, edificou a Jericó; em Abirão, seu primogênito, a fundou, e em Segube, seu filho menor, pôs as suas portas\" (1Rs 16:34). Cinco séculos antes, Josué esconjurara a cidade: \"sobre seu primogênito a fundará, e sobre o seu filho mais novo lhe porá as portas\" (Js 6:26). O texto fecha o capítulo mostrando que a palavra de Deus não caducou — \"conforme a palavra do Senhor, que falara pelo ministério de Josué\" —, e os dois montinhos ao pé dos batentes não são pedra: são os dois filhos." },
  "altar-de-baal-em-samaria": {
    title: "O altar de Baal na corte de Acabe",
    subtitle: "1Rs 16:32 — o altar diante do qual Elias entra",
    text: "\"E levantou um altar a Baal, na casa de Baal que edificara em Samaria\" (1Rs 16:32): é o altar do estado, aceso a poucos passos do trono, quando Elias, o tisbita, atravessa a sala. O profeta não discute com o ídolo; toma-lhe a especialidade e a fecha: \"Vive o SENHOR Deus de Israel, perante cuja face estou, que nestes anos nem orvalho nem chuva haverá, senão segundo a minha palavra\" (1Rs 17:1). O diagnóstico virá no Carmelo: \"deixastes os mandamentos do Senhor, e seguistes a Baalim\" (1Rs 18:18)." },
  "botija-de-azeite-de-sarepta": {
    title: "A botija de azeite da viúva",
    subtitle: "1Rs 17:12 — o pouco que não faltou",
    text: "A viúva de Sarepta tinha \"um pouco de azeite numa botija\", e ia preparar a última refeição para si e para o filho, \"para que o comamos, e morramos\" (1Rs 17:12). Elias lhe pediu primeiro a ela, e prometeu em nome do Senhor: \"o azeite da botija não faltará até ao dia em que o Senhor dê chuva sobre a terra\" (1Rs 17:14). E assim foi, dia após dia, sem sobra e sem falta: \"da botija o azeite não faltou; conforme a palavra do Senhor\" (1Rs 17:16)." },
  "cama-do-quarto-de-cima-de-sarepta": {
    title: "A cama do quarto de cima",
    subtitle: "1Rs 17:19-22 — onde o menino tornou a viver",
    text: "Morto o filho da viúva, Elias \"o tomou do seu regaço, e o levou para cima, ao quarto, onde ele mesmo habitava, e o deitou em sua cama\" (1Rs 17:19). Ali \"se estendeu sobre o menino três vezes, e clamou ao Senhor\", pedindo que a alma dele tornasse a entrar nele (1Rs 17:21). \"E o Senhor ouviu a voz de Elias; e a alma do menino tornou a entrar nele, e reviveu\" (1Rs 17:22) — a primeira ressurreição registrada na Escritura, e a razão da confissão da mãe: \"a palavra do Senhor na tua boca é verdade\" (1Rs 17:24). É deste quarto que Hebreus se lembra: \"As mulheres receberam pela ressurreição os seus mortos\" (Hb 11:35)." },
  "corvos-de-querite": {
    title: "Os corvos de Querite",
    subtitle: "1Rs 17:4,6 — a despensa que Deus ordenou",
    text: "\"E há de ser que beberás do ribeiro; e eu tenho ordenado aos corvos que ali te sustentem\" (1Rs 17:4). Aves imundas pela lei — \"Todo o corvo segundo a sua espécie\" está entre as abomináveis (Lv 11:15) — e, ainda assim, \"os corvos lhe traziam pão e carne pela manhã; como também pão e carne à noite\" (1Rs 17:6). Na terra que Deus fechou à chuva, Ele mesmo escolhe o mensageiro mais improvável para pôr a mesa do seu profeta." },
  "imagem-de-baal": {
    title: "A imagem de Baal",
    subtitle: "1Rs 18:26 — o deus da tempestade que não responde",
    text: "Baal era o senhor da chuva e do trovão, e é exatamente a chuva que o Senhor lhe tira das mãos por três anos (1Rs 17:1). No Carmelo os seus profetas \"invocaram o nome de Baal, desde a manhã até ao meio-dia\", saltando em volta do altar; \"Porém nem havia voz, nem quem respondesse\" (1Rs 18:26). E \"se retalhavam com facas e com lancetas, conforme ao seu costume, até derramarem sangue sobre si\" (1Rs 18:28), e ao cabo do dia o veredito foi o mesmo: \"não houve voz, nem resposta, nem atenção alguma\" (1Rs 18:29)." },
  "panela-de-farinha-de-sarepta": {
    title: "A panela de farinha da viúva",
    subtitle: "1Rs 17:12 — o punhado que durou a seca inteira",
    text: "\"nem um bolo tenho, senão somente um punhado de farinha numa panela\", disse a viúva, apanhando dois cavacos para a última fogueira (1Rs 17:12). A promessa foi dada antes de haver prova alguma: \"A farinha da panela não se acabará\" (1Rs 17:14) — e ela obedeceu, assando primeiro o bolo do profeta. \"Da panela a farinha não se acabou\" (1Rs 17:16). Jesus lembraria esta casa para dizer que a graça de Deus passa por cima das fronteiras de Israel: \"a nenhuma delas foi enviado Elias, senão a Sarepta de Sidom, a uma mulher viúva\" (Lc 4:26)." },
  "ribeiro-de-querite": {
    title: "O ribeiro de Querite",
    subtitle: "1Rs 17:3-7 — o esconderijo que secou",
    text: "\"Retira-te daqui, e vai para o oriente, e esconde-te junto ao ribeiro de Querite, que está diante do Jordão\" (1Rs 17:3). Ali o profeta da seca teve água corrente e pão trazido pelos corvos, no único lugar verde daqueles dias. Mas a palavra que fechou o céu alcançou também o seu abrigo: \"passados dias, o ribeiro se secou, porque não tinha havido chuva na terra\" (1Rs 17:7) — e foi a fonte seca que o empurrou para Sarepta, onde Deus já tinha ordenado a uma viúva que o sustentasse (1Rs 17:9)." },
  "altar-de-baal-no-carmelo": {
    title: "O altar dos profetas de Baal",
    subtitle: "1Rs 18:26 — o altar sobre o qual eles saltavam",
    text: "Quatrocentos e cinqüenta homens escolheram o seu bezerro, armaram a lenha e clamaram meio dia inteiro: \"e saltavam sobre o altar que tinham feito\" (1Rs 18:26). Ao meio-dia Elias zombava — \"talvez esteja dormindo, e despertará\" (1Rs 18:27) — e eles subiram o tom, e \"se retalhavam com facas e com lancetas, conforme ao seu costume\" (1Rs 18:28). Nada desceu sobre aquela lenha: \"não houve voz, nem resposta, nem atenção alguma\" (1Rs 18:29). O altar mais barulhento da Escritura é também o mais mudo." },
  "altar-do-senhor-no-carmelo": {
    title: "O altar restaurado do Senhor",
    subtitle: "1Rs 18:30-38 — as doze pedras e o fogo que desceu",
    text: "Antes de orar, Elias \"restaurou o altar do Senhor, que estava quebrado\" (1Rs 18:30): a obra do avivamento começa por consertar o que a apostasia derrubou. Com doze pedras \"edificou o altar em nome do Senhor\", abriu um rego em volta e mandou encharcar tudo três vezes (1Rs 18:32-34). Então orou pedindo não espetáculo, mas conversão — \"para que este povo conheça que tu és o Senhor Deus\" (1Rs 18:37) —, \"Então caiu fogo do Senhor, e consumiu o holocausto, e a lenha, e as pedras, e o pó\" (1Rs 18:38)." },
  "carro-de-acabe": {
    title: "O carro de Acabe",
    subtitle: "1Rs 18:44-45 • 22:35 — o carro do rei de Israel",
    text: "É o carro que corre à frente da chuva: \"Aparelha o teu carro, e desce, para que a chuva não te impeça\" (1Rs 18:44), e \"Acabe subiu ao carro, e foi para Jizreel\", com Elias correndo adiante dele pela estrada (1Rs 18:45-46). É também o carro em que o rei fez subir o inimigo que Deus lhe entregara — \"e ele o fez subir ao carro\" (1Rs 20:33) —, misericórdia por conta própria que lhe custou a sentença. E é o carro em que ele morre em Ramote: \"o sangue da ferida corria para o fundo do carro\" (1Rs 22:35)." },
  "cova-dos-cem-profetas": {
    title: "A cova dos cem profetas",
    subtitle: "1Rs 18:4 — cinqüenta numa cova, cinqüenta noutra",
    text: "Enquanto Jezabel destruía os profetas do Senhor, o mordomo do próprio palácio agia contra o palácio: \"Obadias tomou cem profetas, e de cinqüenta em cinqüenta os escondeu numa cova, e os sustentou com pão e água\" (1Rs 18:4). Em plena fome extrema, alimentar cem bocas escondidas era desviar comida debaixo do nariz da rainha. Por isso Elias não estava tão só quanto pensava (1Rs 19:10): Deus tinha reservado \"em Israel sete mil: todos os joelhos que não se dobraram a Baal\" (1Rs 19:18)." },
  "doze-pedras-das-tribos": {
    title: "As doze pedras das tribos",
    subtitle: "1Rs 18:31 — o altar que remenda um povo rachado",
    text: "\"E Elias tomou doze pedras, conforme ao número das tribos dos filhos de Jacó, ao qual veio a palavra do Senhor, dizendo: Israel será o teu nome\" (1Rs 18:31). O reino estava partido havia sessenta anos, mas o profeta edifica um altar de doze pedras: diante de Deus, Israel continua sendo um só povo, e a divisão política não desfaz a eleição. Foi \"com aquelas pedras\" que ele edificou o altar \"em nome do Senhor\" (1Rs 18:32) — e o fogo que desceu consumiu até as pedras (1Rs 18:38)." },
  "pequena-nuvem-como-a-mao-de-um-homem": {
    title: "A pequena nuvem do mar",
    subtitle: "1Rs 18:44 — o começo da chuva de três anos",
    text: "Elias, com o rosto entre os joelhos no cume do Carmelo, mandou o servo olhar sete vezes para o lado do mar. À sétima: \"Eis aqui uma pequena nuvem, como a mão de um homem, subindo do mar\" (1Rs 18:44). Do tamanho de uma palma — e bastou: \"os céus se enegreceram com nuvens e vento, e veio uma grande chuva\" (1Rs 18:45). Tiago aponta para esta oração ao ensinar a perseverança: \"E orou outra vez, e o céu deu chuva, e a terra produziu o seu fruto\" (Tg 5:18)." },
  "quatro-cantaros-de-agua": {
    title: "Os quatro cântaros de água",
    subtitle: "1Rs 18:34 — a água derramada três vezes sobre o holocausto",
    text: "No terceiro ano de seca, quando cada gota valia uma vida, Elias mandou: \"Enchei de água quatro cântaros, e derramai-a sobre o holocausto e sobre a lenha\" (1Rs 18:34). E não uma vez: \"Fazei-o terceira vez; e o fizeram terceira vez\". Doze cântaros encharcaram vítima, lenha e altar, \"a água corria ao redor do altar\" (1Rs 18:35): o profeta fecha toda porta à fraude, para que ninguém atribua a fagulha a mão de homem. O fogo veio assim mesmo, \"e ainda lambeu a água que estava no rego\" (1Rs 18:38)." },
  "rego-em-redor-do-altar": {
    title: "O rego em redor do altar",
    subtitle: "1Rs 18:32 — o fosso cheio de água no ano da seca",
    text: "Erguido o altar de doze pedras, Elias \"fez um rego em redor do altar, segundo a largura de duas medidas de semente\" (1Rs 18:32). O sulco não era ornamento: era a prova. Depois dos doze cântaros, \"até o rego ele encheu de água\" (1Rs 18:35), num tempo em que Acabe percorria a terra atrás de erva para não perder os cavalos (1Rs 18:5). Quando o fogo caiu, não sobrou nem a poça: ele \"ainda lambeu a água que estava no rego\" (1Rs 18:38)." },
  "ribeiro-de-quisom": {
    title: "O ribeiro de Quisom",
    subtitle: "1Rs 18:40 — onde os profetas de Baal foram mortos",
    text: "Depois do fogo e da confissão do povo, Elias ordenou: \"Lançai mão dos profetas de Baal, que nenhum deles escape\" (1Rs 18:40). \"e Elias os fez descer ao ribeiro de Quisom, e ali os matou\" — a lei de Israel exigia esta sentença dos que arrastavam o povo atrás de outros deuses (Dt 13:5). É o mesmo leito onde Débora cantara a derrota de Sísera: \"O ribeiro de Quisom os arrastou, aquele antigo ribeiro\" (Jz 5:21)." },
  "bolo-cozido-sobre-as-brasas": {
    title: "O pão cozido sobre as brasas",
    subtitle: "1Rs 19:6 — a comida do anjo no deserto",
    text: "Elias pedira a morte debaixo do zimbro; o céu respondeu com comida. \"E olhou, e eis que à sua cabeceira estava um pão cozido sobre as brasas, e uma botija de água; e comeu, e bebeu, e tornou a deitar-se\" (1Rs 19:6). Deus não repreende o profeta esgotado: deixa-o dormir, alimenta-o duas vezes e só depois fala. \"e com a força daquela comida caminhou quarenta dias e quarenta noites até Horebe, o monte de Deus\" (1Rs 19:8)." },
  "botija-de-agua-de-elias": {
    title: "A botija de água à cabeceira",
    subtitle: "1Rs 19:6 — a água posta ao lado de quem pedira a morte",
    text: "Ao acordar sob o zimbro, Elias achou brasas, pão \"e uma botija de água; e comeu, e bebeu, e tornou a deitar-se\" (1Rs 19:6). O anjo voltou uma segunda vez, tocou-o e disse: \"Levanta-te e come, porque te será muito longo o caminho\" (1Rs 19:7). O profeta que fechara o céu não conseguia arranjar para si um gole de água no deserto — e Deus, que o sustentara por corvos e por uma viúva, sustenta-o agora pela mão de um anjo." },
  "brasas-do-anjo": {
    title: "As brasas do anjo",
    subtitle: "1Rs 19:5-7 — o fogo aceso ao lado do profeta adormecido",
    text: "\"E deitou-se, e dormiu debaixo do zimbro; e eis que então um anjo o tocou, e lhe disse: Levanta-te, come\" (1Rs 19:5). Sobre aquelas brasas havia pão assado, e à cabeceira uma botija de água. \"E o anjo do Senhor tornou segunda vez, e o tocou\" (1Rs 19:7): não há sermão, não há censura pela fuga — há um toque, uma fogueira e comida. Antes de Horebe e da voz mansa e delicada, Deus trata o corpo do seu servo." },
  "caverna-de-horebe": {
    title: "A caverna de Horebe",
    subtitle: "1Rs 19:9-13 — onde Deus passou na voz mansa e delicada",
    text: "\"E ali entrou numa caverna e passou ali a noite; e eis que a palavra do Senhor veio a ele\" com a pergunta que desmonta a fuga: \"Que fazes aqui, Elias?\" (1Rs 19:9,13). No mesmo monte em que Deus se dera a Moisés em trovões, passaram vento que fendia os montes, terremoto e fogo — \"porém o Senhor não estava no vento\", nem no terremoto, nem no fogo (1Rs 19:11). \"e depois do fogo uma voz mansa e delicada\" (1Rs 19:12): o profeta do fogo do Carmelo é ensinado a reconhecer Deus no sussurro." },
  "fogo-dos-aparelhos-do-arado": {
    title: "O fogo dos aparelhos dos bois",
    subtitle: "1Rs 19:21 — a lavoura queimada de Eliseu",
    text: "Eliseu \"andava lavrando com doze juntas de bois adiante dele\" quando Elias passou e \"lançou a sua capa sobre ele\" (1Rs 19:19). O chamado foi selado com fumaça: \"tomou a junta de bois, e os matou, e com os aparelhos dos bois cozeu as carnes, e as deu ao povo, e comeram\" (1Rs 19:21). Queimados o arado e mortos os bois, não sobrou ofício para o qual voltar — \"então se levantou e seguiu a Elias, e o servia\". É a figura que Jesus retomaria: \"Ninguém, que lança mão do arado e olha para trás, é apto para o reino de Deus\" (Lc 9:62)." },
  "zimbro-de-elias": {
    title: "O zimbro do deserto",
    subtitle: "1Rs 19:4 — a sombra onde o profeta pediu a morte",
    text: "Fugindo de Jezabel, Elias andou um dia deserto adentro \"e foi sentar-se debaixo de um zimbro; e pediu para si a morte\" (1Rs 19:4). A oração é das mais nuas da Escritura: \"Já basta, ó Senhor; toma agora a minha vida, pois não sou melhor do que meus pais\". Um dia depois do fogo do Carmelo, o mesmo homem quer morrer — e Deus não o repreende: \"E deitou-se, e dormiu debaixo do zimbro\" (1Rs 19:5), e ali manda um anjo com pão e água." },
  "carros-dos-sirios": {
    title: "Os carros dos sírios",
    subtitle: "1Rs 20:1,21 — a cavalaria dos trinta e dois reis",
    text: "Ben-Hadade cercou Samaria com todo o seu exército, \"e havia com ele trinta e dois reis, e cavalos e carros\" (1Rs 20:1). Bastaram duzentos e trinta e dois moços dos príncipes das províncias para desfazer aquilo: \"E saiu o rei de Israel, e feriu os cavalos e os carros; e feriu os sírios com grande estrago\" (1Rs 20:21). Os conselheiros sírios não aprenderam a lição, e mandaram refazer tudo \"cavalo por cavalo, e carro por carro\" (1Rs 20:25) — \"Uns confiam em carros e outros em cavalos, mas nós faremos menção do nome do Senhor nosso Deus\" (Sl 20:7)." },
  "cavalo-da-fuga-de-ben-hadade": {
    title: "O cavalo da fuga de Ben-Hadade",
    subtitle: "1Rs 20:20 — o rei que se gabou e saiu correndo",
    text: "Ele jurara que \"o pó de Samaria não bastará para encher as mãos de todo o povo que me segue\" (1Rs 20:10), e ouviu de Acabe o provérbio: \"Não se gabe quem se cinge das armas, como aquele que as descinge\" (1Rs 20:11). Ao meio-dia, bêbado nas tendas, viu o seu arraial desmanchar-se: \"os sírios fugiram, e Israel os perseguiu; porém Ben-Hadade, rei da Síria, escapou a cavalo, com alguns cavaleiros\" (1Rs 20:20). Do exército de trinta e dois reis restou um cavalo em disparada." },
  "escombros-do-muro-de-afeque": {
    title: "Os escombros do muro de Afeque",
    subtitle: "1Rs 20:30 — a muralha que caiu sobre os sobreviventes",
    text: "Depois de cem mil sírios caírem num só dia, os que restaram correram para dentro da cidade — \"e caiu o muro sobre vinte e sete mil homens, que restaram\" (1Rs 20:30). A parede em que confiaram foi o que os matou; o refúgio virou a sepultura. \"Ben-Hadade, porém, fugiu, e veio à cidade, escondendo-se de câmara em câmara\", o mesmo esconderijo humilhante que Micaías profetizaria depois a Acabe (1Rs 22:25)." },
  "muro-de-afeque": {
    title: "O muro de Afeque",
    subtitle: "1Rs 20:30 — a muralha da cidade do campo raso",
    text: "Os servos do rei da Síria tinham dito que o Deus de Israel era \"deuses dos montes\", e por isso aconselharam: \"pelejemos com eles em campo raso\" (1Rs 20:23): por isso \"subiu a Afeque, para pelejar contra Israel\" (1Rs 20:26). O homem de Deus veio ao rei com a resposta do Senhor a essa teologia: \"O Senhor é Deus dos montes, e não Deus dos vales\" — \"toda esta grande multidão entregarei nas tuas mãos; para que saibas que eu sou o Senhor\" (1Rs 20:28). E foi a própria muralha de Afeque que executou a sentença (1Rs 20:30)." },
  "taca-de-ben-hadade": {
    title: "A taça de Ben-Hadade",
    subtitle: "1Rs 20:12,16 — o copo do rei que cercava bebendo",
    text: "A ordem de assalto saiu de uma mesa de bebida: \"ouvindo ele esta palavra, estando a beber com os reis nas tendas, disse aos seus servos: Ponde-vos em ordem contra a cidade\" (1Rs 20:12). E quando os moços dos príncipes das províncias saíram ao meio-dia, \"Ben-Hadade estava bebendo e embriagando-se nas tendas, ele e os reis, os trinta e dois reis, que o ajudavam\" (1Rs 20:16). Como Elá na casa de Arsa (1Rs 16:9), o copo chega antes da queda." },
  "tendas-de-ben-hadade": {
    title: "As tendas do arraial da Síria",
    subtitle: "1Rs 20:12,16 — o acampamento que cercou Samaria",
    text: "Ben-Hadade \"ajuntou todo o seu exército\", e com trinta e dois reis \"subiu, e cercou a Samaria, e pelejou contra ela\" (1Rs 20:1). Dali saíram as exigências crescentes — a prata, o ouro, as mulheres e os filhos do rei de Israel (1Rs 20:3-6) — e dali a ordem: \"Ponde-vos em ordem contra a cidade\" (1Rs 20:12). O arraial que estrangulava a capital era, na hora do ataque, uma festa de bêbados (1Rs 20:16); e sobre ele o Senhor dissera: \"Eis que hoje ta entregarei nas tuas mãos, para que saibas que eu sou o Senhor\" (1Rs 20:13)." },
  "cama-de-acabe": {
    title: "A cama de Acabe",
    subtitle: "1Rs 21:4 — o rei emburrado de rosto para a parede",
    text: "Negada a vinha, \"Então Acabe veio desgostoso e indignado à sua casa\", e ali \"deitou-se na sua cama, e voltou o rosto, e não comeu pão\" (1Rs 21:4) — o senhor de Israel de mau humor como criança, por causa de uma horta. Foi este beicinho que Jezabel transformou em sentença de morte: \"Governas tu agora no reino de Israel? Levanta-te, come pão, e alegre-se o teu coração; eu te darei a vinha de Nabote, o jizreelita\" (1Rs 21:7)." },
  "cartas-de-jezabel": {
    title: "As cartas seladas com o sinete do rei",
    subtitle: "1Rs 21:8 — o assassinato escrito em papel oficial",
    text: "\"Então escreveu cartas em nome de Acabe, e as selou com o seu sinete; e mandou as cartas aos anciãos e aos nobres que havia na sua cidade\" (1Rs 21:8). As instruções eram um culto usado como emboscada: \"Apregoai um jejum, e ponde Nabote diante do povo\", com \"dois filhos de Belial, que testemunhem contra ele\" (1Rs 21:9-10). A lei pedia duas testemunhas para condenar à morte (Dt 17:6); Jezabel comprou exatamente duas — e os homens da cidade obedeceram \"conforme estava escrito nas cartas\" (1Rs 21:11)." },
  "pedras-de-nabote": {
    title: "As pedras do apedrejamento de Nabote",
    subtitle: "1Rs 21:13 — o sangue derramado fora da cidade",
    text: "Os dois filhos de Belial testemunharam que \"Nabote blasfemou contra Deus e contra o rei. E o levaram para fora da cidade, e o apedrejaram, e morreu\" (1Rs 21:13). Tudo com forma legal — jejum apregoado, assento diante do povo, o número de testemunhas que a lei exigia (Dt 17:6) — e tudo mentira. O Senhor mandou Elias descer à vinha com a sentença: \"No lugar em que os cães lamberam o sangue de Nabote lamberão também o teu próprio sangue\" (1Rs 21:19)." },
  "vinha-de-nabote": {
    title: "A vinha de Nabote",
    subtitle: "1Rs 21:3 — \"a herança de meus pais\"",
    text: "\"Nabote, o jizreelita, tinha uma vinha em Jizreel junto ao palácio de Acabe, rei de Samaria\" (1Rs 21:1). A recusa dele não foi teimosia de camponês, e sim obediência: \"Guarde-me o Senhor de que eu te dê a herança de meus pais\" (1Rs 21:3), porque em Israel \"a terra não se venderá em perpetuidade, porque a terra é minha\", diz o Senhor (Lv 25:23). O rei podia comprar; o súdito não podia vender. Tomada por sangue, a vinha virou o tribunal onde Elias o encontrou: \"Já me achaste, inimigo meu?\" (1Rs 21:20)." },
  "altos-de-juda": {
    title: "Os altos de Judá",
    subtitle: "1Rs 15:14 • 22:43-44 — o culto que rei nenhum bom tirou",
    text: "Desde os dias de Roboão o povo \"edificaram altos, e estátuas, e imagens de Aserá sobre todo o alto outeiro e debaixo de toda a árvore verde\" (1Rs 14:23). Asa fez o que era reto, mas \"Os altos, porém, não foram tirados\" (1Rs 15:14), e o mesmo se anota do seu filho: \"Todavia os altos não se tiraram; ainda o povo sacrificava e queimava incenso nos altos\" (1Rs 22:44). A lei mandara destruir todo lugar onde as nações serviram aos seus deuses \"sobre os outeiros, e debaixo de toda a árvore frondosa\" (Dt 12:2) — é a reforma que sempre para no meio." },
  "arco-atirado-a-esmo": {
    title: "O arco atirado a esmo",
    subtitle: "1Rs 22:34 — a flecha sem pontaria que cumpriu a profecia",
    text: "Acabe achou que podia driblar a palavra de Micaías: \"Eu me disfarçarei, e entrarei na peleja; tu porém veste as tuas roupas\" (1Rs 22:30). O disfarce enganou os trinta e dois capitães dos carros, mas não o Senhor: \"Então um homem armou o arco, e atirou a esmo, e feriu o rei de Israel por entre as fivelas e as couraças\" (1Rs 22:34). Nenhum atirador mirou aquele rei; a seta achou a única fresta da armadura, e o rei morreu à tarde, escorado no seu carro (1Rs 22:35)." },
  "baal-de-acazias": {
    title: "O Baal de Acazias",
    subtitle: "1Rs 22:54 — o ídolo com que o livro se fecha",
    text: "O último rei apresentado em 1 Reis \"andou no caminho de seu pai, como também no caminho de sua mãe, e no caminho de Jeroboão, filho de Nebate\" (1Rs 22:53). E o versículo final não deixa dúvida de a quem ele serviu: \"E serviu a Baal, e adorou-o, e provocou a ira do Senhor Deus de Israel, conforme a tudo quanto fizera seu pai\" (1Rs 22:54). O livro que começou com o trono de Davi e o templo de Salomão termina com um rei de Israel curvado diante de um metal — e o próximo capítulo o mostrará consultando \"Baal-Zebube, deus de Ecrom\" (2Rs 1:2)." },
  "casa-de-marfim": {
    title: "A casa de marfim de Acabe",
    subtitle: "1Rs 22:39 — a obra pela qual o rei quis ser lembrado",
    text: "O epitáfio oficial de Acabe registra a sua grande obra: \"Quanto ao mais dos atos de Acabe, e a tudo quanto fez, e à casa de marfim que edificou\" (1Rs 22:39). O rei que tomou a vinha de um homem por não ter horta construiu um palácio revestido de marfim. Amós, depois, pronunciaria a sentença sobre esse luxo: \"as casas de marfim perecerão, e as grandes casas terão fim, diz o Senhor\" (Am 3:15), e o \"Ai dos que dormem em camas de marfim\" (Am 6:4)." },
  "navios-de-tarsis": {
    title: "Os navios de Társis em Eziom-Geber",
    subtitle: "1Rs 22:49 — a frota que se quebrou antes de zarpar",
    text: "\"E fez Jeosafá navios de Társis, para irem a Ofir por causa do ouro; porém não foram, porque os navios se quebraram em Eziom-Geber\" (1Rs 22:49). É o mesmo porto e a mesma rota do ouro de Salomão (1Rs 9:26-28), mas o resultado é o naufrágio em terra. A crônica dá o motivo: o rei bom de Judá se aliara a Acazias, e o profeta lhe disse: \"Porquanto te aliaste com Acazias, o Senhor despedaçou as tuas obras\" (2Cr 20:37) — e desta vez Jeosafá aprendeu, pois \"não quis\" repetir a sociedade (1Rs 22:50)." },
  "pao-de-angustia": {
    title: "O pão de angústia de Micaías",
    subtitle: "1Rs 22:27 — a ração de quem disse a verdade",
    text: "Por não profetizar o que o rei queria ouvir, a ordem foi: \"Colocai este homem na casa do cárcere, e sustentai-o com o pão de angústia, e com água de amargura, até que eu venha em paz\" (1Rs 22:27). O profeta já tinha decidido o preço: \"Vive o Senhor que o que o Senhor me disser isso falarei\" (1Rs 22:14). E respondeu ao carcereiro com a única aposta que lhe restava: \"Se tu voltares em paz, o Senhor não tem falado por mim\" (1Rs 22:28) — Acabe não voltou." },
  "tanque-de-samaria": {
    title: "O tanque de Samaria",
    subtitle: "1Rs 22:38 — onde os cães lamberam o sangue do rei",
    text: "Trazido morto de Ramote, o rei foi sepultado em Samaria, \"E, lavando-se o carro no tanque de Samaria, os cães lamberam o seu sangue (ora as prostitutas se lavavam ali), conforme à palavra que o Senhor tinha falado\" (1Rs 22:38). A palavra fora dita anos antes, na vinha roubada: \"No lugar em que os cães lamberam o sangue de Nabote lamberão também o teu próprio sangue\" (1Rs 21:19). O açude comum da cidade é o cartório onde a profecia foi registrada como cumprida." },
  "trono-de-acabe": {
    title: "O trono de Acabe na praça",
    subtitle: "1Rs 22:10 — o assento de onde se pediu profecia por encomenda",
    text: "\"E o rei de Israel e Jeosafá, rei de Judá, estavam assentados cada um no seu trono, vestidos de trajes reais, na praça, à entrada da porta de Samaria; e todos os profetas profetizavam na sua presença\" (1Rs 22:10). Quatrocentos homens diziam a uma só voz o que o rei desejava. Do único que faltava, Acabe já sabia o problema: \"porém eu o odeio, porque nunca profetiza de mim o que é bom, mas só o mal\" (1Rs 22:8) — o trono queria conselho, não a palavra do Senhor." },
  "trono-de-jeosafa": {
    title: "O trono de Jeosafá",
    subtitle: "1Rs 22:10 — o rei de Judá assentado ao lado do rei de Israel",
    text: "Jeosafá desceu a Samaria e entregou a Acabe tudo o que tinha: \"Serei como tu, e o meu povo como o teu povo, e os meus cavalos como os teus cavalos\" (1Rs 22:4). Ainda assim, foi dele a única pergunta certa daquele dia: \"Não há aqui ainda algum profeta do Senhor, ao qual possamos consultar?\" (1Rs 22:7). O trono de Judá, posto lado a lado com o de Israel na praça de Samaria, é o retrato de um homem reto (1Rs 22:43) amarrado a uma aliança que quase lhe custou a vida (1Rs 22:32)." },
  "trono-do-senhor-na-visao": {
