...
export const CHAPTER_ACTORS: Record<number, Record<string, StageInfo>> = {
  ...
  17: {
    homem: {
      ...
      text: "O anjo explica a João as duas figuras deste capítulo. Os dez chifres \"são dez reis, que ainda não receberam o reino, mas receberão poder como reis por uma hora, juntamente com a besta\" (Ap 17:12): reinam o tempo de um relógio, \"têm um mesmo intento\" (17:13), e o fim deles é dito antes de começarem — \"combaterão contra o Cordeiro, e o Cordeiro os vencerá\" (17:14). A outra figura são as águas: \"são povos, e multidões, e nações, e línguas\" (17:15), a base humana sem a qual a cidade não se sustenta. E o golpe final não vem de fora: são os próprios dez que \"a queimarão no fogo\" (17:16)."
    },
    mulherComum: {
