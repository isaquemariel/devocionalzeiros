// O pacote de fichas de leviticus — capítulo, personagem e objeto-marco num módulo só,
...
import { CHAPTER_ACTORS } from "@/lib/stageInfo/leviticus";
import { CHARS } from "@/lib/stageInfo/chars/leviticus";
import { TAGS } from "@/lib/stageInfo/tags/leviticus";
