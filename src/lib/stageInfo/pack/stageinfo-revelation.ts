// O pacote de fichas de revelation — capítulo, personagem e objeto-marco num módulo só,
...
import { CHAPTER_ACTORS } from "@/lib/stageInfo/revelation";
import { CHARS } from "@/lib/stageInfo/chars/revelation";
import { TAGS } from "@/lib/stageInfo/tags/revelation";
