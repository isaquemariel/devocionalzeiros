// O pacote de fichas de deuteronomy — capítulo, personagem e objeto-marco num módulo só,
...
import { CHAPTER_ACTORS } from "@/lib/stageInfo/deuteronomy";
import { CHARS } from "@/lib/stageInfo/chars/deuteronomy";
import { TAGS } from "@/lib/stageInfo/tags/deuteronomy";
