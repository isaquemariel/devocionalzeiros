// O pacote de fichas de 1kings — capítulo, personagem e objeto-marco num módulo só,
...
import { CHAPTER_ACTORS } from "@/lib/stageInfo/1kings";
import { CHARS } from "@/lib/stageInfo/chars/1kings";
import { TAGS } from "@/lib/stageInfo/tags/1kings";
