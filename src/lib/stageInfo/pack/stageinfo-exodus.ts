// O pacote de fichas de exodus — capítulo, personagem e objeto-marco num módulo só,
...
import { CHAPTER_ACTORS } from "@/lib/stageInfo/exodus";
import { CHARS } from "@/lib/stageInfo/chars/exodus";
import { TAGS } from "@/lib/stageInfo/tags/exodus";
