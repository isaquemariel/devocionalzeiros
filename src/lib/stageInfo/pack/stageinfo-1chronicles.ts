// O pacote de fichas de 1chronicles — capítulo, personagem e objeto-marco num módulo só,
...
import { CHAPTER_ACTORS } from "@/lib/stageInfo/1chronicles";
import { CHARS } from "@/lib/stageInfo/chars/1chronicles";
import { TAGS } from "@/lib/stageInfo/tags/1chronicles";
