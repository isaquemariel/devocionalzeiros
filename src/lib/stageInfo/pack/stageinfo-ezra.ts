// O pacote de fichas de ezra — capítulo, personagem e objeto-marco num módulo só,
...
import { CHAPTER_ACTORS } from "@/lib/stageInfo/ezra";
import { CHARS } from "@/lib/stageInfo/chars/ezra";
import { TAGS } from "@/lib/stageInfo/tags/ezra";
