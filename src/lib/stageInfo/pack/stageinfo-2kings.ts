// O pacote de fichas de 2kings — capítulo, personagem e objeto-marco num módulo só,
...
import { CHAPTER_ACTORS } from "@/lib/stageInfo/2kings";
import { CHARS } from "@/lib/stageInfo/chars/2kings";
import { TAGS } from "@/lib/stageInfo/tags/2kings";
