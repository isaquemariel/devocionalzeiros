// O pacote de fichas de 1samuel — capítulo, personagem e objeto-marco num módulo só,
...
import { CHAPTER_ACTORS } from "@/lib/stageInfo/1samuel";
import { CHARS } from "@/lib/stageInfo/chars/1samuel";
import { TAGS } from "@/lib/stageInfo/tags/1samuel";
