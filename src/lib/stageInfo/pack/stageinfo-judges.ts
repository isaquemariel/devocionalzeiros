// O pacote de fichas de judges — capítulo, personagem e objeto-marco num módulo só,
...
import { CHAPTER_ACTORS } from "@/lib/stageInfo/judges";
import { CHARS } from "@/lib/stageInfo/chars/judges";
import { TAGS } from "@/lib/stageInfo/tags/judges";
