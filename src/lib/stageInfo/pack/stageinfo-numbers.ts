// O pacote de fichas de numbers — capítulo, personagem e objeto-marco num módulo só,
...
import { CHAPTER_ACTORS } from "@/lib/stageInfo/numbers";
import { CHARS } from "@/lib/stageInfo/chars/numbers";
import { TAGS } from "@/lib/stageInfo/tags/numbers";
