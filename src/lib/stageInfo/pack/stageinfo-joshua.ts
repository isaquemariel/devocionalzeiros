// O pacote de fichas de joshua — capítulo, personagem e objeto-marco num módulo só,
...
import { CHAPTER_ACTORS } from "@/lib/stageInfo/joshua";
import { CHARS } from "@/lib/stageInfo/chars/joshua";
import { TAGS } from "@/lib/stageInfo/tags/joshua";
