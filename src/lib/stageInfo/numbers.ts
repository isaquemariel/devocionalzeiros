...
export const CHAPTER_ACTORS: Record<number, Record<string, StageInfo>> = {
  ...
  17: {
    mulherComum: {
      ...
      text: "Depois da terra que se abriu sobre Corá, do fogo sobre os duzentos e cinquenta e da praga que matou catorze mil e setecentos (Nm 16:49), o arraial inteiro passou a olhar para a tenda do testemunho com pavor. A confissão que fecha o capítulo é de casas inteiras, não de homens só: \"expiramos, perecemos, todos perecemos\" (Nm 17:12). O medo é real, mas está errado de alvo — a vara que floresceu fora dada como sinal de misericórdia, \"e não morram\" (Nm 17:10). O capítulo seguinte responde nomeando quem leva a culpa do santuário (Nm 18:1).",
    },
    homem: {
      title: "Os filhos de Israel diante da vara que floresceu",
      subtitle: "Números 17 • o pavor depois de Corá",
      text: "Doze varas foram postas na tenda do testemunho, uma por casa paterna, e ao outro dia a de Arão \"brotara, e produzira flores, e dera amêndoas\" (Nm 17:8) — madeira seca que reverdeceu, para calar de uma vez a disputa pelo sacerdócio. Mas o povo tinha acabado de ver a terra abrir-se sobre Corá, e a lição chega junto com o terror: \"eis aqui, expiramos, perecemos, todos perecemos\" (Nm 17:12). São estes homens que fazem a pergunta do último versículo, que é medo puro e não fé. A vara ficaria guardada \"contra os filhos rebeldes\" (Nm 17:10).",
    },
    multidao: {
  ...
  20: {
    homem: {
      ...
      text: "São os enviados que Moisés manda de Cades ao rei de Edom com um recado que começa por parentesco: \"Assim diz teu irmão Israel: Tu sabes todo o trabalho que nos tem sobrevindo\" (Nm 20:14). O pedido é modesto: \"iremos pela estrada real\" (Nm 20:17). Edom responde com a espada (Nm 20:18), e eles insistem, oferecendo pagar até a água que os animais bebessem (Nm 20:19). Do outro lado sai a guarda de Esaú \"com muita gente, e com mão forte\" (Nm 20:20). É a primeira vez que a promessa esbarra num parente que Deus proibira guerrear (Dt 2:4-5)."
    },
    multidao: {
