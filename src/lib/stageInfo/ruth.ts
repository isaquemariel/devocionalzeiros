...
export const CHAPTER_ACTORS: Record<number, Record<string, StageInfo>> = {
  ...
  1: {
    ...
    mulherComum: {
      ...
      text: "Noemi, Orfa e Rute são três mulheres sem marido e sem filhos, e no Israel antigo isso era ficar sem pão e sem futuro. Noemi as despede com bênção (Rt 1:9), Orfa beija a sogra e volta \"ao seu povo e aos seus deuses\" (Rt 1:15), e Rute se apega a ela: \"o teu povo é o meu povo, o teu Deus é o meu Deus\" (Rt 1:16). Em Belém, as mulheres da cidade perguntam \"Não é esta Noemi?\", e é a elas que ela responde: \"chamai-me Mara... cheia parti, porém vazia o Senhor me fez tornar\" (Rt 1:19-21). São elas que no fim bendirão o remidor (Rt 4:14).",
    },
    multidao: {
  ...
  2: {
    homem: {
      ...
      text: "São os trabalhadores da colheita de Boaz e o capataz \"que estava posto sobre os segadores\" (Rt 2:5-6) — o moço que sabe quem é a respigadora: \"Esta é a moça moabita que voltou com Noemi dos campos de Moabe\". A saudação que trocam com o dono do campo, \"O Senhor seja convosco… O Senhor te abençoe\" (Rt 2:4), revela um trabalho ainda vivido diante de Deus, coisa rara na época dos juízes. Por ordem de Boaz, não a molestam e ainda deixam cair punhados de propósito (Rt 2:9,15-16) — a lei da respiga cumprida além da letra.",
    },
    mulherComum: {
  ...
  4: {
    anciao: {
      ...
      text: "\"Então tomou dez homens dos anciãos da cidade, e disse: Assentai-vos aqui\" (Rt 4:2). A porta era o fórum de Israel: ali se julgavam causas, se fechavam compras e se davam testemunhos públicos (Dt 25:7), e dez varões formavam o número de uma assembleia legítima. Diante deles Boaz expõe o caso da terra de Elimeleque e do dever de suscitar \"o nome do falecido sobre a sua herança\" (Rt 4:5). Da boca deles sai a bênção sobre Rute — \"como a Raquel e como a Lia, que ambas edificaram a casa de Israel\" (Rt 4:11).",
    },
    homem: {
      title: "O remidor mais chegado — e o menino Obede",
      subtitle: "Rute 4 • quem recusa resgatar, e o filho que nasce do resgate",
      text: "O parente com direito anterior é chamado por Boaz apenas de \"Ó fulano\" (Rt 4:1): a Escritura, de propósito, não guarda o nome de quem não quis redimir. Ele aceita a terra, mas recua ao saber que com ela vem Rute e o dever de levantar o nome do morto — \"para que não prejudique a minha herança\" (Rt 4:6) — e descalça o sapato, gesto que em Israel confirmava toda a permuta (Rt 4:7-8). Perde o nome e a herança que temia perder. Do resgate nasce Obede: \"Este é o pai de Jessé, pai de Davi\" (Rt 4:17).",
    },
    mulherComum: {
