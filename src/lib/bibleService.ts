...
export const BOOK_ID_MAP: Record<string, { apiNumber: number; name: string; aliases: string[]; chapters: number }> = {
  ...
  '1samuel': { apiNumber: 9, name: '1 Samuel', aliases: ['1 samuel', '1samuel', '1sm', '1sam', 'i samuel'], chapters: 31 },
  '2samuel': { apiNumber: 10, name: '2 Samuel', aliases: ['2 samuel', '2samuel', '2sm', '2sam', 'ii samuel'], chapters: 24 },
  '1kings': { apiNumber: 11, name: '1 Reis', aliases: ['1 reis', '1reis', '1rs', '1re', 'i reis'], chapters: 22 },
  '2kings': { apiNumber: 12, name: '2 Reis', aliases: ['2 reis', '2reis', '2rs', '2re', 'ii reis'], chapters: 25 },
  '1chronicles': { apiNumber: 13, name: '1 Crônicas', aliases: ['1 crônicas', '1 cronicas', '1cr', 'i crônicas', 'i cronicas'], chapters: 29 },
  '2chronicles': { apiNumber: 14, name: '2 Crônicas', aliases: ['2 crônicas', '2 cronicas', '2cr', 'ii crônicas', 'ii cronicas'], chapters: 36 },
  ...
  '1corinthians': { apiNumber: 46, name: '1 Coríntios', aliases: ['1 coríntios', '1 corintios', '1co', '1cor', 'i coríntios'], chapters: 16 },
  '2corinthians': { apiNumber: 47, name: '2 Coríntios', aliases: ['2 coríntios', '2 corintios', '2co', '2cor', 'ii coríntios'], chapters: 13 },
  ...
  '1thessalonians': { apiNumber: 52, name: '1 Tessalonicenses', aliases: ['1 tessalonicenses', '1ts', '1tes', 'i tessalonicenses'], chapters: 5 },
  '2thessalonians': { apiNumber: 53, name: '2 Tessalonicenses', aliases: ['2 tessalonicenses', '2ts', '2tes', 'ii tessalonicenses'], chapters: 3 },
  '1timothy': { apiNumber: 54, name: '1 Timóteo', aliases: ['1 timóteo', '1 timoteo', '1tm', '1tim', 'i timóteo'], chapters: 6 },
  '2timothy': { apiNumber: 55, name: '2 Timóteo', aliases: ['2 timóteo', '2 timoteo', '2tm', '2tim', 'ii timóteo'], chapters: 4 },
  ...
  '1peter': { apiNumber: 60, name: '1 Pedro', aliases: ['1 pedro', '1pe', '1ped', 'i pedro'], chapters: 5 },
  '2peter': { apiNumber: 61, name: '2 Pedro', aliases: ['2 pedro', '2pe', '2ped', 'ii pedro'], chapters: 3 },
  '1john': { apiNumber: 62, name: '1 João', aliases: ['1 joão', '1 joao', '1jo', '1joa', 'i joão', 'i joao'], chapters: 5 },
  '2john': { apiNumber: 63, name: '2 João', aliases: ['2 joão', '2 joao', '2jo', '2joa', 'ii joão', 'ii joao'], chapters: 1 },
  '3john': { apiNumber: 64, name: '3 João', aliases: ['3 joão', '3 joao', '3jo', '3joa', 'iii joão', 'iii joao'], chapters: 1 },
