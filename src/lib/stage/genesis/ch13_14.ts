...
export const CHAPTERS: Record<number, StageScript> = {
  ...
  14: {
    ...
    beats: [
      ...
      b(10, { props: SIDIM(true), cast: [C("rei", -30, "lie", { id: "rei-sodoma", dy: 0.56 }), C("rei", 36, "lie", { id: "rei-gomorra", dy: 0.6 }), C("homem", 210, "walk", { id: "soldado-de-sodoma-em-fuga", dy: 0.44, facing: 1 }), C("homem", 264, "walk", { id: "soldado-de-gomorra-em-fuga", dy: 0.48, facing: 1, scale: 0.9 }), C("rei", -110, "stand", { id: "rei-elao", dy: 0.46, facing: 1 })], env: { night: 0.35, storm: 0.6 } }), // poços de betume: caíram ali; fugiram
