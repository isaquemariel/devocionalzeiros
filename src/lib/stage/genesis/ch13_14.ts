...
export const CHAPTERS: Record<number, StageScript> = {
  ...
  14: {
    ...
    beats: [
      ...
      b(18, { props: VALE_SAVE(true), cast: [C("rei", -60, "stand", { dy: 0.46, glow: 0.5 }), C("abraao", 20, "stand", { dy: 0.5, glow: 0.4, facing: -1 }), C("rei", 150, "stand", { id: "rei-sodoma", dy: 0.5, facing: -1 })], env: { glory: 0.55, night: 0.08 } }), // Melquisedeque, rei de Salém: pão e vinho
      b(19, { by: "rei", q: "disse: ", cast: [C("rei", -60, "raise", { dy: 0.46, glow: 0.55 }), C("abraao", 20, "bow", { dy: 0.5, glow: 0.4, facing: -1 }), C("rei", 150, "stand", { id: "rei-sodoma", dy: 0.5, facing: -1 })], env: { glory: 0.7 } }), // "Bendito seja Abrão pelo Deus Altíssimo"
      b(20, { by: "rei", cast: [C("rei", -60, "raise", { dy: 0.46, glow: 0.6 }), C("abraao", 20, "kneel", { dy: 0.5, glow: 0.45, facing: -1 }), C("rei", 150, "stand", { id: "rei-sodoma", dy: 0.5, facing: -1 })], env: { glory: 0.8 } }), // "bendito o Deus Altíssimo"; o dízimo
