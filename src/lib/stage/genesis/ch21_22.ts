...
export const CHAPTERS: Record<number, StageScript> = {
  ...
  21: {
    ...
    beats: [
      ...
      b(12, { env: { night: 0.1, glory: 0.7 } }),                                    // Deus: "em tudo… ESCUTA A SUA VOZ"
      b(13, { env: { glory: 0.75 } }),                                               // também do filho da serva farei nação
  ...
  22: {
    ...
    beats: [
      ...
      b(2, { cast: [C("abraao", -10, "bow", { dy: 0.5 })], env: { glory: 0.45, night: 0.5 } }), // "Toma teu filho, teu ÚNICO filho"
