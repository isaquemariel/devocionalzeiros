...
export const CHAPTERS: Record<number, StageScript> = {
  ...
  22: {
    ...
    beats: [
      ...
      b(9, { cast: [C("abraao", 40, "raise", { dy: 0.52, facing: -1, scale: 1.25 }), C("isaque", -20, "lie", { scale: 1.35, dy: 0.4 })], props: MORIA_ALTAR, env: { night: 0.5, storm: 0.2, glory: 0.05 } }), // o ALTAR ao centro: Isaque amarrado sobre a lenha, o cutelo erguido
      b(10, { cast: [C("abraao", 40, "raise", { dy: 0.52, facing: -1, scale: 1.25 }), C("isaque", -20, "lie", { scale: 1.35, dy: 0.4 })], env: { night: 0.6, storm: 0.3, glory: 0 } }), // a mão estendida, o CUTELO
      b(11, { by: "anjo", q: "desde os céus, e disse: ", cast: [C("anjo", 165, "flyIdle", { glow: 1, dy: 0.22 }), C("abraao", 40, "raise", { dy: 0.52, facing: 1, scale: 1.25 }), C("isaque", -20, "lie", { scale: 1.35, dy: 0.4 })], env: { glory: 0.9, storm: 0.1, night: 0.25 } }), // o BRADO do céu: "Abraão, Abraão!"
      b(12, { by: "anjo", q: "Então disse: ", cast: [C("anjo", 165, "flyIdle", { glow: 1, dy: 0.22 }), C("abraao", 40, "kneel", { dy: 0.52, facing: 1, scale: 1.25 }), C("isaque", -20, "lie", { scale: 1.35, dy: 0.4 })], env: { glory: 0.9, storm: 0, night: 0.15 } }), // "NÃO ESTENDAS A TUA MÃO" — o alívio
