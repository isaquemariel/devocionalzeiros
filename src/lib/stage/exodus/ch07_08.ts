...
export const CHAPTERS: Record<number, StageScript> = {
  ...
  8: {
    ...
    beats: [
      ...
      b(8, { by: "farao", q: "e disse: ", set: "palacio", cast: [C("farao", 90, "point", { dy: 0.44, facing: -1 }), C("moises", -60, "stand", { dy: 0.5, facing: 1 }), C("arao", -10, "stand", { dy: 0.5, facing: 1 })], props: [...PALACIO, { ...P("frogs", -40, 1.0, undefined, 0.74), tag: "praga-ras" }, P("frogs", 130, 0.9, undefined, 0.62)], env: { terrain: "city", water: 0.5, storm: 0.15, glory: 0.3, night: 0.12 } }), // Faraó chama Moisés e Arão: "Rogai ao Senhor que tire as rãs... deixarei ir o povo"
