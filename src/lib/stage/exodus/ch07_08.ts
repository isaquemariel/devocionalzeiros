...
export const CHAPTERS: Record<number, StageScript> = {
  ...
  7: {
    ...
    beats: [
      ...
      b(10, { set: "palacio", cast: [C("farao", 90, "stand", { dy: 0.44, facing: -1 }), C("arao", -20, "raise", { dy: 0.5, facing: 1 }), C("moises", -80, "stand", { dy: 0.5, facing: 1 })], props: PALACIO, env: { terrain: "city", glory: 0.4, night: 0.12, storm: 0.2 } }), // Arão lança a vara diante de Faraó: torna-se em serpente
      b(11, { cast: [C("farao", 90, "point", { dy: 0.44, facing: -1 }), C("homem", 40, "raise", { dy: 0.5, id: "mago", facing: 1 }), C("homem", 130, "stand", { dy: 0.52, id: "mago2", facing: 1 }), C("arao", -60, "stand", { dy: 0.5, facing: -1 })], env: { storm: 0.28, glory: 0.25 } }), // Faraó chama os sábios e magos, que fazem o mesmo com seus encantamentos
      b(12, { cast: [C("arao", -50, "raise", { dy: 0.5, facing: -1 }), C("homem", 40, "bow", { dy: 0.5, id: "mago", facing: 1 }), C("homem", 130, "bow", { dy: 0.52, id: "mago2", facing: 1 }), C("farao", 90, "stand", { dy: 0.44, facing: -1 })], env: { storm: 0.35, glory: 0.5 } }), // as varas viram serpentes, mas a vara de Arão traga as deles
      ...
      b(18, { by: "deus", env: { glory: 0.68, water: 0.55, storm: 0.15 } }), // "os peixes morrerão, o rio cheirará mal, e os egípcios terão nojo de beber"
      b(19, { by: "deus", q: "Disse mais o Senhor a Moisés: Dize a Arão: ", env: { glory: 0.72 } }), // "estende a tua mão sobre as águas do Egito... e haja sangue em toda a terra"
      b(20, { cast: [C("arao", -30, "raise", { dy: 0.5, facing: 1 }), C("moises", -90, "point", { dy: 0.5, facing: 1 }), C("farao", 120, "stand", { dy: 0.46, facing: -1 }), C("homem", 190, "stand", { dy: 0.5, id: "servo", facing: -1 })], env: { water: 0.7, storm: 0.4, fire: 0.35, glory: 0.4, night: 0.12 } }), // Arão fere as águas diante de Faraó, e todo o rio se torna em sangue
      b(21, { cast: [C("farao", 120, "stand", { dy: 0.46, facing: -1 }), C("homem", 190, "bow", { dy: 0.5, id: "servo", facing: -1 }), C("arao", -30, "stand", { dy: 0.5, facing: 1 }), C("moises", -90, "stand", { dy: 0.5, facing: 1 })], env: { water: 0.72, storm: 0.45, fire: 0.4, night: 0.2, glory: 0.25 } }), // os peixes morrem, o rio cheira mal, e há sangue por toda a terra do Egito
      b(22, { cast: [C("farao", 90, "point", { dy: 0.46, facing: -1 }), C("homem", 30, "raise", { dy: 0.5, id: "mago", facing: 1 }), C("homem", 140, "stand", { dy: 0.52, id: "mago2", facing: 1 })], env: { water: 0.6, storm: 0.3, fire: 0.3, glory: 0.15 } }), // os magos fazem o mesmo; o coração de Faraó se endurece
      b(23, { cast: [C("farao", 60, "walk", { dy: 0.46, facing: 1 })], env: { water: 0.5, storm: 0.2, night: 0.28, glory: 0.12 } }), // Faraó vira-se e vai para casa; nem ainda nisto põe o coração
      b(24, { cast: [C("multidao", -40, "kneel", { dy: 0.56 }), C("multidao", 60, "kneel", { scale: 0.9, dy: 0.6, id: "povo2" })], props: [...RIO, P("well", -180, 1, undefined, 0.34), P("well", 150, 0.9, undefined, 0.44)], env: { water: 0.55, storm: 0.15, fire: 0.25, night: 0.2, glory: 0.1 } }), // os egípcios cavam poços junto ao rio, pois não podem beber a água
      b(25, { env: { water: 0.45, storm: 0.1, fire: 0.2, night: 0.25 } }), // cumprem-se sete dias depois que o Senhor ferira o rio
    ],
  },
  ...
  8: {
    ...
    beats: [
      ...
      b(6, { set: "rio", cast: [C("arao", -30, "raise", { dy: 0.5, facing: 1 }), C("moises", -90, "stand", { dy: 0.5, facing: 1 })], props: [P("river", 0, 1.5, undefined, 0.22), P("palm", -256, 1.1, undefined, 0.12), P("palm", 244, 1.05, undefined, 0.12), P("grass", -120, 1.05, undefined, 0.68), P("grass", 120, 1, undefined, 0.72), P("bush", 200, 0.8, undefined, 0.4)], env: { terrain: "city", water: 0.75, storm: 0.35, glory: 0.3, night: 0.14 } }), // Arão estende a mão, e as rãs sobem e cobrem a terra do Egito
      b(7, { cast: [C("homem", 60, "raise", { dy: 0.5, id: "mago", facing: -1 }), C("homem", 140, "stand", { dy: 0.52, id: "mago2", facing: -1 }), C("arao", -60, "stand", { dy: 0.5, facing: 1 })], env: { water: 0.72, storm: 0.35 } }), // os magos fazem o mesmo, e também fazem subir rãs
      b(8, { by: "farao", q: "e disse: ", set: "palacio", cast: [C("farao", 90, "point", { dy: 0.44, facing: -1 }), C("moises", -60, "stand", { dy: 0.5, facing: 1 }), C("arao", -10, "stand", { dy: 0.5, facing: 1 })], props: PALACIO, env: { terrain: "city", water: 0.5, storm: 0.15, glory: 0.3, night: 0.12 } }), // Faraó chama Moisés e Arão: "Rogai ao Senhor que tire as rãs... deixarei ir o povo"
      b(9, { by: "moises", q: "E disse Moisés a Faraó: ", cast: [C("moises", -60, "point", { dy: 0.5, facing: 1 }), C("arao", -10, "stand", { dy: 0.5, facing: 1 }), C("farao", 90, "stand", { dy: 0.44, facing: -1 })], env: { glory: 0.4 } }), // "quando hei de rogar por ti, para que as rãs fiquem somente no rio?"
