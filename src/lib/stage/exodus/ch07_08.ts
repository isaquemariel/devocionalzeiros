...
export const CHAPTERS: Record<number, StageScript> = {
  ...
  7: {
    ...
    beats: [
      ...
      b(20, { cast: [C("arao", -30, "raise", { dy: 0.72, facing: 1 }), C("moises", -90, "point", { dy: 0.72, facing: 1 }), C("farao", 120, "stand", { dy: 0.72, facing: -1 }), C("homem", 190, "stand", { dy: 0.72, id: "servo", facing: -1 })], env: { water: 0.7, storm: 0.4, fire: 0.35, glory: 0.4, night: 0.12 } }), // Arão fere as águas diante de Faraó, e todo o rio se torna em sangue
      b(21, { cast: [C("farao", 120, "stand", { dy: 0.74, facing: -1 }), C("homem", 190, "bow", { dy: 0.74, id: "servo", facing: -1 }), C("arao", -30, "stand", { dy: 0.74, facing: 1 }), C("moises", -90, "stand", { dy: 0.74, facing: 1 })], env: { water: 0.72, storm: 0.45, fire: 0.4, night: 0.2, glory: 0.25 } }), // os peixes morrem, o rio cheira mal, e há sangue por toda a terra do Egito
      b(22, { cast: [C("farao", 90, "point", { dy: 0.61, facing: -1 }), C("homem", 30, "raise", { dy: 0.61, id: "mago", facing: 1 }), C("homem", 140, "stand", { dy: 0.61, id: "mago2", facing: 1 })], env: { water: 0.6, storm: 0.3, fire: 0.3, glory: 0.15 } }), // os magos fazem o mesmo; o coração de Faraó se endurece
