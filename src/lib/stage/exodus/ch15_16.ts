...
export const CHAPTERS: Record<number, StageScript> = {
  ...
  16: {
    ...
    beats: [
      ...
      b(33, { by: "moises", q: "Disse também Moisés a Arão: ", cast: [C("moises", -60, "point", { dy: 0.5, facing: 1 }), C("arao", 10, "stand", { dy: 0.5, facing: -1 })], props: [...ARRAIAL, P("amphora", -20, 0.85, undefined, 0.55)], env: { glory: 0.65 } }), // "Toma um vaso, põe nele um ômer de maná, e coloca-o diante do Senhor"
