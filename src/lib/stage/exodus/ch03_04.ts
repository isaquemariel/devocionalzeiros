...
const HOREBE_SARCA: StagePropSpec[] = [...HOREBE, { ...P("bush", -18, 1.45, 1, 0.42), tag: "sarca-ardente" }];
...
export const CHAPTERS: Record<number, StageScript> = {
  ...
  3: {
    ...
    beats: [
      ...
      b(20, { by: "anjo", env: { glory: 0.9, fire: 0.85 } }), // "ferirei ao Egito com todas as minhas maravilhas"
      b(21, { by: "anjo", env: { glory: 0.95 } }), // "darei graça a este povo aos olhos dos egípcios"
      b(22, { by: "anjo", env: { glory: 1 } }), // "despojareis os egípcios" — a promessa da saída
    ],
  },
  ...
  4: {
    ...
    beats: [
      ...
      b(21, { by: "deus", q: "E disse o Senhor a Moisés: ", env: { glory: 0.6 } }), // "faças diante de Faraó todas as maravilhas... endurecerei o coração"
      b(22, { by: "deus", q: "Assim diz o Senhor: ", env: { glory: 0.75 } }), // "Israel é meu filho, meu primogênito"
      b(23, { by: "deus", q: "E eu te tenho dito: ", env: { glory: 0.7 } }), // "Deixa ir o meu filho... matarei a teu filho, o primogênito"
      ...
      b(27, { by: "deus", q: "Disse o Senhor a Arão: ", set: "monte-encontro", cast: [C("moises", -50, "stand", { dy: 0.5, facing: 1 }), C("arao", 20, "walk", { dy: 0.5, facing: -1 })], props: HOREBE, env: { terrain: "mountain", night: 0.2, glory: 0.7 } }), // "Vai ao encontro de Moisés" — os irmãos se encontram no monte
