...
export const CHAPTERS: Record<number, StageScript> = {
  ...
  14: {
    ...
    beats: [
      ...
      b(9, { set: "mar", cast: [C("multidao", -120, "stand", { dy: 0.5 }), C("multidao", -40, "stand", { scale: 0.9, dy: 0.54, id: "povo2" }), C("cavaleiro", 150, "walk", { dy: 0.46, facing: -1 }), C("cavaleiro", 240, "walk", { scale: 0.85, dy: 0.5, id: "carro2", facing: -1 })], props: MAR, env: { terrain: "desert", storm: 0.4, night: 0.4, water: 0.5, glory: 0.35 } }), // os egípcios os perseguem e os alcançam acampados junto ao mar
      ...
      b(12, { by: "homem", cast: [                                                        // "melhor nos fora servir aos egípcios do que morrer no deserto"
        ...
        C("homem", 165, "bow", { dy: 0.5, scale: 0.92, id: "israelita-que-murmura3" }),
      ...
      b(19, { props: [...MAR, { ...P("pillar", 120, 1.05, 1, 0.42), tag: "coluna-nuvem-fogo" }], cast: [C("multidao", -60, "stand", { dy: 0.5 }), C("multidao", 30, "stand", { scale: 0.9, dy: 0.54, id: "povo2" }), C("cavaleiro", 220, "stand", { dy: 0.5, facing: -1 })], env: { glory: 0.55, fire: 0.5, night: 0.45 } }), // o anjo de Deus e a coluna de nuvem se retiram e vão atrás de Israel
      ...
      b(24, { props: [...MAR_SECO, { ...P("pillar", -140, 1.1, 1, 0.4), tag: "coluna-nuvem-fogo" }], cast: [C("cavaleiro", -60, "stand", { dy: 0.6 }), C("cavaleiro", 30, undefined, { scale: 0.9, dy: 0.64, id: "carro2" })], env: { fire: 0.8, glory: 0.6, storm: 0.7, night: 0.5, water: 0.18 } }), // na vigília da manhã, o Senhor na coluna de fogo alvoroça o campo dos egípcios
      b(25, { by: "cavaleiro", q: "Então disseram os egípcios: ", cast: [C("cavaleiro", -60, undefined, { dy: 0.6 }), C("cavaleiro", 40, undefined, { scale: 0.9, dy: 0.66, id: "carro2" })], env: { storm: 0.8, water: 0.22, glory: 0.55, fire: 0.6 } }), // tira as rodas dos carros: "Fujamos de Israel, porque o Senhor peleja por eles"
      ...
      b(27, { set: "mar", cast: [C("moises", -170, "point", { dy: 0.5, facing: -1 }), C("cavaleiro", 20, "lie", { dy: 0.5 }), C("cavaleiro", 110, "lie", { scale: 0.9, dy: 0.46, id: "carro2" })], props: MAR, env: { terrain: "desert", water: 0.5, storm: 0.9, night: 0.4, glory: 0.5 } }), // Moisés estende a mão; o mar retorna e o Senhor derruba os egípcios
      b(28, { cast: [C("cavaleiro", 20, "lie", { dy: 0.98 }), C("cavaleiro", 120, "lie", { scale: 0.9, dy: 0.98, id: "carro2" })], env: { water: 1, storm: 0.6, night: 0.35 } }), // as águas cobrem os carros e cavaleiros; nenhum deles fica
