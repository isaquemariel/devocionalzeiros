...
export const CHAPTERS: Record<number, StageScript> = {
  ...
  24: {
    ...
    beats: [
      ...
      b(14, { by: "moises", q: "E disse aos anciãos: ", set: "altar", cast: [C("moises", -70, "point", { dy: 0.5, facing: 1 }), C("anciao", 20, "stand", { dy: 0.5, facing: -1 }), C("arao", 90, "stand", { dy: 0.5, id: "arao", facing: -1 }), C("homem", 150, "stand", { dy: 0.52, id: "hur", facing: -1 })], props: ALTAR_ALIANCA, env: { terrain: "mountain", glory: 0.7, fire: 0.4, night: 0.16 } }), // "esperai-nos aqui; Arão e Hur ficam convosco para os negócios"
      b(15, { set: "monte", cast: [C("moises", -40, "walk", { dy: 0.4, facing: 1 })], props: MONTE, env: { terrain: "mountain", glory: 0.82, fire: 0.5, night: 0.2 } }), // subindo Moisés ao monte, a nuvem cobre o monte
