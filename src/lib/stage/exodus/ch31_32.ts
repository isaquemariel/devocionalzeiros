...
export const CHAPTERS: Record<number, StageScript> = {
  ...
  32: {
    ...
    beats: [
      ...
      b(28, { cast: [C("homem", 10, "raise", { dy: 0.5, id: "levita1", facing: 1 }), C("homem", 90, "stand", { dy: 0.52, id: "levita2", facing: 1 }), C("servo", 160, "lie", { scale: 0.9, dy: 0.56, id: "caidoBezerroA" }), C("servo", 225, "lie", { scale: 0.85, dy: 0.58, id: "caidoBezerroB" }), C("servo", 288, "lie", { scale: 0.8, dy: 0.6, id: "caidoBezerroC" })], env: { storm: 0.45, night: 0.4, glory: 0.25 } }), // os filhos de Levi fazem conforme a palavra; caem uns três mil homens
