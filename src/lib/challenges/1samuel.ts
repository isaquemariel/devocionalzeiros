...
export const SAMUEL1_CH: BookChallenges = {
  ...
  complete: {
    ...
    22: {
      ref: "1 Samuel 22:2",
      before: "E ajuntou-se a ele todo o homem que se achava em",
      answer: "aperto",
      after: ", e todo o homem endividado, e todo o homem de espírito desgostoso",
      options: ["aperto", "festa", "descanso", "riqueza"],
    },
    28: {
      ref: "1 Samuel 28:7",
      before: "Eis que em",
      answer: "En-Dor",
      after: "há uma mulher que tem o espírito de adivinhar",
      options: ["En-Dor", "Gilboa", "Ramá", "Gate"],
    },
  },
  connect: {
    5: {
